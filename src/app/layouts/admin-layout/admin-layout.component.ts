...
// Complete admin nav — professional remittance industry structure
// Filtered by role/privileges at runtime; superAdminOnly items hidden for non-SystemAdmin
...
export class AdminLayoutComponent implements OnInit, OnDestroy {
  ...
  // Track which sidebar sections are expanded; default: all open
  ...
  private buildNavItems(roles: string[], privileges: any[]): void {
    ...
    // Hide superAdminOnly items from non-SystemAdmin users
    if (!isSA) {
  ...
  isSectionExpanded(section: string): boolean {
    // Default: expanded (true) unless explicitly set to false
