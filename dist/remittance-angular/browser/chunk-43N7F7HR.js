...
function TransactionDetailComponent_ng_container_2_button_154_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 49);
    \u0275\u0275listener("click", function TransactionDetailComponent_ng_container_2_button_154_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext(2);
...
function TransactionDetailComponent_ng_container_2_div_160_Template(rf, ctx) {
  if (rf & 1) {
...
function TransactionDetailComponent_ng_container_2_span_167_Template(rf, ctx) {
  if (rf & 1) {
...
function TransactionDetailComponent_ng_container_2_div_170_div_1_Template(rf, ctx) {
  if (rf & 1) {
...
function TransactionDetailComponent_ng_container_2_div_170_div_2_Template(rf, ctx) {
  if (rf & 1) {
...
function TransactionDetailComponent_ng_container_2_div_170_div_3_div_1_div_11_div_1_p_10_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", log_r11.errorMessage, " ");
  }
}
function TransactionDetailComponent_ng_container_2_div_170_div_3_div_1_div_11_div_1_div_11_pre_10_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const log_r11 = \u0275\u0275nextContext(2).$implicit;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(log_r11.requestPayload);
  }
}
function TransactionDetailComponent_ng_container_2_div_170_div_3_div_1_div_11_div_1_div_11_Template(rf, ctx) {
  if (rf & 1) {
    const _r12 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 92)(1, "div", 93)(2, "button", 94);
    \u0275\u0275listener("click", function TransactionDetailComponent_ng_container_2_div_170_div_3_div_1_div_11_div_1_div_11_Template_button_click_2_listener() {
      \u0275\u0275restoreView(_r12);
      const log_r11 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(6);
      return \u0275\u0275resetView(ctx_r1.togglePayload("req_" + log_r11.id));
    });
    \u0275\u0275namespaceSVG();
    ...
    \u0275\u0275listener("click", function TransactionDetailComponent_ng_container_2_div_170_div_3_div_1_div_11_div_1_div_11_Template_button_click_6_listener() {
      \u0275\u0275restoreView(_r12);
      const log_r11 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(6);
      return \u0275\u0275resetView(ctx_r1.copyPayload(log_r11.requestPayload));
    });
    \u0275\u0275namespaceSVG();
    ...
    \u0275\u0275text(9, " Copy ");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(10, TransactionDetailComponent_ng_container_2_div_170_div_3_div_1_div_11_div_1_div_11_pre_10_Template, 2, 1, "pre", 100);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const log_r11 = \u0275\u0275nextContext().$implicit;
    const ctx_r1 = \u0275\u0275nextContext(6);
    \u0275\u0275advance(3);
    \u0275\u0275classProp("rotate-90", ctx_r1.isPayloadOpen("req_" + log_r11.id));
    \u0275\u0275advance(7);
    \u0275\u0275property("ngIf", ctx_r1.isPayloadOpen("req_" + log_r11.id));
  }
}
function TransactionDetailComponent_ng_container_2_div_170_div_3_div_1_div_11_div_1_div_12_pre_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "pre", 105);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const log_r11 = \u0275\u0275nextContext(2).$implicit;
    \u0275\u0275classMap(log_r11.isSuccess ? "bg-emerald-50 dark:bg-emerald-950/30 border-emerald-200 dark:border-emerald-800/50 text-emerald-900 dark:text-emerald-200" : "bg-danger-50 dark:bg-danger-950/30 border-danger-200 dark:border-danger-800/50 text-danger-900 dark:text-danger-200");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(log_r11.responsePayload);
  }
}
function TransactionDetailComponent_ng_container_2_div_170_div_3_div_1_div_11_div_1_div_12_Template(rf, ctx) {
  if (rf & 1) {
    const _r13 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 92)(1, "div", 93)(2, "button", 102);
    \u0275\u0275listener("click", function TransactionDetailComponent_ng_container_2_div_170_div_3_div_1_div_11_div_1_div_12_Template_button_click_2_listener() {
      \u0275\u0275restoreView(_r13);
      const log_r11 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(6);
      return \u0275\u0275resetView(ctx_r1.togglePayload("res_" + log_r11.id));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(3, "svg", 95);
    \u0275\u0275element(4, "path", 96);
    ...
    \u0275\u0275listener("click", function TransactionDetailComponent_ng_container_2_div_170_div_3_div_1_div_11_div_1_div_12_Template_button_click_6_listener() {
      \u0275\u0275restoreView(_r13);
      const log_r11 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(6);
      return \u0275\u0275resetView(ctx_r1.copyPayload(log_r11.responsePayload));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(7, "svg", 98);
    \u0275\u0275element(8, "path", 99);
    ...
    \u0275\u0275text(9, " Copy ");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(10, TransactionDetailComponent_ng_container_2_div_170_div_3_div_1_div_11_div_1_div_12_pre_10_Template, 2, 3, "pre", 104);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const log_r11 = \u0275\u0275nextContext().$implicit;
    const ctx_r1 = \u0275\u0275nextContext(6);
    \u0275\u0275advance(2);
    \u0275\u0275classMap(log_r11.isSuccess ? "text-surface-400 dark:text-surface-500 hover:text-emerald-600 dark:hover:text-emerald-400" : "text-surface-400 dark:text-surface-500 hover:text-danger-600 dark:hover:text-danger-400");
    \u0275\u0275advance();
    \u0275\u0275classProp("rotate-90", ctx_r1.isPayloadOpen("res_" + log_r11.id));
    \u0275\u0275advance(7);
    \u0275\u0275property("ngIf", ctx_r1.isPayloadOpen("res_" + log_r11.id));
  }
}
function TransactionDetailComponent_ng_container_2_div_170_div_3_div_1_div_11_div_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 84)(1, "div", 85);
    \u0275\u0275element(2, "div", 86);
    \u0275\u0275elementStart(3, "div", 63)(4, "div", 87)(5, "span", 88);
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(9, "date");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(10, TransactionDetailComponent_ng_container_2_div_170_div_3_div_1_div_11_div_1_p_10_Template, 2, 1, "p", 90)(11, TransactionDetailComponent_ng_container_2_div_170_div_3_div_1_div_11_div_1_div_11_Template, 11, 3, "div", 91)(12, TransactionDetailComponent_ng_container_2_div_170_div_3_div_1_div_11_div_1_div_12_Template, 11, 5, "div", 91);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const log_r11 = ctx.$implicit;
    \u0275\u0275advance(2);
    \u0275\u0275property("ngClass", log_r11.isSuccess ? "bg-success-400" : "bg-danger-400");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(log_r11.providerKey);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(9, 6, log_r11.createdAt, "MMM dd, HH:mm:ss"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", log_r11.errorMessage);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", log_r11.requestPayload);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", log_r11.responsePayload);
  }
}
function TransactionDetailComponent_ng_container_2_div_170_div_3_div_1_div_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 82);
    \u0275\u0275template(1, TransactionDetailComponent_ng_container_2_div_170_div_3_div_1_div_11_div_1_Template, 13, 9, "div", 83);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const group_r10 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", group_r10.logs);
  }
}
function TransactionDetailComponent_ng_container_2_div_170_div_3_div_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 74)(1, "button", 75);
    \u0275\u0275listener("click", function TransactionDetailComponent_ng_container_2_div_170_div_3_div_1_Template_button_click_1_listener() {
      const group_r10 = \u0275\u0275restoreView(_r9).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r1.toggleGroup(group_r10.event));
    });
    ...
    \u0275\u0275element(10, "path", 46);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(11, TransactionDetailComponent_ng_container_2_div_170_div_3_div_1_div_11_Template, 2, 1, "div", 81);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const group_r10 = ctx.$implicit;
    const isLast_r14 = ctx.last;
    const ctx_r1 = \u0275\u0275nextContext(4);
    \u0275\u0275classProp("border-b", !isLast_r14);
    \u0275\u0275advance();
    \u0275\u0275property("ngClass", ctx_r1.getGroupHeaderClass(group_r10.event));
    \u0275\u0275advance();
    \u0275\u0275property("ngClass", ctx_r1.getLogEventClass(group_r10.event));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", group_r10.label, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate2(" ", group_r10.logs.length, " ", group_r10.logs.length === 1 ? "entry" : "entries", " ");
    \u0275\u0275advance();
    \u0275\u0275property("ngClass", group_r10.logs[0].isSuccess ? "text-success-600 dark:text-success-400" : "text-danger-600 dark:text-danger-400");
    \u0275\u0275advance();
    \u0275\u0275property("ngClass", group_r10.logs[0].isSuccess ? "bg-success-500" : "bg-danger-500");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", group_r10.logs[0].isSuccess ? "OK" : "Failed", " ");
    \u0275\u0275advance();
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction1(12, _c0, ctx_r1.expandedGroups[group_r10.event]));
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", ctx_r1.expandedGroups[group_r10.event]);
  }
}
function TransactionDetailComponent_ng_container_2_div_170_div_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div");
    \u0275\u0275template(1, TransactionDetailComponent_ng_container_2_div_170_div_3_div_1_Template, 12, 14, "div", 73);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function TransactionDetailComponent_ng_container_2_div_170_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 67);
    \u0275\u0275template(1, TransactionDetailComponent_ng_container_2_div_170_div_1_Template, 4, 0, "div", 68)(2, TransactionDetailComponent_ng_container_2_div_170_div_2_Template, 2, 0, "div", 69)(3, TransactionDetailComponent_ng_container_2_div_170_div_3_Template, 2, 1, "div", 2);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function TransactionDetailComponent_ng_container_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(146, "date");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(147, TransactionDetailComponent_ng_container_2_div_147_Template, 6, 4, "div", 24)(148, TransactionDetailComponent_ng_container_2_div_148_Template, 6, 4, "div", 24)(149, TransactionDetailComponent_ng_container_2_div_149_Template, 5, 1, "div", 24)(150, TransactionDetailComponent_ng_container_2_div_150_Template, 6, 4, "div", 24)(151, TransactionDetailComponent_ng_container_2_div_151_Template, 6, 4, "div", 24)(152, TransactionDetailComponent_ng_container_2_div_152_Template, 5, 1, "div", 24);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(153, "div", 32);
    \u0275\u0275template(154, TransactionDetailComponent_ng_container_2_button_154_Template, 4, 1, "button", 33)(155, TransactionDetailComponent_ng_container_2_button_155_Template, 4, 1, "button", 34)(156, TransactionDetailComponent_ng_container_2_button_156_Template, 4, 1, "button", 35)(157, TransactionDetailComponent_ng_container_2_button_157_Template, 4, 1, "button", 36)(158, TransactionDetailComponent_ng_container_2_button_158_Template, 4, 1, "button", 37)(159, TransactionDetailComponent_ng_container_2_button_159_Template, 4, 1, "button", 38);
    \u0275\u0275elementEnd();
    \u0275\u0275template(160, TransactionDetailComponent_ng_container_2_div_160_Template, 8, 1, "div", 39);
    \u0275\u0275elementStart(161, "div", 40)(162, "button", 41);
    \u0275\u0275listener("click", function TransactionDetailComponent_ng_container_2_Template_button_click_162_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.toggleLogs());
    });
    \u0275\u0275elementStart(163, "h3", 42);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(164, "svg", 9);
    \u0275\u0275element(165, "path", 43);
    \u0275\u0275elementEnd();
    \u0275\u0275text(166, " Integration Logs ");
    \u0275\u0275template(167, TransactionDetailComponent_ng_container_2_span_167_Template, 2, 1, "span", 44);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(168, "svg", 45);
    \u0275\u0275element(169, "path", 46);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(170, TransactionDetailComponent_ng_container_2_div_170_Template, 4, 3, "div", 47);
    \u0275\u0275elementEnd();
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275textInterpolate(ctx_r1.getStatusLabel(ctx_r1.txn.status));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(32, 55, ctx_r1.txn.createdAt, "medium"));
    \u0275\u0275advance(2);
    ...
    \u0275\u0275advance(11);
    \u0275\u0275textInterpolate2("", \u0275\u0275pipeBind2(87, 58, ctx_r1.txn.sendAmount, "1.2-2"), " ", ctx_r1.txn.sendCurrency, "");
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate3("1 ", ctx_r1.txn.sendCurrency, " = ", \u0275\u0275pipeBind2(93, 61, ctx_r1.txn.exchangeRateApplied, "1.4-4"), " ", ctx_r1.txn.receiveCurrency, "");
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate2("", \u0275\u0275pipeBind2(99, 64, ctx_r1.txn.receiveAmount, "1.2-2"), " ", ctx_r1.txn.receiveCurrency, "");
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate2("", \u0275\u0275pipeBind2(106, 67, ctx_r1.txn.totalCommission, "1.2-2"), " ", ctx_r1.txn.sendCurrency, "");
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(112, 70, ctx_r1.txn.agentCommission, "1.2-2"));
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(118, 73, ctx_r1.txn.payoutAgentCommission, "1.2-2"));
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(124, 76, ctx_r1.txn.companyCommission, "1.2-2"));
    \u0275\u0275advance(8);
    ...
    \u0275\u0275advance(11);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(146, 79, ctx_r1.txn.createdAt, "medium"));
    \u0275\u0275advance(2);
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction1(82, _c0, ctx_r1.showLogs));
    \u0275\u0275advance(2);
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 mb-6">
      ...
      <div class="rounded-2xl border border-surface-200 dark:border-surface-700 bg-white dark:bg-surface-800 p-6 shadow-soft">
        ...
        <div class="flex flex-col gap-2">
          ...
          <div *ngIf="txn.partnerReferenceId" class="flex justify-between items-baseline py-1 border-b border-surface-100 dark:border-surface-700">
            <span class="text-sm text-surface-500 dark:text-surface-400">Partner Reference</span>
            <span class="text-surface-900 dark:text-surface-100 font-medium text-sm font-mono">{{ txn.partnerReferenceId }}</span>
          </div>
        </div>
      </div>
...
//# sourceMappingURL=chunk-43N7F7HR.js.map
