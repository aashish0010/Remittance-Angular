      ...
      <div class="overflow-x-auto">
        <table class="w-full text-sm">
          <thead class="bg-surface-50 dark:bg-surface-700/50">
            <tr>
              <th class="px-4 py-3 text-left font-semibold text-surface-600 dark:text-surface-300">Reference</th>
              <th class="px-4 py-3 text-left font-semibold text-surface-600 dark:text-surface-300">Sender</th>
              <th class="px-4 py-3 text-left font-semibold text-surface-600 dark:text-surface-300">Receiver</th>
              <th class="px-4 py-3 text-right font-semibold text-surface-600 dark:text-surface-300">Send Amount</th>
              <th class="px-4 py-3 text-right font-semibold text-surface-600 dark:text-surface-300">Receive Amount</th>
              <th class="px-4 py-3 text-right font-semibold text-surface-600 dark:text-surface-300">Service Charge</th>
              <th class="px-4 py-3 text-left font-semibold text-surface-600 dark:text-surface-300">Status</th>
              <th class="px-4 py-3 text-left font-semibold text-surface-600 dark:text-surface-300">Date</th>
            </tr>
          </thead>
...
//# sourceMappingURL=chunk-PDZZKF4W.js.map
