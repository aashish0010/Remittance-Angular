...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AgentProfileComponent, [{
    type: Component,
    args: [{ selector: "app-agent-profile", standalone: true, imports: [CommonModule, FormsModule], template: `<div class="flex flex-col gap-6 max-w-4xl">
...
//# sourceMappingURL=chunk-DVVUANFQ.js.map
