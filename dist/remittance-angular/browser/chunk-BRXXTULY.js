...
var PublicSettingsService = class _PublicSettingsService {
  constructor(http) {
    ...
    this.companyLogo = signal("");
    this.noticeAlertImage = signal("");
    this.http.get(`${environment.apiUrl}api/public/company`).subscribe({
      next: (res) => {
        if (res?.success && res.data) {
          ...
          if (d.companyLogo)
            this.companyLogo.set(d.companyLogo);
          if (d.noticeAlertImage)
            this.noticeAlertImage.set(d.noticeAlertImage);
        }
      },
      error: () => {
      }
...
function LoginComponent_ng_container_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275propertyInterpolate1("alt", "", ctx_r0.appName, " logo");
    \u0275\u0275property("src", ctx_r0.publicSettings.companyLogo(), \u0275\u0275sanitizeUrl);
  }
}
function LoginComponent_ng_template_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "img", 15, 1);
    \u0275\u0275listener("error", function LoginComponent_ng_template_5_Template_img_error_0_listener() {
      \u0275\u0275restoreView(_r2);
      const logoImgRef_r3 = \u0275\u0275reference(1);
      const iconFallback_r4 = \u0275\u0275reference(3);
      logoImgRef_r3.style.display = "none";
      return \u0275\u0275resetView(iconFallback_r4.style.display = "flex");
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "div", 16, 2);
    \u0275\u0275namespaceSVG();
...
function LoginComponent_ng_container_11_div_1_div_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(4, "Try again in ");
    \u0275\u0275elementStart(5, "strong", 43);
    \u0275\u0275text(6);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate1("", ctx_r0.lockoutRemainingSeconds, "s");
  }
}
function LoginComponent_ng_container_11_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(6, LoginComponent_ng_container_11_div_1_div_6_Template, 7, 1, "div", 39);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r0.isLockedOut && ctx_r0.lockoutRemainingSeconds > 0);
  }
}
function LoginComponent_ng_container_11_p_8_Template(rf, ctx) {
  if (rf & 1) {
...
function LoginComponent_ng_container_11__svg_svg_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
...
function LoginComponent_ng_container_11__svg_svg_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "svg", 45);
...
function LoginComponent_ng_container_11_p_18_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 44);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function LoginComponent_ng_container_11_ng_container_29_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "transloco");
...
function LoginComponent_ng_container_11_ng_template_30_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
...
function LoginComponent_ng_container_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, LoginComponent_ng_container_11_div_1_Template, 7, 2, "div", 20);
    \u0275\u0275elementStart(2, "form", 21);
    ...
    \u0275\u0275elementStart(3, "div")(4, "label", 22);
    \u0275\u0275text(5);
    \u0275\u0275pipe(6, "transloco");
    \u0275\u0275elementEnd();
    \u0275\u0275element(7, "input", 23);
    \u0275\u0275template(8, LoginComponent_ng_container_11_p_8_Template, 2, 1, "p", 24);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function LoginComponent_ng_container_11_Template_button_click_15_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.hidePassword = !ctx_r0.hidePassword);
    });
    \u0275\u0275template(16, LoginComponent_ng_container_11__svg_svg_16_Template, 2, 0, "svg", 29)(17, LoginComponent_ng_container_11__svg_svg_17_Template, 3, 0, "svg", 29);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(18, LoginComponent_ng_container_11_p_18_Template, 2, 1, "p", 24);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "div", 30)(20, "label", 31)(21, "input", 32);
    \u0275\u0275listener("change", function LoginComponent_ng_container_11_Template_input_change_21_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r0 = \u0275\u0275nextContext();
    ...
    \u0275\u0275template(29, LoginComponent_ng_container_11_ng_container_29_Template, 3, 3, "ng-container", 8)(30, LoginComponent_ng_container_11_ng_template_30_Template, 3, 0, "ng-template", null, 3, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const loader_r6 = \u0275\u0275reference(31);
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !ctx_r0.loading)("ngIfElse", loader_r6);
  }
}
function LoginComponent_ng_container_12_button_5__svg_svg_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "svg", 45);
    \u0275\u0275element(1, "path", 65);
...
function LoginComponent_ng_container_12_button_5__svg_svg_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "svg", 45);
    \u0275\u0275element(1, "path", 66);
...
function LoginComponent_ng_container_12_button_5__svg_svg_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "svg", 45);
    \u0275\u0275element(1, "path", 67);
...
function LoginComponent_ng_container_12_button_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 56);
    \u0275\u0275listener("click", function LoginComponent_ng_container_12_button_5_Template_button_click_0_listener() {
      const portal_r9 = \u0275\u0275restoreView(_r8).$implicit;
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.selectPortal(portal_r9));
    });
    \u0275\u0275elementStart(1, "div", 57);
    \u0275\u0275elementContainerStart(2, 58);
    \u0275\u0275template(3, LoginComponent_ng_container_12_button_5__svg_svg_3_Template, 2, 0, "svg", 59)(4, LoginComponent_ng_container_12_button_5__svg_svg_4_Template, 2, 0, "svg", 59)(5, LoginComponent_ng_container_12_button_5__svg_svg_5_Template, 2, 0, "svg", 59);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275element(14, "path", 64);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const portal_r9 = ctx.$implicit;
    \u0275\u0275advance();
    \u0275\u0275property("ngStyle", \u0275\u0275pureFunction2(11, _c2, portal_r9.color, portal_r9.color + "15"));
    \u0275\u0275advance();
    \u0275\u0275property("ngSwitch", portal_r9.key);
    \u0275\u0275advance();
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(9, 7, portal_r9.label));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(12, 9, portal_r9.description));
  }
}
function LoginComponent_ng_container_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(5, LoginComponent_ng_container_12_button_5_Template, 15, 14, "button", 54);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "button", 55);
    \u0275\u0275listener("click", function LoginComponent_ng_container_12_Template_button_click_6_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r0 = \u0275\u0275nextContext();
...
var LoginComponent = class _LoginComponent {
  ...
  constructor(api, auth, router, route, appSettings, publicSettings, seo) {
    this.api = api;
    this.auth = auth;
    this.router = router;
    this.route = route;
      ...
      next: (res) => {
        ...
        if (!res?.success || !res.data) {
          ...
          if (this.failedAttempts >= maxAttempts) {
            ...
            const lockoutMs = (this.appSettings.lockoutDurationMinutes || 5) * 60 * 1e3;
            this.lockoutRemainingSeconds = Math.floor(lockoutMs / 1e3);
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LoginComponent, selectors: [["app-login"]], decls: 26, vars: 15, consts: [["fallbackIcon", ""], ["logoImgRef", ""], ["iconFallback", ""], ["loader", ""], [1, "flex", "min-h-screen", "items-center", "justify-center", "bg-surface-50", "dark:bg-surface-900", "p-4", "animate-fade-in"], [1, "w-full", "max-w-md", "rounded-2xl", "shadow-elevated", "bg-white", "dark:bg-surface-800", "dark:shadow-[0_10px_25px_-5px_rgba(0,0,0,0.3)]", "p-8", "sm:p-10", "text-center", "animate-slide-up"], [1, "mb-8"], [1, "mx-auto", "mb-5", "flex", "items-center", "justify-center"], [4, "ngIf", "ngIfElse"], [1, "text-2xl", "font-bold", "tracking-tight", "text-surface-900", "dark:text-surface-100"], ["class", "mt-2 text-sm text-surface-500 dark:text-surface-400", 4, "ngIf"], [4, "ngIf"], [1, "mt-8", "flex", "items-center", "justify-center", "gap-2", "border-t", "border-surface-200", "dark:border-surface-700", "pt-6", "text-xs", "text-surface-400", "dark:text-surface-500"], ["href", "#", 1, "hover:text-brand-600", "dark:hover:text-brand-400", "transition-colors"], [1, "h-16", "w-auto", "max-w-[200px]", "object-contain", 3, "src", "alt"], ["src", "assets/images/logo.png", 1, "h-16", "w-auto", "max-w-[200px]", "object-contain", 3, "error", "alt"], [1, "hidden", "h-14", "w-14", "items-center", "justify-center", "rounded-2xl", "bg-brand-100", "dark:bg-brand-900/30", "text-brand-600", "dark:text-brand-400"], ["xmlns", "http://www.w3.org/2000/svg", "fill", "none", "viewBox", "0 0 24 24", "stroke", "currentColor", "stroke-width", "1.5", 1, "h-8", "w-8"], ["stroke-linecap", "round", "stroke-linejoin", "round", "d", "M21 12a2.25 2.25 0 0 0-2.25-2.25H15a3 3 0 1 1-6 0H5.25A2.25 2.25 0 0 0 3 12m18 0v6a2.25 2.25 0 0 1-2.25 2.25H5.25A2.25 2.25 0 0 1 3 18v-6m18 0V9M3 12V9m18 0a2.25 2.25 0 0 0-2.25-2.25H5.25A2.25 2.25 0 0 0 3 9m18 0V6a2.25 2.25 0 0 0-2.25-2.25H5.25A2.25 2.25 0 0 0 3 6v3"], [1, "mt-2", "text-sm", "text-surface-500", "dark:text-surface-400"], ["class", "mb-6 rounded-lg bg-danger-50 dark:bg-danger-500/10 px-4 py-3 text-sm text-danger-600 dark:text-danger-400 animate-slide-down", 4, "ngIf"], [1, "flex", "flex-col", "gap-4", "text-left", 3, "ngSubmit", "formGroup"], ["for", "email", 1, "block", "text-sm", "font-medium", "text-surface-700", "dark:text-surface-300", "mb-1.5"], ["id", "email", "type", "email", "formControlName", "email", "placeholder", "you@example.com", 1, "block", "w-full", "rounded-lg", "border", "px-3.5", "py-2.5", "text-sm", "bg-white", "dark:bg-surface-700/50", "text-surface-900", "dark:text-surface-100", "placeholder-surface-400", "dark:placeholder-surface-500", "border-surface-200", "dark:border-surface-600", "focus:outline-none", "focus:ring-2", "focus:ring-brand-500/40", "focus:border-brand-500", "dark:focus:ring-brand-400/30", "dark:focus:border-brand-400", "transition-colors", 3, "ngClass"], ["class", "mt-1.5 text-xs text-danger-500 dark:text-danger-400", 4, "ngIf"], ["for", "password", 1, "block", "text-sm", "font-medium", "text-surface-700", "dark:text-surface-300", "mb-1.5"], [1, "relative"], ["id", "password", "formControlName", "password", "placeholder", "Enter your password", 1, "block", "w-full", "rounded-lg", "border", "px-3.5", "py-2.5", "pr-10", "text-sm", "bg-white", "dark:bg-surface-700/50", "text-surface-900", "dark:text-surface-100", "placeholder-surface-400", "dark:placeholder-surface-500", "border-surface-200", "dark:border-surface-600", "focus:outline-none", "focus:ring-2", "focus:ring-brand-500/40", "focus:border-brand-500", "dark:focus:ring-brand-400/30", "dark:focus:border-brand-400", "transition-colors", 3, "type", "ngClass"], ["type", "button", "tabindex", "-1", 1, "absolute", "inset-y-0", "right-0", "flex", "items-center", "pr-3", "text-surface-400", "hover:text-surface-600", "dark:text-surface-500", "dark:hover:text-surface-300", "transition-colors", 3, "click"], ["xmlns", "http://www.w3.org/2000/svg", "class", "h-5 w-5", "fill", "none", "viewBox", "0 0 24 24", "stroke", "currentColor", "stroke-width", "1.5", 4, "ngIf"], [1, "flex", "items-center", "justify-between", "text-sm"], [1, "flex", "items-center", "gap-2", "cursor-pointer", "select-none", "text-surface-600", "dark:text-surface-400"], ["type", "checkbox", 1, "h-4", "w-4", "rounded", "border-surface-300", "dark:border-surface-600", "text-brand-600", "focus:ring-brand-500/40", "dark:bg-surface-700", "transition-colors", 3, "change", "checked"], ["routerLink", "/auth/forgot-password", 1, "font-medium", "text-brand-600", "hover:text-brand-500", "dark:text-brand-400", "dark:hover:text-brand-300", "transition-colors"], ["type", "submit", 1, "mt-2", "flex", "w-full", "items-center", "justify-center", "gap-2", "rounded-lg", "bg-brand-600", "px-4", "py-2.5", "text-sm", "font-semibold", "text-white", "hover:bg-brand-700", "focus:outline-none", "focus:ring-2", "focus:ring-brand-500/40", "focus:ring-offset-2", "dark:focus:ring-offset-surface-800", "disabled:opacity-60", "disabled:cursor-not-allowed", "transition-all", "duration-150", "ease-in-out", 3, "disabled"], [1, "mb-6", "rounded-lg", "bg-danger-50", "dark:bg-danger-500/10", "px-4", "py-3", "text-sm", "text-danger-600", "dark:text-danger-400", "animate-slide-down"], [1, "flex", "items-center", "gap-2"], ["xmlns", "http://www.w3.org/2000/svg", "viewBox", "0 0 20 20", "fill", "currentColor", 1, "h-5", "w-5", "flex-shrink-0"], ["fill-rule", "evenodd", "d", "M18 10a8 8 0 1 1-16 0 8 8 0 0 1 16 0Zm-8-5a.75.75 0 0 1 .75.75v4.5a.75.75 0 0 1-1.5 0v-4.5A.75.75 0 0 1 10 5Zm0 10a1 1 0 1 0 0-2 1 1 0 0 0 0 2Z", "clip-rule", "evenodd"], ["class", "mt-2 flex items-center gap-1.5 text-xs font-medium", 4, "ngIf"], [1, "mt-2", "flex", "items-center", "gap-1.5", "text-xs", "font-medium"], ["xmlns", "http://www.w3.org/2000/svg", "fill", "none", "viewBox", "0 0 24 24", "stroke", "currentColor", "stroke-width", "2", 1, "h-4", "w-4"], ["stroke-linecap", "round", "stroke-linejoin", "round", "d", "M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"], [1, "tabular-nums"], [1, "mt-1.5", "text-xs", "text-danger-500", "dark:text-danger-400"], ["xmlns", "http://www.w3.org/2000/svg", "fill", "none", "viewBox", "0 0 24 24", "stroke", "currentColor", "stroke-width", "1.5", 1, "h-5", "w-5"], ["stroke-linecap", "round", "stroke-linejoin", "round", "d", "M3.98 8.223A10.477 10.477 0 0 0 1.934 12C3.226 16.338 7.244 19.5 12 19.5c.993 0 1.953-.138 2.863-.395M6.228 6.228A10.451 10.451 0 0 1 12 4.5c4.756 0 8.773 3.162 10.065 7.498a10.522 10.522 0 0 1-4.293 5.774M6.228 6.228 3 3m3.228 3.228 3.65 3.65m7.894 7.894L21 21m-3.228-3.228-3.65-3.65m0 0a3 3 0 1 0-4.243-4.243m4.242 4.242L9.88 9.88"], ["stroke-linecap", "round", "stroke-linejoin", "round", "d", "M2.036 12.322a1.012 1.012 0 0 1 0-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178Z"], ["stroke-linecap", "round", "stroke-linejoin", "round", "d", "M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z"], ["xmlns", "http://www.w3.org/2000/svg", "fill", "none", "viewBox", "0 0 24 24", 1, "h-5", "w-5", "animate-spin", "text-white"], ["cx", "12", "cy", "12", "r", "10", "stroke", "currentColor", "stroke-width", "4", 1, "opacity-25"], ["fill", "currentColor", "d", "M4 12a8 8 0 0 1 8-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 0 1 4 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z", 1, "opacity-75"], [1, "text-sm", "text-surface-500", "dark:text-surface-400", "mb-5"], [1, "flex", "flex-col", "gap-3", "mb-6", "animate-slide-up"], ["class", "group flex w-full items-center gap-4 rounded-xl border border-surface-200 dark:border-surface-600\n                 bg-white dark:bg-surface-800 p-4 text-left\n                 hover:border-brand-400 dark:hover:border-brand-500 hover:shadow-soft\n                 hover:-translate-y-0.5\n                 transition-all duration-200 ease-in-out", 3, "click", 4, "ngFor", "ngForOf"], ["type", "button", 1, "w-full", "rounded-lg", "border", "border-surface-200", "dark:border-surface-600", "px-4", "py-2.5", "text-sm", "font-medium", "text-surface-500", "dark:text-surface-400", "hover:bg-surface-50", "dark:hover:bg-surface-700", "focus:outline-none", "focus:ring-2", "focus:ring-brand-500/40", "transition-colors", 3, "click"], [1, "group", "flex", "w-full", "items-center", "gap-4", "rounded-xl", "border", "border-surface-200", "dark:border-surface-600", "bg-white", "dark:bg-surface-800", "p-4", "text-left", "hover:border-brand-400", "dark:hover:border-brand-500", "hover:shadow-soft", "hover:-translate-y-0.5", "transition-all", "duration-200", "ease-in-out", 3, "click"], [1, "flex", "h-10", "w-10", "flex-shrink-0", "items-center", "justify-center", "rounded-lg", "text-lg", 3, "ngStyle"], [3, "ngSwitch"], ["xmlns", "http://www.w3.org/2000/svg", "class", "h-5 w-5", "fill", "none", "viewBox", "0 0 24 24", "stroke", "currentColor", "stroke-width", "1.5", 4, "ngSwitchCase"], [1, "flex-1", "min-w-0"], [1, "block", "text-sm", "font-semibold", "text-surface-900", "dark:text-surface-100"], [1, "block", "text-xs", "text-surface-500", "dark:text-surface-400", "mt-0.5", "truncate"], ["xmlns", "http://www.w3.org/2000/svg", "fill", "none", "viewBox", "0 0 24 24", "stroke", "currentColor", "stroke-width", "2", 1, "h-5", "w-5", "flex-shrink-0", "text-surface-300", "dark:text-surface-600", "group-hover:text-brand-500", "transition-colors"], ["stroke-linecap", "round", "stroke-linejoin", "round", "d", "m8.25 4.5 7.5 7.5-7.5 7.5"], ["stroke-linecap", "round", "stroke-linejoin", "round", "d", "M9 12.75 11.25 15 15 9.75m-3-7.036A11.959 11.959 0 0 1 3.598 6 11.99 11.99 0 0 0 3 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285Z"], ["stroke-linecap", "round", "stroke-linejoin", "round", "d", "M13.5 21v-7.5a.75.75 0 0 1 .75-.75h3a.75.75 0 0 1 .75.75V21m-4.5 0H2.36m11.14 0H18m0 0h3.64m-1.39 0V9.349M3.75 21V9.349m0 0a3.001 3.001 0 0 0 3.75-.615A2.993 2.993 0 0 0 9.75 9.75c.896 0 1.7-.393 2.25-1.016a2.993 2.993 0 0 0 2.25 1.016c.896 0 1.7-.393 2.25-1.015a3.001 3.001 0 0 0 3.75.614m-16.5 0a3.004 3.004 0 0 1-.621-4.72l1.189-1.19A1.5 1.5 0 0 1 5.378 3h13.243a1.5 1.5 0 0 1 1.06.44l1.19 1.189a3 3 0 0 1-.621 4.72M6.75 18h3.75a.75.75 0 0 0 .75-.75V13.5a.75.75 0 0 0-.75-.75H6.75a.75.75 0 0 0-.75.75v3.75c0 .414.336.75.75.75Z"], ["stroke-linecap", "round", "stroke-linejoin", "round", "d", "M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z"]], template: function LoginComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        const fallbackIcon_r10 = \u0275\u0275reference(6);
        \u0275\u0275advance(4);
        \u0275\u0275property("ngIf", ctx.publicSettings.companyLogo())("ngIfElse", fallbackIcon_r10);
        \u0275\u0275advance(4);
        ...
        \u0275\u0275advance(4);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(20, 11, "common.privacy"));
        \u0275\u0275advance(5);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(25, 13, "common.terms"));
      }
    }, dependencies: [
      CommonModule,
      NgClass,
      ...
      TranslocoModule,
      TranslocoPipe
    ], styles: ["\n\n[_nghost-%COMP%] {\n  display: block;\n  width: 100%;\n  height: 100%;\n}\ninput[type=password][_ngcontent-%COMP%]::-ms-reveal, \ninput[type=password][_ngcontent-%COMP%]::-ms-clear {\n  display: none !important;\n}\ninput[type=password][_ngcontent-%COMP%]::-webkit-contacts-auto-fill-button, \ninput[type=password][_ngcontent-%COMP%]::-webkit-credentials-auto-fill-button {\n  visibility: hidden;\n  display: none !important;\n  pointer-events: none;\n}\n/*# sourceMappingURL=login.component.css.map */"] });
  }
};
(() => {
...
\r
    <!-- Header Section -->\r
    <div class="mb-8">\r
      <!-- Company Logo (from settings) or fallback icon -->\r
      <div class="mx-auto mb-5 flex items-center justify-center">\r
        <ng-container *ngIf="publicSettings.companyLogo(); else fallbackIcon">\r
          <img [src]="publicSettings.companyLogo()" alt="{{ appName }} logo"\r
               class="h-16 w-auto max-w-[200px] object-contain" />\r
        </ng-container>\r
        <ng-template #fallbackIcon>\r
          <!-- Static logo from assets if file exists, else SVG icon -->\r
          <img src="assets/images/logo.png" alt="{{ appName }} logo"\r
               class="h-16 w-auto max-w-[200px] object-contain"\r
               (error)="logoImgRef.style.display='none'; iconFallback.style.display='flex'"\r
               #logoImgRef />\r
          <div #iconFallback class="hidden h-14 w-14 items-center justify-center rounded-2xl bg-brand-100 dark:bg-brand-900/30 text-brand-600 dark:text-brand-400">\r
...
\r
      ...
      <div *ngIf="errorMessage"\r
           class="mb-6 rounded-lg bg-danger-50 dark:bg-danger-500/10 px-4 py-3 text-sm text-danger-600 dark:text-danger-400 animate-slide-down">\r
        ...
        <div *ngIf="isLockedOut && lockoutRemainingSeconds > 0"\r
             class="mt-2 flex items-center gap-1.5 text-xs font-medium">\r
          <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">\r
            <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />\r
          </svg>\r
          <span>Try again in <strong class="tabular-nums">{{ lockoutRemainingSeconds }}s</strong></span>\r
        </div>\r
      </div>\r
\r
...
`, styles: ["/* src/app/pages/auth/login/login.component.scss */\n:host {\n  display: block;\n  width: 100%;\n  height: 100%;\n}\ninput[type=password]::-ms-reveal,\ninput[type=password]::-ms-clear {\n  display: none !important;\n}\ninput[type=password]::-webkit-contacts-auto-fill-button,\ninput[type=password]::-webkit-credentials-auto-fill-button {\n  visibility: hidden;\n  display: none !important;\n  pointer-events: none;\n}\n/*# sourceMappingURL=login.component.css.map */\n"] }]
  }], () => [{ type: ApiService }, { type: AuthStateService }, { type: Router }, { type: ActivatedRoute }, { type: AppSettingsService }, { type: PublicSettingsService }, { type: SeoService }], null);
})();
(() => {
...
//# sourceMappingURL=chunk-BRXXTULY.js.map
