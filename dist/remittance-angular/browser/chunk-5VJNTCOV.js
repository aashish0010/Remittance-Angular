      ...
      <table class="w-full text-sm text-left whitespace-nowrap">
        <thead class="bg-surface-50 dark:bg-surface-700/50">
          <tr class="border-b border-surface-200 dark:border-surface-700 text-surface-600 dark:text-surface-300">
            ...
            <th class="px-4 py-3 font-semibold">Portal</th>
            <th class="px-4 py-3 font-semibold text-center">Users</th>
            <th class="px-4 py-3 font-semibold text-center">Permissions</th>
            ...
            <td class="px-4 py-3 text-right">
              <ng-container *ngIf="role.roleType !== 'SystemAdmin'">
                <div class="flex items-center justify-end gap-1">
                  <button title="Edit" (click)="openEdit(role)"
                  ...
                  <button title="Permissions" (click)="openPermissions(role)"
                  ...
                  <button title="Delete" (click)="deleteRole(role)" [disabled]="role.userCount > 0"
...
//# sourceMappingURL=chunk-5VJNTCOV.js.map
