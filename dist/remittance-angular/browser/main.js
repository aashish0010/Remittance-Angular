...
var AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
   ...
   */
  loadImpl() {
    const loadFn = () => this.moduleImpl ?? import("./chunk-TUSISAPY.js").then((m) => m);
...
var routes = [
  ...
  {
    path: "auth",
    loadComponent: () => import("./chunk-3QDMF6ND.js").then((m) => m.LoginLayoutComponent),
    children: [
      { path: "login", loadComponent: () => import("./chunk-4DL4VN5C.js").then((m) => m.LoginComponent) },
  ...
  {
    path: "admin",
    loadComponent: () => import("./chunk-SQQ543SA.js").then((m) => m.AdminLayoutComponent),
    canActivate: [authGuard],
    children: [
      { path: "dashboard", loadComponent: () => import("./chunk-AIXZNZWN.js").then((m) => m.AdminDashboardComponent) },
      { path: "agents", loadComponent: () => import("./chunk-KGE74O6W.js").then((m) => m.AgentManagementComponent) },
      { path: "setup", loadComponent: () => import("./chunk-W3F2IQA7.js").then((m) => m.AccountingComponent) },
      { path: "transactions", loadComponent: () => import("./chunk-SKQGOS5T.js").then((m) => m.AdminTransactionsComponent) },
      { path: "customer-register", loadComponent: () => import("./chunk-BCR4A3G7.js").then((m) => m.CustomerRegisterComponent) },
      { path: "customer-report", loadComponent: () => import("./chunk-5H4T5NO6.js").then((m) => m.CustomerReportComponent) },
      { path: "receivers", loadComponent: () => import("./chunk-RANH4CHQ.js").then((m) => m.ReceiversComponent) },
      { path: "rates", loadComponent: () => import("./chunk-DAQJ2SZ3.js").then((m) => m.ExchangeRatesComponent) },
      { path: "commissions", loadComponent: () => import("./chunk-KMLF3U4W.js").then((m) => m.CommissionsComponent) },
      { path: "routing", loadComponent: () => import("./chunk-KZFYHXDC.js").then((m) => m.RoutingComponent) },
      { path: "accounting", loadComponent: () => import("./chunk-W3F2IQA7.js").then((m) => m.AccountingComponent) },
      { path: "compliance", loadComponent: () => import("./chunk-2EEHWA6F.js").then((m) => m.ComplianceComponent) },
      { path: "compliance-setup", loadComponent: () => import("./chunk-RGM22BJY.js").then((m) => m.ComplianceSetupComponent) },
  ...
  {
    path: "agent",
    loadComponent: () => import("./chunk-R6DLNHRL.js").then((m) => m.AgentLayoutComponent),
    canActivate: [authGuard],
    children: [
      { path: "dashboard", loadComponent: () => import("./chunk-PDGMAMBR.js").then((m) => m.AgentDashboardComponent) },
      { path: "send", loadComponent: () => import("./chunk-KZONDXUR.js").then((m) => m.SendMoneyComponent) },
      { path: "transactions", loadComponent: () => import("./chunk-Q77FA5AR.js").then((m) => m.AgentTransactionsComponent) },
      { path: "", redirectTo: "dashboard", pathMatch: "full" }
    ]
  },
  // Customer Portal
  {
    path: "customer",
    loadComponent: () => import("./chunk-IFHA5PXQ.js").then((m) => m.CustomerLayoutComponent),
    canActivate: [authGuard],
    children: [
      { path: "dashboard", loadComponent: () => import("./chunk-FU4TMBZA.js").then((m) => m.CustomerDashboardComponent) },
      { path: "send", loadComponent: () => import("./chunk-BWTYYDB3.js").then((m) => m.CustomerSendComponent) },
      { path: "transactions", loadComponent: () => import("./chunk-KQMPHM5P.js").then((m) => m.CustomerTransactionsComponent) },
      { path: "", redirectTo: "dashboard", pathMatch: "full" }
    ]
  },
  // Default redirect
