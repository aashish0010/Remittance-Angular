...
var LanguageService = class _LanguageService {
  ...
  init() {
    ...
    if (saved && this.availableLanguages.some((l18) => l18.code === saved)) {
  ...
  getActiveLanguage() {
    ...
    return this.availableLanguages.find((l18) => l18.code === code) ?? this.availableLanguages[0];
  }
  static {
...
var HttpLoader = class _HttpLoader {
  constructor() {
  ...
  static {
    this.\u0275fac = function HttpLoader_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _HttpLoader)();
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _HttpLoader, factory: _HttpLoader.\u0275fac, providedIn: "root" });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(HttpLoader, [{
    type: Injectable,
    args: [{ providedIn: "root" }]
  }], null, null);
})();
var appConfig = {
  providers: [
    ...
    provideEchartsCore({ echarts: () => import("./chunk-CM4DBHIR.js").then((m4) => m4.default) }),
    provideTransloco({
      config: {
