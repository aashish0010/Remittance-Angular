...
function AgentManagementComponent_div_25_div_11_tr_17_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "td", 122)(8, "span", 123);
    \u0275\u0275text(9);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(10, "td", 122)(11, "span", 42);
    \u0275\u0275text(12);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(13, "td", 122)(14, "div", 45)(15, "button", 124);
    ...
    \u0275\u0275element(17, "path", 125);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(18, "button", 126);
    ...
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(22, "svg", 128);
    \u0275\u0275template(23, AgentManagementComponent_div_25_div_11_tr_17__svg_path_23_Template, 1, 0, "path", 129)(24, AgentManagementComponent_div_25_div_11_tr_17__svg_path_24_Template, 1, 0, "path", 130);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
...
function AgentManagementComponent_div_27_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 136)(1, "div", 72)(2, "div", 73)(3, "h3", 74);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "button", 75);
    ...
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(43, "div", 100)(44, "button", 139);
...
function AgentManagementComponent_div_29_div_11_tr_19_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(12, AgentManagementComponent_div_29_div_11_tr_19_span_12_Template, 2, 0, "span", 141);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "td", 122)(14, "div", 45)(15, "button", 142);
...
function AgentManagementComponent_div_29_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 136)(1, "div", 111)(2, "div", 73)(3, "h3", 74);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "button", 75);
...
function AgentManagementComponent_div_31_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(36, "Operator");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(37, "option", 148);
    \u0275\u0275text(38, "Manager");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(39, "option", 149);
    \u0275\u0275text(40, "Cashier");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(41, "label", 150)(42, "input", 151);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(43, "span", 152);
    \u0275\u0275text(44, "Default User");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(45, "div", 100)(46, "button", 139);
...
function AgentManagementComponent_div_33_div_11_tr_19_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "td", 122)(4, "span", 123);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275text(9);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "td", 122)(11, "span", 123);
    \u0275\u0275text(12);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(13, "td", 122)(14, "span", 42);
    \u0275\u0275text(15);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(16, "td", 122)(17, "div", 45)(18, "button", 153);
    ...
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(25, "svg", 128);
    \u0275\u0275template(26, AgentManagementComponent_div_33_div_11_tr_19__svg_path_26_Template, 1, 0, "path", 129)(27, AgentManagementComponent_div_33_div_11_tr_19__svg_path_27_Template, 1, 0, "path", 130);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(28, "button", 131);
...
function AgentManagementComponent_div_35_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(19, "option", 155);
    \u0275\u0275text(20, "Select");
    \u0275\u0275elementEnd();
    \u0275\u0275template(21, AgentManagementComponent_div_35_option_21_Template, 2, 2, "option", 156);
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(57, "textarea", 157);
    ...
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(58, "div", 100)(59, "button", 139);
...
function AgentManagementComponent_div_37_div_11_tr_17_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(10);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "td", 122)(12, "div", 45)(13, "button", 142);
...
function AgentManagementComponent_div_37_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 136)(1, "div", 158)(2, "div", 73)(3, "h3", 74);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "button", 75);
...
function AgentManagementComponent_div_39_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(31, "div", 100)(32, "button", 139);
  ...
  <div class="bg-white dark:bg-surface-800 rounded-2xl shadow-xl w-full max-w-2xl pointer-events-auto max-h-[90vh] overflow-y-auto">
    ...
    <div class="p-6 space-y-5">
      ...
      <div>
        ...
        <select [(ngModel)]="newAgent.agentType" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-700 border border-surface-200 dark:border-surface-600 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30">
      ...
      <div class="p-4 rounded-lg border border-surface-100 dark:border-surface-700 bg-surface-50 dark:bg-surface-900/50 space-y-3">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
          ...
          <div><label class="block text-xs font-medium text-surface-500 mb-1">Agent Type *</label>
            <select [(ngModel)]="editAgent.agentType" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-700 border border-surface-200 dark:border-surface-600 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30"><option value="SendingAgent">Sending Agent</option><option value="PayoutAgent">Payout Agent</option></select></div>
        </div>
      </div>
    </div>
    <div class="flex items-center justify-end gap-3 px-6 py-4 border-t border-surface-100 dark:border-surface-700">
          ...
          <tr *ngFor="let u of userLocation.users" class="hover:bg-surface-50 dark:hover:bg-surface-750">
            ...
            <td class="px-4 py-2.5">
              <div class="flex items-center gap-0.5">
                ...
                <button aria-label="Delete" (click)="deleteUser(u.id)" class="p-1.5 rounded text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20"><svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="m14.74 9-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 01-2.244 2.077H8.084a2.25 2.25 0 01-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 00-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 013.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 00-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 00-7.5 0"/></svg></button>
              </div>
            </td>
          </tr>
        </tbody>
...
//# sourceMappingURL=chunk-7DQ56GXO.js.map
