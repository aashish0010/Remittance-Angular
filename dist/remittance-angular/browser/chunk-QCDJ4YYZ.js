    ...
    <div class="overflow-x-auto" *ngIf="report.agentSummaries.length > 0">
      <table class="w-full text-sm">
        <thead class="bg-surface-50 dark:bg-surface-700/50">
          <tr>
            <th class="px-4 py-3 text-left font-semibold text-surface-600 dark:text-surface-300">Agent Name</th>
            <th class="px-4 py-3 text-left font-semibold text-surface-600 dark:text-surface-300">Agent Type</th>
            <th class="px-4 py-3 text-right font-semibold text-surface-600 dark:text-surface-300">Sending Service Charge</th>
            <th class="px-4 py-3 text-right font-semibold text-surface-600 dark:text-surface-300">Payout Service Charge</th>
            <th class="px-4 py-3 text-right font-semibold text-surface-600 dark:text-surface-300">Total Earnings</th>
            <th class="px-4 py-3 text-right font-semibold text-surface-600 dark:text-surface-300">Transaction Count</th>
          </tr>
        </thead>
...
//# sourceMappingURL=chunk-QCDJ4YYZ.js.map
