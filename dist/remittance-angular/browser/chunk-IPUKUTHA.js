...
var ApiService = class _ApiService {
  ...
  resolveAlert(id, resolution) {
    return this.put(`api/admin/compliance/alerts/${id}/resolve`, resolution);
  }
  releaseAlert(id) {
    return this.put(`api/admin/compliance/alerts/${id}/release`);
  }
  // ---------------------------------------------------------------------------
  // Compliance Rules
  // ---------------------------------------------------------------------------
...
//# sourceMappingURL=chunk-IPUKUTHA.js.map
