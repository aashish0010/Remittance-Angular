...
function ExchangeRatesComponent_div_17_tr_25_ng_container_32_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "button", 59);
    \u0275\u0275listener("click", function ExchangeRatesComponent_div_17_tr_25_ng_container_32_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r5);
...
function ExchangeRatesComponent_div_17_tr_25_span_33_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "span", 61)(1, "span", 62);
    \u0275\u0275text(2, "Delete?");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "button", 63);
    \u0275\u0275listener("click", function ExchangeRatesComponent_div_17_tr_25_span_33_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r6);
      const r_r4 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      ctx_r1.deleteRate(r_r4);
      return \u0275\u0275resetView(ctx_r1.deleteConfirmId = null);
    });
    \u0275\u0275text(4, "Yes");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "button", 64);
    \u0275\u0275listener("click", function ExchangeRatesComponent_div_17_tr_25_span_33_Template_button_click_5_listener() {
      \u0275\u0275restoreView(_r6);
...
function ExchangeRatesComponent_div_17_tr_25_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(31, " Edit ");
    \u0275\u0275elementEnd();
    \u0275\u0275template(32, ExchangeRatesComponent_div_17_tr_25_ng_container_32_Template, 5, 0, "ng-container", 57)(33, ExchangeRatesComponent_div_17_tr_25_span_33_Template, 7, 0, "span", 58);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(11, 10, r_r4.rate, "1.2-2"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(14, 13, r_r4.margin, "1.2-2"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(17, 16, r_r4.rate - (r_r4.margin || 0), "1.2-2"));
    \u0275\u0275advance(3);
...
function ExchangeRatesComponent_div_17_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(25, ExchangeRatesComponent_div_17_tr_25_Template, 34, 19, "tr", 27);
    \u0275\u0275elementEnd()()();
...
function ExchangeRatesComponent_div_19_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 67)(1, "div", 68)(2, "h3", 69);
    ...
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(5, "svg", 71);
    \u0275\u0275element(6, "path", 72);
    \u0275\u0275elementEnd()()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(7, "div", 73)(8, "div", 74)(9, "span", 75);
    \u0275\u0275text(10, "Payout Agent");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "span", 76);
    \u0275\u0275text(12);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(13, "div", 74)(14, "span", 75);
    \u0275\u0275text(15, "Country");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(22);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(23, "div", 74)(24, "span", 75);
    \u0275\u0275text(25, "Destination Currency");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(26, "span", 76);
    \u0275\u0275text(27);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(28, "div", 74)(29, "span", 75);
    \u0275\u0275text(30, "Rate");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(33, "number");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(34, "div", 74)(35, "span", 75);
    \u0275\u0275text(36, "Margin");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(39, "number");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(40, "div", 78)(41, "span", 75);
    \u0275\u0275text(42, "Customer Rate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(43, "span", 79);
    \u0275\u0275text(44);
    \u0275\u0275pipe(45, "number");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(46, "div", 78)(47, "span", 75);
    \u0275\u0275text(48, "Status");
    \u0275\u0275elementEnd();
...
function ExchangeRatesComponent_div_21_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 80)(1, "div", 68)(2, "h3", 81);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "button", 70);
    ...
    \u0275\u0275element(6, "path", 72);
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(7, ExchangeRatesComponent_div_21_div_7_Template, 2, 1, "div", 82);
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(8, "div", 83)(9, "div", 84)(10, "label", 85);
    \u0275\u0275text(11, "Payout Agent *");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "select", 86);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(15, ExchangeRatesComponent_div_21_option_15_Template, 2, 2, "option", 88);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(16, "div", 84)(17, "label", 85);
    \u0275\u0275text(18, "Payout Country");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "select", 86);
    ...
    \u0275\u0275elementStart(20, "option", 89);
    \u0275\u0275text(21, "-- Select Country --");
    \u0275\u0275elementEnd();
    \u0275\u0275template(22, ExchangeRatesComponent_div_21_option_22_Template, 2, 2, "option", 90);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(23, "div")(24, "label", 85);
    \u0275\u0275text(25, "Source Currency *");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(26, "select", 86);
    ...
    \u0275\u0275elementStart(27, "option", 91);
    \u0275\u0275text(28, "Select");
    \u0275\u0275elementEnd();
    \u0275\u0275template(29, ExchangeRatesComponent_div_21_option_29_Template, 2, 2, "option", 90);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(30, "div")(31, "label", 85);
    \u0275\u0275text(32, "Destination Currency *");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(33, "select", 86);
    ...
    \u0275\u0275text(35, "Select");
    \u0275\u0275elementEnd();
    \u0275\u0275template(36, ExchangeRatesComponent_div_21_option_36_Template, 2, 2, "option", 90);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(37, "div")(38, "label", 85);
    \u0275\u0275text(39, "Rate *");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(45, "div", 93)(46, "button", 3);
    ...
    \u0275\u0275template(49, ExchangeRatesComponent_div_21__svg_svg_49_Template, 3, 0, "svg", 95)(50, ExchangeRatesComponent_div_21__svg_svg_50_Template, 2, 0, "svg", 96);
    \u0275\u0275text(51);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    <table class="w-full text-sm text-left">
      <thead>
        <tr
          ...
          <th scope="col" class="px-4 py-3 font-semibold">Payout Agent</th>
          <th scope="col" class="px-4 py-3 font-semibold">Corridor</th>
          <th scope="col" class="px-4 py-3 font-semibold">Rate</th>
          <th scope="col" class="px-4 py-3 font-semibold">Margin</th>
          <th scope="col" class="px-4 py-3 font-semibold">Customer Rate</th>
          ...
          <td class="px-4 py-3">
            <div class="flex items-center gap-1">
              ...
              <ng-container *ngIf="deleteConfirmId !== r.id">
                <button (click)="deleteConfirmId = r.id"
              ...
              <span *ngIf="deleteConfirmId === r.id" class="inline-flex items-center gap-1.5 text-xs">
                ...
                <button (click)="deleteRate(r); deleteConfirmId = null"
...
<div *ngIf="showDetail && detailRate"
  role="dialog" aria-modal="true" aria-labelledby="rate-detail-title"
  ...
  <div class="flex items-center justify-between mb-5">
    <h3 id="rate-detail-title" class="text-lg font-semibold text-surface-900 dark:text-surface-100">Exchange Rate Details</h3>
    <button (click)="closeDetail()" aria-label="Close dialog"
...
<div *ngIf="showFormPopup"
  role="dialog" aria-modal="true" aria-labelledby="rate-form-title"
  ...
  <div class="flex items-center justify-between mb-5">
    <h3 id="rate-form-title" class="text-lg font-semibold text-surface-900 dark:text-surface-100">{{ isEditing ? 'Edit Exchange Rate' : 'Add
      New Exchange Rate' }}</h3>
    <button (click)="closeFormPopup()" aria-label="Close dialog"
      class="p-1.5 rounded-lg text-surface-400 hover:text-surface-600 dark:hover:text-surface-200 hover:bg-surface-100 dark:hover:bg-surface-700 transition">
      <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" />
      </svg>
...
//# sourceMappingURL=chunk-IGWL2CWE.js.map
