...
function AgentLayoutComponent_ng_container_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(5, "path", 38);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(6, AgentLayoutComponent_ng_container_13_ng_container_6_Template, 2, 1, "ng-container", 48);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function AgentLayoutComponent_div_35_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, AgentLayoutComponent_div_35_button_4_Template, 2, 0, "button", 55);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "div", 56);
    \u0275\u0275template(6, AgentLayoutComponent_div_35_div_6_Template, 10, 7, "div", 57)(7, AgentLayoutComponent_div_35_div_7_Template, 5, 0, "div", 58);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext();
...
function AgentLayoutComponent_div_48_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(11, "svg", 77);
    \u0275\u0275element(12, "path", 78);
    \u0275\u0275elementEnd();
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AgentLayoutComponent, selectors: [["app-agent-layout"]], hostBindings: function AgentLayoutComponent_HostBindings(rf, ctx) {
      ...
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd()();
        \u0275\u0275namespaceHTML();
        \u0275\u0275elementStart(49, "main", 40)(50, "div", 41);
...
//# sourceMappingURL=chunk-I2RCBV2O.js.map
