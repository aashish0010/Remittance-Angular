...
var ComplianceSetupComponent = class _ComplianceSetupComponent {
  constructor(api, auth, notify, confirmDelete) {
    this.api = api;
    this.auth = auth;
    this.notify = notify;
        ...
        <tr *ngFor="let r of filteredRules" class="border-b border-surface-100 dark:border-surface-700 hover:bg-surface-50 dark:hover:bg-surface-750 transition-colors">
          ...
          <td class="px-4 py-3">
            <div class="flex items-center gap-1">
              ...
              <button aria-label="Delete rule" (click)="deleteRule(r)" class="p-1.5 rounded-md text-danger-500 hover:bg-danger-50 dark:hover:bg-danger-900/20 transition"><svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/></svg></button>
            </div>
          </td>
        </tr>
      </tbody>
...
<div *ngIf="showPopup" class="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
  ...
  }], () => [{ type: ApiService }, { type: AuthStateService }, { type: NotificationService }, { type: ConfirmDeleteService }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ComplianceSetupComponent, { className: "ComplianceSetupComponent", filePath: "src/app/pages/admin/compliance-setup/compliance-setup.component.ts", lineNumber: 48 });
})();
export {
  ComplianceSetupComponent
};
//# sourceMappingURL=chunk-EJBVUAMG.js.map
