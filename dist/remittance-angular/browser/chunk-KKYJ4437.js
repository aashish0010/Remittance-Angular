  ...
  <div class="overflow-x-auto">
    <table class="w-full text-sm text-left">
      <thead class="bg-surface-50 dark:bg-surface-700/50 border-b border-surface-200 dark:border-surface-700">
        <tr>
          <th scope="col" class="px-4 py-3 font-semibold text-surface-600 dark:text-surface-300">Reference</th>
          <th scope="col" class="px-4 py-3 font-semibold text-surface-600 dark:text-surface-300">Sender</th>
          <th scope="col" class="px-4 py-3 font-semibold text-surface-600 dark:text-surface-300">Receiver</th>
          <th scope="col" class="px-4 py-3 font-semibold text-surface-600 dark:text-surface-300">Amount</th>
          <th scope="col" class="px-4 py-3 font-semibold text-surface-600 dark:text-surface-300">Alert Type</th>
          <th scope="col" class="px-4 py-3 font-semibold text-surface-600 dark:text-surface-300">Txn Status</th>
          <th scope="col" class="px-4 py-3 font-semibold text-surface-600 dark:text-surface-300">Alert</th>
            ...
            <div class="flex items-center gap-1">
              ...
              <ng-container *ngIf="!a.isResolved">
                ...
                <button (click)="rejectAlert(a)"
                        role="alert" aria-live="assertive" class="inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-medium text-danger-600 dark:text-danger-400 hover:bg-danger-50 dark:hover:bg-danger-900/20 transition">
  ...
  <div class="flex flex-col sm:flex-row items-center justify-between gap-3 px-4 py-3 border-t border-surface-200 dark:border-surface-700">
    ...
    <div class="flex items-center gap-1">
      <button (click)="pageIndex = 0; loadAlerts()" [disabled]="pageIndex === 0"
              class="p-1.5 rounded-lg hover:bg-surface-100 dark:hover:bg-surface-700 disabled:opacity-30 disabled:cursor-not-allowed transition" aria-label="First page">
      ...
      <button (click)="pageIndex = pageIndex - 1; loadAlerts()" [disabled]="pageIndex === 0"
              class="p-1.5 rounded-lg hover:bg-surface-100 dark:hover:bg-surface-700 disabled:opacity-30 disabled:cursor-not-allowed transition" aria-label="Previous page">
      ...
      <button (click)="pageIndex = pageIndex + 1; loadAlerts()" [disabled]="(pageIndex + 1) * pageSize >= totalCount"
              class="p-1.5 rounded-lg hover:bg-surface-100 dark:hover:bg-surface-700 disabled:opacity-30 disabled:cursor-not-allowed transition" aria-label="Next page">
      ...
      <button (click)="pageIndex = Math.ceil(totalCount / pageSize) - 1; loadAlerts()" [disabled]="(pageIndex + 1) * pageSize >= totalCount"
              class="p-1.5 rounded-lg hover:bg-surface-100 dark:hover:bg-surface-700 disabled:opacity-30 disabled:cursor-not-allowed transition" aria-label="Last page">
...
<div *ngIf="selectedAlert" role="dialog" aria-modal="true" class="fixed inset-0 z-[1000] flex items-center justify-center bg-black/50 backdrop-blur-sm" (click)="closeDetail()">
...
<div *ngIf="showResolvePopup" role="dialog" aria-modal="true" class="fixed inset-0 z-[1000] flex items-center justify-center bg-black/50 backdrop-blur-sm" (click)="closeResolvePopup()">
...
//# sourceMappingURL=chunk-KKYJ4437.js.map
