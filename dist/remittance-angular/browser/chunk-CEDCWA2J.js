...
var SignalRService = class _SignalRService {
  constructor() {
    this.hub = null;
    this.transactionStatusUpdated$ = new Subject();
  }
  startConnection() {
    if (this.hub)
      return;
    this.hub = new HubConnectionBuilder().withUrl(`${environment.apiUrl}hubs/transactions`, {
      withCredentials: true
    }).withAutomaticReconnect().build();
    this.hub.on("TransactionStatusUpdated", (update) => {
...
//# sourceMappingURL=chunk-CEDCWA2J.js.map
