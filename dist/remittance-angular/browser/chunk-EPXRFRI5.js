...
function AgentManagementComponent_div_21_div_71_Template(rf, ctx) {
  if (rf & 1) {
    const _r17 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 91)(1, "h4", 92);
    \u0275\u0275text(2, "API Settings");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "label", 111)(4, "div", 112)(5, "input", 113);
    \u0275\u0275twoWayListener("ngModelChange", function AgentManagementComponent_div_21_div_71_Template_input_ngModelChange_5_listener($event) {
      \u0275\u0275restoreView(_r17);
      const ctx_r1 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r1.newAgent.isThirdPartyApi, $event) || (ctx_r1.newAgent.isThirdPartyApi = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd();
    \u0275\u0275element(6, "div", 114)(7, "div", 115);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "div")(9, "span", 116);
    \u0275\u0275text(10, "Third Party API Agent");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "p", 117);
    \u0275\u0275text(12, "Field mappings are configured separately in field mapping management.");
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(5);
    \u0275\u0275twoWayProperty("ngModel", ctx_r1.newAgent.isThirdPartyApi);
  }
}
function AgentManagementComponent_div_21__svg_svg_76_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
...
function AgentManagementComponent_div_21_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("change", function AgentManagementComponent_div_21_Template_select_change_13_listener() {
      \u0275\u0275restoreView(_r13);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onNewAgentTypeChange());
    });
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(30, "div", 96)(31, "label", 94);
    \u0275\u0275text(32, "Address");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(33, "input", 95);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(37, "div", 97)(38, "div")(39, "label", 94);
    \u0275\u0275text(40, "Full Name *");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(41, "input", 95);
    ...
    \u0275\u0275elementStart(58, "option", 99);
    \u0275\u0275text(59, "Select");
    \u0275\u0275elementEnd();
    \u0275\u0275template(60, AgentManagementComponent_div_21_option_60_Template, 2, 2, "option", 100);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(61, "div")(62, "label", 94);
    \u0275\u0275text(63, "City *");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(64, "input", 95);
    ...
    \u0275\u0275template(69, AgentManagementComponent_div_21_option_69_Template, 2, 2, "option", 100);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(70, AgentManagementComponent_div_21_ng_container_70_Template, 13, 2, "ng-container", 44);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(71, AgentManagementComponent_div_21_div_71_Template, 13, 1, "div", 101);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(72, "div", 102)(73, "button", 103);
    \u0275\u0275listener("click", function AgentManagementComponent_div_21_Template_button_click_73_listener() {
      \u0275\u0275restoreView(_r13);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.closeCreatePopup());
    });
    ...
    \u0275\u0275template(76, AgentManagementComponent_div_21__svg_svg_76_Template, 3, 0, "svg", 105);
    \u0275\u0275text(77, " Create Agent ");
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.newAgent.agentType === "PayoutAgent");
    \u0275\u0275advance(4);
...
function AgentManagementComponent_div_23_div_67_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "label", 111)(4, "div", 112)(5, "input", 113);
    \u0275\u0275twoWayListener("ngModelChange", function AgentManagementComponent_div_23_div_67_Template_input_ngModelChange_5_listener($event) {
      \u0275\u0275restoreView(_r23);
      const ctx_r1 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r1.editAgent.isThirdPartyApi, $event) || (ctx_r1.editAgent.isThirdPartyApi = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd();
    \u0275\u0275element(6, "div", 114)(7, "div", 115);
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(5);
    \u0275\u0275twoWayProperty("ngModel", ctx_r1.editAgent.isThirdPartyApi);
  }
}
function AgentManagementComponent_div_23__svg_svg_72_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "svg", 118);
    \u0275\u0275element(1, "circle", 18)(2, "path", 19);
...
function AgentManagementComponent_div_23_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(22, "div", 96)(23, "label", 94);
    \u0275\u0275text(24, "Address");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(25, "input", 95);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(29, "div", 119)(30, "div")(31, "span", 79);
    \u0275\u0275text(32, "Full Name");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275template(48, AgentManagementComponent_div_23_option_48_Template, 2, 2, "option", 100);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(49, "div")(50, "label", 94);
    \u0275\u0275text(51, "City *");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(52, "input", 95);
    ...
    \u0275\u0275template(57, AgentManagementComponent_div_23_option_57_Template, 2, 2, "option", 100);
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275listener("change", function AgentManagementComponent_div_23_Template_select_change_62_listener() {
      \u0275\u0275restoreView(_r19);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onEditAgentTypeChange());
    });
    ...
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275template(67, AgentManagementComponent_div_23_div_67_Template, 13, 1, "div", 101);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(68, "div", 102)(69, "button", 103);
    \u0275\u0275listener("click", function AgentManagementComponent_div_23_Template_button_click_69_listener() {
      \u0275\u0275restoreView(_r19);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.closeEditPopup());
    });
    \u0275\u0275text(70, "Cancel");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(71, "button", 104);
    \u0275\u0275listener("click", function AgentManagementComponent_div_23_Template_button_click_71_listener() {
      \u0275\u0275restoreView(_r19);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.updateAgent());
    });
    \u0275\u0275template(72, AgentManagementComponent_div_23__svg_svg_72_Template, 3, 0, "svg", 105);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(5);
    \u0275\u0275property("ngIf", ctx_r1.editAgent.agentType === "PayoutAgent");
    \u0275\u0275advance(4);
...
function AgentManagementComponent_div_25_div_11_tr_17_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "td", 131)(8, "span", 132);
    \u0275\u0275text(9);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(10, "td", 131)(11, "span", 42);
    \u0275\u0275text(12);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(13, "td", 131)(14, "div", 45)(15, "button", 133);
    \u0275\u0275listener("click", function AgentManagementComponent_div_25_div_11_tr_17_Template_button_click_15_listener() {
      const loc_r27 = \u0275\u0275restoreView(_r26).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.openUserManagement(loc_r27));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(16, "svg", 4);
    \u0275\u0275element(17, "path", 134);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    ...
    \u0275\u0275listener("click", function AgentManagementComponent_div_25_div_11_tr_17_Template_button_click_18_listener() {
      const loc_r27 = \u0275\u0275restoreView(_r26).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.openLocationForm(loc_r27));
    });
    \u0275\u0275namespaceSVG();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(21, "button", 136);
    \u0275\u0275listener("click", function AgentManagementComponent_div_25_div_11_tr_17_Template_button_click_21_listener() {
      const loc_r27 = \u0275\u0275restoreView(_r26).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.toggleLocation(loc_r27.id));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(22, "svg", 137);
    \u0275\u0275template(23, AgentManagementComponent_div_25_div_11_tr_17__svg_path_23_Template, 1, 0, "path", 138)(24, AgentManagementComponent_div_25_div_11_tr_17__svg_path_24_Template, 1, 0, "path", 139);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(25, "button", 140);
    \u0275\u0275listener("click", function AgentManagementComponent_div_25_div_11_tr_17_Template_button_click_25_listener() {
      const loc_r27 = \u0275\u0275restoreView(_r26).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.deleteLocation(loc_r27.id, loc_r27.locationName));
    });
    \u0275\u0275namespaceSVG();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(loc_r27.locationName);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(loc_r27.locationCode || "-");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate2("", loc_r27.country || "-", " / ", loc_r27.city || "-", "");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(loc_r27.users.length);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngClass", loc_r27.isActive ? "bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400" : "bg-surface-100 text-surface-500 dark:bg-surface-700 dark:text-surface-400");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(loc_r27.isActive ? "Active" : "Inactive");
    \u0275\u0275advance(9);
    \u0275\u0275property("title", loc_r27.isActive ? "Deactivate" : "Activate")("ngClass", loc_r27.isActive ? "text-green-600" : "text-surface-400");
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", loc_r27.isActive);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !loc_r27.isActive);
  }
}
function AgentManagementComponent_div_25_div_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 26)(1, "table", 27)(2, "thead", 125)(3, "tr")(4, "th", 126);
    \u0275\u0275text(5, "Location");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "th", 126);
    \u0275\u0275text(7, "Code");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "th", 126);
    \u0275\u0275text(9, "Country / City");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "th", 126);
    \u0275\u0275text(11, "Users");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "th", 126);
    \u0275\u0275text(13, "Status");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "th", 126);
    \u0275\u0275text(15, "Actions");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(16, "tbody", 30);
    \u0275\u0275template(17, AgentManagementComponent_div_25_div_11_tr_17_Template, 28, 11, "tr", 127);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function AgentManagementComponent_div_25_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 71)(1, "div", 120)(2, "div", 73)(3, "h3", 74);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "button", 75);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275template(11, AgentManagementComponent_div_25_div_11_Template, 18, 1, "div", 123)(12, AgentManagementComponent_div_25_div_12_Template, 2, 0, "div", 124);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function AgentManagementComponent_div_27_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 145)(1, "div", 72)(2, "div", 73)(3, "h3", 74);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "button", 75);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(27, "div", 96)(28, "label", 94);
    \u0275\u0275text(29, "Address");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(30, "input", 95);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(39, "div", 96)(40, "label", 94);
    ...
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(43, "div", 102)(44, "button", 148);
...
function AgentManagementComponent_div_29_div_11_tr_19_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "td", 130);
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "td", 130);
    \u0275\u0275text(10);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "td", 131);
    \u0275\u0275template(12, AgentManagementComponent_div_29_div_11_tr_19_span_12_Template, 2, 0, "span", 150);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "td", 131)(14, "div", 45)(15, "button", 151);
    \u0275\u0275listener("click", function AgentManagementComponent_div_29_div_11_tr_19_Template_button_click_15_listener() {
      const u_r33 = \u0275\u0275restoreView(_r32).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.openUserForm(u_r33));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(16, "svg", 4);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(u_r33.fullName);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(u_r33.email);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(u_r33.userName || "-");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(u_r33.phone || "-");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(u_r33.role || "-");
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", u_r33.isDefault);
  }
}
function AgentManagementComponent_div_29_div_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(15, "Default");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "th", 126);
    \u0275\u0275text(17, "Actions");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(18, "tbody", 30);
    \u0275\u0275template(19, AgentManagementComponent_div_29_div_11_tr_19_Template, 21, 6, "tr", 127);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function AgentManagementComponent_div_29_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 145)(1, "div", 120)(2, "div", 73)(3, "h3", 74);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "button", 75);
    ...
    \u0275\u0275text(10, "+ Add User");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(11, AgentManagementComponent_div_29_div_11_Template, 20, 1, "div", 123)(12, AgentManagementComponent_div_29_div_12_Template, 2, 0, "div", 124);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function AgentManagementComponent_div_31_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 154)(1, "div", 72)(2, "div", 73)(3, "h3", 74);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "button", 75);
    ...
    \u0275\u0275elementStart(35, "option", 156);
    \u0275\u0275text(36, "Operator");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(37, "option", 157);
    \u0275\u0275text(38, "Manager");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(39, "option", 158);
    \u0275\u0275text(40, "Cashier");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(41, "label", 159)(42, "input", 160);
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(45, "div", 102)(46, "button", 148);
...
function AgentManagementComponent_div_33_div_11_tr_19_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "td", 131)(4, "span", 132);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "td", 130);
    \u0275\u0275text(7);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "td", 130);
    \u0275\u0275text(9);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "td", 131)(11, "span", 132);
    \u0275\u0275text(12);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(13, "td", 131)(14, "span", 42);
    \u0275\u0275text(15);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(16, "td", 131)(17, "div", 45)(18, "button", 162);
    \u0275\u0275listener("click", function AgentManagementComponent_div_33_div_11_tr_19_Template_button_click_18_listener() {
      const b_r39 = \u0275\u0275restoreView(_r38).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.openBankBranchManagement(b_r39));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(19, "svg", 4);
    \u0275\u0275element(20, "path", 163);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(21, "button", 135);
    \u0275\u0275listener("click", function AgentManagementComponent_div_33_div_11_tr_19_Template_button_click_21_listener() {
      const b_r39 = \u0275\u0275restoreView(_r38).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.openBankForm(b_r39));
    });
    \u0275\u0275namespaceSVG();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(24, "button", 136);
    \u0275\u0275listener("click", function AgentManagementComponent_div_33_div_11_tr_19_Template_button_click_24_listener() {
      const b_r39 = \u0275\u0275restoreView(_r38).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.toggleBank(b_r39.id));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(25, "svg", 137);
    \u0275\u0275template(26, AgentManagementComponent_div_33_div_11_tr_19__svg_path_26_Template, 1, 0, "path", 138)(27, AgentManagementComponent_div_33_div_11_tr_19__svg_path_27_Template, 1, 0, "path", 139);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(28, "button", 140);
    \u0275\u0275listener("click", function AgentManagementComponent_div_33_div_11_tr_19_Template_button_click_28_listener() {
      const b_r39 = \u0275\u0275restoreView(_r38).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.deleteBank(b_r39.id, b_r39.bankName));
    });
    \u0275\u0275namespaceSVG();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(b_r39.bankName);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(b_r39.paymentMethodName || "-");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(b_r39.bankCode || "-");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(b_r39.swiftCode || "-");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(b_r39.branches.length);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngClass", b_r39.isActive ? "bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400" : "bg-surface-100 text-surface-500 dark:bg-surface-700 dark:text-surface-400");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(b_r39.isActive ? "Active" : "Inactive");
    \u0275\u0275advance(9);
    \u0275\u0275property("title", b_r39.isActive ? "Deactivate" : "Activate")("ngClass", b_r39.isActive ? "text-green-600" : "text-surface-400");
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", b_r39.isActive);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !b_r39.isActive);
  }
}
function AgentManagementComponent_div_33_div_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(18, "tbody", 30);
    \u0275\u0275template(19, AgentManagementComponent_div_33_div_11_tr_19_Template, 31, 11, "tr", 127);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function AgentManagementComponent_div_33_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(10, "+ Add Bank");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(11, AgentManagementComponent_div_33_div_11_Template, 20, 1, "div", 123)(12, AgentManagementComponent_div_33_div_12_Template, 2, 0, "div", 124);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function AgentManagementComponent_div_35_option_21_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "option", 164);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const pm_r42 = ctx.$implicit;
    \u0275\u0275property("ngValue", pm_r42.id);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(pm_r42.name);
  }
}
function AgentManagementComponent_div_35_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(19, "option", 164);
    \u0275\u0275text(20, "Select");
    \u0275\u0275elementEnd();
    \u0275\u0275template(21, AgentManagementComponent_div_35_option_21_Template, 2, 2, "option", 165);
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(42, "div", 96)(43, "label", 94);
    \u0275\u0275text(44, "Address");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(45, "input", 95);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(54, "div", 96)(55, "label", 94);
    \u0275\u0275text(56, "Additional Info");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(57, "textarea", 166);
    ...
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(58, "div", 102)(59, "button", 148);
...
function AgentManagementComponent_div_37_div_11_tr_17_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(10);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "td", 131)(12, "div", 45)(13, "button", 151);
    \u0275\u0275listener("click", function AgentManagementComponent_div_37_div_11_tr_17_Template_button_click_13_listener() {
      const br_r46 = \u0275\u0275restoreView(_r45).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.openBankBranchForm(br_r46));
    });
    \u0275\u0275namespaceSVG();
  ...
  if (rf & 2) {
    const br_r46 = ctx.$implicit;
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(br_r46.branchName);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(br_r46.branchCode || "-");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(br_r46.swiftCode || "-");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(br_r46.address || "-");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(br_r46.contactPhone || "-");
  }
}
function AgentManagementComponent_div_37_div_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(16, "tbody", 30);
    \u0275\u0275template(17, AgentManagementComponent_div_37_div_11_tr_17_Template, 19, 5, "tr", 127);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function AgentManagementComponent_div_37_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 145)(1, "div", 167)(2, "div", 73)(3, "h3", 74);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "button", 75);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275template(11, AgentManagementComponent_div_37_div_11_Template, 18, 1, "div", 123)(12, AgentManagementComponent_div_37_div_12_Template, 2, 0, "div", 124);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function AgentManagementComponent_div_39_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(31, "div", 102)(32, "button", 148);
...
var AgentManagementComponent = class _AgentManagementComponent {
  constructor(api, auth, notify, exportService, confirmDelete, router) {
    this.api = api;
    this.auth = auth;
    this.notify = notify;
  ...
  static {
    this.\u0275fac = function AgentManagementComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _AgentManagementComponent)(\u0275\u0275directiveInject(ApiService), \u0275\u0275directiveInject(AuthStateService), \u0275\u0275directiveInject(NotificationService), \u0275\u0275directiveInject(ExportService), \u0275\u0275directiveInject(ConfirmDeleteService), \u0275\u0275directiveInject(Router));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AgentManagementComponent, selectors: [["app-agent-management"]], decls: 40, vars: 24, consts: [[1, "flex", "flex-col", "sm:flex-row", "sm:items-center", "sm:justify-between", "gap-4", "mb-6"], [1, "text-xl", "font-bold", "text-surface-900", "dark:text-surface-100"], [1, "flex", "flex-wrap", "gap-2"], [1, "inline-flex", "items-center", "gap-1.5", "px-3", "py-2", "text-sm", "font-medium", "border", "border-surface-300", "dark:border-surface-600", "rounded-lg", "text-surface-700", "dark:text-surface-300", "hover:bg-surface-50", "dark:hover:bg-surface-800", "transition-colors", 3, "click"], ["fill", "none", "stroke", "currentColor", "stroke-width", "1.5", "viewBox", "0 0 24 24", 1, "w-4", "h-4"], ["stroke-linecap", "round", "stroke-linejoin", "round", "d", "M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5M16.5 12L12 16.5m0 0L7.5 12m4.5 4.5V3"], [1, "inline-flex", "items-center", "gap-1.5", "px-4", "py-2", "text-sm", "font-semibold", "bg-brand-600", "hover:bg-brand-700", "text-white", "rounded-lg", "shadow-sm", "transition-colors", 3, "click"], ["stroke-linecap", "round", "stroke-linejoin", "round", "d", "M19 7.5v3m0 0v3m0-3h3m-3 0h-3m-2.25-4.125a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zM4 19.235v-.11a6.375 6.375 0 0112.75 0v.109A12.318 12.318 0 0110.374 21c-2.331 0-4.512-.645-6.374-1.766z"], ["class", "flex items-center justify-center py-20", 4, "ngIf"], ["class", "bg-white dark:bg-surface-800 rounded-xl border border-surface-200 dark:border-surface-700 shadow-sm", 4, "ngIf"], ["class", "fixed inset-0 z-50 bg-black/50 backdrop-blur-sm", 3, "click", 4, "ngIf"], ["role", "dialog", "aria-modal", "true", "class", "fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none", 4, "ngIf"], ["class", "fixed inset-0 z-[60] bg-black/50 backdrop-blur-sm", 3, "click", 4, "ngIf"], ["role", "dialog", "aria-modal", "true", "class", "fixed inset-0 z-[60] flex items-center justify-center p-4 pointer-events-none", 4, "ngIf"], ["class", "fixed inset-0 z-[70] bg-black/50 backdrop-blur-sm", 3, "click", 4, "ngIf"], ["role", "dialog", "aria-modal", "true", "class", "fixed inset-0 z-[70] flex items-center justify-center p-4 pointer-events-none", 4, "ngIf"], [1, "flex", "items-center", "justify-center", "py-20"], ["xmlns", "http://www.w3.org/2000/svg", "fill", "none", "viewBox", "0 0 24 24", 1, "animate-spin", "h-8", "w-8", "text-brand-600"], ["cx", "12", "cy", "12", "r", "10", "stroke", "currentColor", "stroke-width", "4", 1, "opacity-25"], ["fill", "currentColor", "d", "M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z", 1, "opacity-75"], [1, "bg-white", "dark:bg-surface-800", "rounded-xl", "border", "border-surface-200", "dark:border-surface-700", "shadow-sm"], [1, "p-4", "border-b", "border-surface-100", "dark:border-surface-700"], [1, "relative", "max-w-sm"], ["fill", "none", "stroke", "currentColor", "stroke-width", "1.5", "viewBox", "0 0 24 24", 1, "absolute", "left-3", "top-1/2", "-translate-y-1/2", "w-4", "h-4", "text-surface-400"], ["stroke-linecap", "round", "stroke-linejoin", "round", "d", "m21 21-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z"], ["type", "text", "placeholder", "Search agents...", 1, "w-full", "pl-9", "pr-4", "py-2", "text-sm", "bg-surface-50", "dark:bg-surface-700", "border", "border-surface-200", "dark:border-surface-600", "rounded-lg", "text-surface-900", "dark:text-surface-100", "placeholder-surface-400", "focus:outline-none", "focus:ring-2", "focus:ring-brand-500/30", 3, "ngModelChange", "ngModel"], [1, "overflow-x-auto"], [1, "w-full", "text-sm", "text-left"], [1, "text-xs", "uppercase", "tracking-wider", "text-surface-500", "dark:text-surface-400", "bg-surface-50", "dark:bg-surface-900/50", "border-b", "border-surface-200", "dark:border-surface-700"], ["scope", "col", 1, "px-4", "py-3", "font-semibold"], [1, "divide-y", "divide-surface-100", "dark:divide-surface-700"], ["class", "hover:bg-surface-50 dark:hover:bg-surface-750 transition-colors", 4, "ngFor", "ngForOf"], [1, "flex", "flex-col", "sm:flex-row", "items-center", "justify-between", "gap-3", "px-4", "py-3", "border-t", "border-surface-100", "dark:border-surface-700"], [1, "text-xs", "text-surface-500", "dark:text-surface-400"], [1, "flex", "items-center", "gap-1"], [1, "px-2", "py-1", "text-xs", "rounded", "border", "border-surface-200", "dark:border-surface-700", "disabled:opacity-40", "hover:bg-surface-50", "dark:hover:bg-surface-800", 3, "click", "disabled"], [1, "px-3", "py-1", "text-xs", "font-medium", "text-surface-700", "dark:text-surface-300"], ["class", "flex items-center justify-center py-12 text-surface-400 dark:text-surface-500 text-sm", 4, "ngIf"], [1, "hover:bg-surface-50", "dark:hover:bg-surface-750", "transition-colors"], [1, "px-4", "py-3", "font-medium", "text-surface-900", "dark:text-surface-100"], [1, "px-4", "py-3", "text-surface-600", "dark:text-surface-300"], [1, "px-4", "py-3"], [1, "inline-flex", "items-center", "px-2", "py-0.5", "text-xs", "font-medium", "rounded-full", 3, "ngClass"], [1, "flex", "items-center", "gap-1.5"], [4, "ngIf"], [1, "flex", "items-center", "gap-0.5"], ["aria-label", "View Details", 1, "p-1.5", "rounded-lg", "text-brand-600", "hover:bg-brand-50", "dark:hover:bg-brand-900/20", "transition-colors", 3, "click"], ["stroke-linecap", "round", "stroke-linejoin", "round", "d", "M2.036 12.322a1.012 1.012 0 010-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178z"], ["stroke-linecap", "round", "stroke-linejoin", "round", "d", "M15 12a3 3 0 11-6 0 3 3 0 016 0z"], ["aria-label", "Locations", "class", "p-1.5 rounded-lg text-purple-600 hover:bg-purple-50 dark:hover:bg-purple-900/20 transition-colors", 3, "click", 4, "ngIf"], ["aria-label", "Banks", "class", "p-1.5 rounded-lg text-brand-600 hover:bg-brand-50 dark:hover:bg-brand-900/20 transition-colors", 3, "click", 4, "ngIf"], ["aria-label", "Block", "class", "p-1.5 rounded-lg text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors", 3, "click", 4, "ngIf"], ["aria-label", "Edit", 1, "p-1.5", "rounded-lg", "text-brand-600", "hover:bg-brand-50", "dark:hover:bg-brand-900/20", "transition-colors", 3, "click"], ["stroke-linecap", "round", "stroke-linejoin", "round", "d", "m16.862 4.487 1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931z"], ["aria-label", "Delete", 1, "p-1.5", "rounded-lg", "text-red-500", "hover:bg-red-50", "dark:hover:bg-red-900/20", "transition-colors", 3, "click"], ["stroke-linecap", "round", "stroke-linejoin", "round", "d", "m14.74 9-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 01-2.244 2.077H8.084a2.25 2.25 0 01-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 00-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 013.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 00-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 00-7.5 0"], ["aria-label", "Unblock", 1, "p-1", "rounded", "text-green-600", "hover:bg-green-50", "dark:hover:bg-green-900/20", 3, "click"], ["stroke-linecap", "round", "stroke-linejoin", "round", "d", "M13.5 10.5V6.75a4.5 4.5 0 119 0v3.75M3.75 21.75h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H3.75a2.25 2.25 0 00-2.25 2.25v6.75a2.25 2.25 0 002.25 2.25z"], ["aria-label", "Approve", 1, "p-1", "rounded", "text-green-600", "hover:bg-green-50", "dark:hover:bg-green-900/20", 3, "click"], ["stroke-linecap", "round", "stroke-linejoin", "round", "d", "M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z"], ["aria-label", "Reject", 1, "p-1", "rounded", "text-red-600", "hover:bg-red-50", "dark:hover:bg-red-900/20", 3, "click"], ["stroke-linecap", "round", "stroke-linejoin", "round", "d", "m9.75 9.75 4.5 4.5m0-4.5-4.5 4.5M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"], ["aria-label", "Locations", 1, "p-1.5", "rounded-lg", "text-purple-600", "hover:bg-purple-50", "dark:hover:bg-purple-900/20", "transition-colors", 3, "click"], ["stroke-linecap", "round", "stroke-linejoin", "round", "d", "M15 10.5a3 3 0 11-6 0 3 3 0 016 0z"], ["stroke-linecap", "round", "stroke-linejoin", "round", "d", "M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z"], ["aria-label", "Banks", 1, "p-1.5", "rounded-lg", "text-brand-600", "hover:bg-brand-50", "dark:hover:bg-brand-900/20", "transition-colors", 3, "click"], ["stroke-linecap", "round", "stroke-linejoin", "round", "d", "M12 21v-8.25M15.75 21v-8.25M8.25 21v-8.25M3 9l9-6 9 6m-1.5 12V10.332A48.36 48.36 0 0012 9.75c-2.551 0-5.056.2-7.5.582V21M3 21h18M12 6.75h.008v.008H12V6.75z"], ["aria-label", "Block", 1, "p-1.5", "rounded-lg", "text-red-500", "hover:bg-red-50", "dark:hover:bg-red-900/20", "transition-colors", 3, "click"], ["stroke-linecap", "round", "stroke-linejoin", "round", "d", "M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L5.636 5.636"], [1, "flex", "items-center", "justify-center", "py-12", "text-surface-400", "dark:text-surface-500", "text-sm"], [1, "fixed", "inset-0", "z-50", "bg-black/50", "backdrop-blur-sm", 3, "click"], ["role", "dialog", "aria-modal", "true", 1, "fixed", "inset-0", "z-50", "flex", "items-center", "justify-center", "p-4", "pointer-events-none"], [1, "bg-white", "dark:bg-surface-800", "rounded-2xl", "shadow-xl", "w-full", "max-w-lg", "pointer-events-auto", "max-h-[90vh]", "overflow-y-auto"], [1, "flex", "items-center", "justify-between", "px-6", "py-4", "border-b", "border-surface-100", "dark:border-surface-700"], [1, "text-base", "font-semibold", "text-surface-900", "dark:text-surface-100"], [1, "p-1", "rounded-lg", "hover:bg-surface-100", "dark:hover:bg-surface-700", "text-surface-400", 3, "click"], ["fill", "none", "stroke", "currentColor", "stroke-width", "1.5", "viewBox", "0 0 24 24", 1, "w-5", "h-5"], ["stroke-linecap", "round", "stroke-linejoin", "round", "d", "M6 18L18 6M6 6l12 12"], [1, "grid", "grid-cols-2", "gap-x-6", "gap-y-3", "p-6", "text-sm"], [1, "block", "text-xs", "text-surface-400", "mb-0.5"], [1, "text-surface-900", "dark:text-surface-100", "font-medium"], [1, "text-surface-900", "dark:text-surface-100"], [1, "col-span-2"], [1, "text-surface-900", "dark:text-surface-100", "font-semibold"], [1, "bg-white", "dark:bg-surface-800", "rounded-2xl", "shadow-xl", "w-full", "max-w-2xl", "pointer-events-auto", "max-h-[90vh]", "overflow-y-auto"], [1, "p-6", "space-y-5"], ["class", "px-4 py-2 bg-red-50 dark:bg-red-900/20 text-red-700 dark:text-red-400 text-sm rounded-lg", 4, "ngIf"], [1, "block", "text-xs", "font-medium", "text-surface-500", "dark:text-surface-400", "mb-1"], [1, "w-full", "px-3", "py-2", "text-sm", "bg-white", "dark:bg-surface-700", "border", "border-surface-200", "dark:border-surface-600", "rounded-lg", "text-surface-900", "dark:text-surface-100", "focus:outline-none", "focus:ring-2", "focus:ring-brand-500/30", 3, "ngModelChange", "change", "ngModel"], ["value", "SendingAgent"], ["value", "PayoutAgent"], [1, "p-4", "rounded-lg", "border", "border-surface-100", "dark:border-surface-700", "bg-surface-50", "dark:bg-surface-900/50", "space-y-3"], [1, "text-xs", "font-semibold", "uppercase", "tracking-wider", "text-surface-400"], [1, "grid", "grid-cols-1", "md:grid-cols-2", "gap-3"], [1, "block", "text-xs", "font-medium", "text-surface-500", "mb-1"], [1, "w-full", "px-3", "py-2", "text-sm", "bg-white", "dark:bg-surface-700", "border", "border-surface-200", "dark:border-surface-600", "rounded-lg", "text-surface-900", "dark:text-surface-100", "focus:outline-none", "focus:ring-2", "focus:ring-brand-500/30", 3, "ngModelChange", "ngModel"], [1, "md:col-span-2"], [1, "grid", "grid-cols-1", "md:grid-cols-3", "gap-3"], ["type", "email", 1, "w-full", "px-3", "py-2", "text-sm", "bg-white", "dark:bg-surface-700", "border", "border-surface-200", "dark:border-surface-600", "rounded-lg", "text-surface-900", "dark:text-surface-100", "focus:outline-none", "focus:ring-2", "focus:ring-brand-500/30", 3, "ngModelChange", "ngModel"], ["value", ""], [3, "value", 4, "ngFor", "ngForOf"], ["class", "p-4 rounded-lg border border-surface-100 dark:border-surface-700 bg-surface-50 dark:bg-surface-900/50 space-y-3", 4, "ngIf"], [1, "flex", "items-center", "justify-end", "gap-3", "px-6", "py-4", "border-t", "border-surface-100", "dark:border-surface-700"], [1, "px-4", "py-2", "text-sm", "font-medium", "text-surface-700", "dark:text-surface-300", "hover:bg-surface-100", "dark:hover:bg-surface-700", "rounded-lg", "transition-colors", 3, "click"], [1, "inline-flex", "items-center", "gap-2", "px-4", "py-2", "text-sm", "font-semibold", "bg-brand-600", "hover:bg-brand-700", "text-white", "rounded-lg", "shadow-sm", "transition-colors", "disabled:opacity-50", 3, "click", "disabled"], ["class", "animate-spin w-4 h-4", "fill", "none", "viewBox", "0 0 24 24", 4, "ngIf"], [1, "px-4", "py-2", "bg-red-50", "dark:bg-red-900/20", "text-red-700", "dark:text-red-400", "text-sm", "rounded-lg"], [3, "value"], ["type", "number", 1, "w-full", "px-3", "py-2", "text-sm", "bg-white", "dark:bg-surface-700", "border", "border-surface-200", "dark:border-surface-600", "rounded-lg", "text-surface-900", "dark:text-surface-100", "focus:outline-none", "focus:ring-2", "focus:ring-brand-500/30", 3, "ngModelChange", "ngModel"], ["value", "PreFunding"], ["value", "PostFunding"], [1, "flex", "items-center", "gap-3", "cursor-pointer", "select-none"], [1, "relative"], ["type", "checkbox", 1, "sr-only", "peer", 3, "ngModelChange", "ngModel"], [1, "w-10", "h-6", "rounded-full", "bg-surface-200", "dark:bg-surface-600", "peer-checked:bg-brand-600", "transition-colors"], [1, "absolute", "top-1", "left-1", "w-4", "h-4", "rounded-full", "bg-white", "shadow", "transition-transform", "peer-checked:translate-x-4"], [1, "text-sm", "font-medium", "text-surface-700", "dark:text-surface-200"], [1, "text-xs", "text-surface-400", "mt-0.5"], ["fill", "none", "viewBox", "0 0 24 24", 1, "animate-spin", "w-4", "h-4"], [1, "grid", "grid-cols-2", "gap-3", "text-sm"], [1, "bg-white", "dark:bg-surface-800", "rounded-2xl", "shadow-xl", "w-full", "max-w-4xl", "pointer-events-auto", "max-h-[90vh]", "overflow-y-auto"], [1, "px-6", "py-3"], [1, "inline-flex", "items-center", "gap-1.5", "px-3", "py-2", "text-sm", "font-semibold", "bg-brand-600", "hover:bg-brand-700", "text-white", "rounded-lg", "transition-colors", 3, "click"], ["class", "overflow-x-auto", 4, "ngIf"], ["class", "px-6 py-8 text-center text-sm text-surface-400 border-t border-dashed border-surface-200 dark:border-surface-700", 4, "ngIf"], [1, "text-xs", "uppercase", "tracking-wider", "text-surface-500", "bg-surface-50", "dark:bg-surface-900/50", "border-y", "border-surface-200", "dark:border-surface-700"], ["scope", "col", 1, "px-4", "py-2.5"], ["class", "hover:bg-surface-50 dark:hover:bg-surface-750", 4, "ngFor", "ngForOf"], [1, "hover:bg-surface-50", "dark:hover:bg-surface-750"], [1, "px-4", "py-2.5", "font-medium", "text-surface-900", "dark:text-surface-100"], [1, "px-4", "py-2.5", "text-surface-600", "dark:text-surface-300"], [1, "px-4", "py-2.5"], [1, "inline-flex", "items-center", "px-2", "py-0.5", "text-xs", "font-medium", "rounded-full", "bg-blue-100", "text-blue-700", "dark:bg-blue-900/30", "dark:text-blue-400"], ["aria-label", "Manage Users", 1, "p-1.5", "rounded", "text-brand-600", "hover:bg-brand-50", "dark:hover:bg-brand-900/20", 3, "click"], ["stroke-linecap", "round", "stroke-linejoin", "round", "d", "M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z"], ["aria-label", "Edit", 1, "p-1.5", "rounded", "text-amber-600", "hover:bg-amber-50", "dark:hover:bg-amber-900/20", 3, "click"], [1, "p-1.5", "rounded", "hover:bg-surface-100", "dark:hover:bg-surface-700", 3, "click", "title", "ngClass"], ["fill", "currentColor", "viewBox", "0 0 24 24", 1, "w-4", "h-4"], ["d", "M17 7H7a5 5 0 000 10h10a5 5 0 000-10zm0 8a3 3 0 110-6 3 3 0 010 6z", 4, "ngIf"], ["d", "M17 7H7a5 5 0 000 10h10a5 5 0 000-10zM7 15a3 3 0 110-6 3 3 0 010 6z", 4, "ngIf"], ["aria-label", "Delete", 1, "p-1.5", "rounded", "text-red-500", "hover:bg-red-50", "dark:hover:bg-red-900/20", 3, "click"], ["d", "M17 7H7a5 5 0 000 10h10a5 5 0 000-10zm0 8a3 3 0 110-6 3 3 0 010 6z"], ["d", "M17 7H7a5 5 0 000 10h10a5 5 0 000-10zM7 15a3 3 0 110-6 3 3 0 010 6z"], [1, "px-6", "py-8", "text-center", "text-sm", "text-surface-400", "border-t", "border-dashed", "border-surface-200", "dark:border-surface-700"], [1, "fixed", "inset-0", "z-[60]", "bg-black/50", "backdrop-blur-sm", 3, "click"], ["role", "dialog", "aria-modal", "true", 1, "fixed", "inset-0", "z-[60]", "flex", "items-center", "justify-center", "p-4", "pointer-events-none"], [1, "p-6", "space-y-3"], ["placeholder", "e.g. Mon-Fri 9AM-5PM", 1, "w-full", "px-3", "py-2", "text-sm", "bg-white", "dark:bg-surface-700", "border", "border-surface-200", "dark:border-surface-600", "rounded-lg", "text-surface-900", "dark:text-surface-100", "focus:outline-none", "focus:ring-2", "focus:ring-brand-500/30", 3, "ngModelChange", "ngModel"], [1, "px-4", "py-2", "text-sm", "font-medium", "text-surface-700", "dark:text-surface-300", "hover:bg-surface-100", "dark:hover:bg-surface-700", "rounded-lg", 3, "click"], [1, "px-4", "py-2", "text-sm", "font-semibold", "bg-brand-600", "hover:bg-brand-700", "text-white", "rounded-lg", 3, "click"], ["class", "inline-flex items-center px-2 py-0.5 text-xs font-medium rounded-full bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400", 4, "ngIf"], ["aria-label", "Edit", 1, "p-1.5", "rounded", "text-brand-600", "hover:bg-brand-50", "dark:hover:bg-brand-900/20", 3, "click"], [1, "inline-flex", "items-center", "px-2", "py-0.5", "text-xs", "font-medium", "rounded-full", "bg-green-100", "text-green-700", "dark:bg-green-900/30", "dark:text-green-400"], [1, "fixed", "inset-0", "z-[70]", "bg-black/50", "backdrop-blur-sm", 3, "click"], ["role", "dialog", "aria-modal", "true", 1, "fixed", "inset-0", "z-[70]", "flex", "items-center", "justify-center", "p-4", "pointer-events-none"], ["type", "password", 1, "w-full", "px-3", "py-2", "text-sm", "bg-white", "dark:bg-surface-700", "border", "border-surface-200", "dark:border-surface-600", "rounded-lg", "text-surface-900", "dark:text-surface-100", "focus:outline-none", "focus:ring-2", "focus:ring-brand-500/30", 3, "ngModelChange", "ngModel"], ["value", "Operator"], ["value", "Manager"], ["value", "Cashier"], [1, "flex", "items-center", "gap-2", "mt-2", "cursor-pointer"], ["type", "checkbox", 1, "w-4", "h-4", "rounded", "border-surface-300", "text-brand-600", "focus:ring-brand-500", 3, "ngModelChange", "ngModel"], [1, "text-sm", "text-surface-700", "dark:text-surface-300"], ["aria-label", "Manage Branches", 1, "p-1.5", "rounded", "text-brand-600", "hover:bg-brand-50", "dark:hover:bg-brand-900/20", 3, "click"], ["stroke-linecap", "round", "stroke-linejoin", "round", "d", "M3.75 6A2.25 2.25 0 016 3.75h2.25A2.25 2.25 0 0110.5 6v2.25a2.25 2.25 0 01-2.25 2.25H6a2.25 2.25 0 01-2.25-2.25V6zM3.75 15.75A2.25 2.25 0 016 13.5h2.25a2.25 2.25 0 012.25 2.25V18a2.25 2.25 0 01-2.25 2.25H6A2.25 2.25 0 013.75 18v-2.25zM13.5 6a2.25 2.25 0 012.25-2.25H18A2.25 2.25 0 0120.25 6v2.25A2.25 2.25 0 0118 10.5h-2.25a2.25 2.25 0 01-2.25-2.25V6zM13.5 15.75a2.25 2.25 0 012.25-2.25H18a2.25 2.25 0 012.25 2.25V18A2.25 2.25 0 0118 20.25h-2.25A2.25 2.25 0 0113.5 18v-2.25z"], [3, "ngValue"], [3, "ngValue", 4, "ngFor", "ngForOf"], ["rows", "2", 1, "w-full", "px-3", "py-2", "text-sm", "bg-white", "dark:bg-surface-700", "border", "border-surface-200", "dark:border-surface-600", "rounded-lg", "text-surface-900", "dark:text-surface-100", "focus:outline-none", "focus:ring-2", "focus:ring-brand-500/30", 3, "ngModelChange", "ngModel"], [1, "bg-white", "dark:bg-surface-800", "rounded-2xl", "shadow-xl", "w-full", "max-w-3xl", "pointer-events-auto", "max-h-[90vh]", "overflow-y-auto"]], template: function AgentManagementComponent_Template(rf, ctx) {
      if (rf & 1) {
...
<div *ngIf="!loading" class="bg-white dark:bg-surface-800 rounded-xl border border-surface-200 dark:border-surface-700 shadow-sm">
  ...
  <div class="p-4 border-b border-surface-100 dark:border-surface-700">
    <div class="relative max-w-sm">
      ...
      <input type="text" placeholder="Search agents..." [(ngModel)]="searchString" (ngModelChange)="searchDebounce.next($event)" class="w-full pl-9 pr-4 py-2 text-sm bg-surface-50 dark:bg-surface-700 border border-surface-200 dark:border-surface-600 rounded-lg text-surface-900 dark:text-surface-100 placeholder-surface-400 focus:outline-none focus:ring-2 focus:ring-brand-500/30" />
    </div>
  </div>
  ...
  <div class="overflow-x-auto">
    <table class="w-full text-sm text-left">
      <thead class="text-xs uppercase tracking-wider text-surface-500 dark:text-surface-400 bg-surface-50 dark:bg-surface-900/50 border-b border-surface-200 dark:border-surface-700">
        <tr>
          <th scope="col" class="px-4 py-3 font-semibold">Business Name</th>
      ...
      <tbody class="divide-y divide-surface-100 dark:divide-surface-700">
        <tr *ngFor="let agent of agents" class="hover:bg-surface-50 dark:hover:bg-surface-750 transition-colors">
...
<div *ngIf="showDetail && detailAgent" role="dialog" aria-modal="true" class="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
...
<div *ngIf="showCreatePopup" role="dialog" aria-modal="true" class="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
  <div class="bg-white dark:bg-surface-800 rounded-2xl shadow-xl w-full max-w-2xl pointer-events-auto max-h-[90vh] overflow-y-auto">
    ...
    <div class="p-6 space-y-5">
      ...
      <div>
        ...
        <select [(ngModel)]="newAgent.agentType" (change)="onNewAgentTypeChange()" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-700 border border-surface-200 dark:border-surface-600 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30">
      ...
      <div class="p-4 rounded-lg border border-surface-100 dark:border-surface-700 bg-surface-50 dark:bg-surface-900/50 space-y-3">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
          <div><label class="block text-xs font-medium text-surface-500 mb-1">Business Name *</label><input [(ngModel)]="newAgent.businessName" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-700 border border-surface-200 dark:border-surface-600 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30" /></div>
          <div><label class="block text-xs font-medium text-surface-500 mb-1">License Number</label><input [(ngModel)]="newAgent.licenseNumber" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-700 border border-surface-200 dark:border-surface-600 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30" /></div>
          <div class="md:col-span-2"><label class="block text-xs font-medium text-surface-500 mb-1">Address</label><input [(ngModel)]="newAgent.address" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-700 border border-surface-200 dark:border-surface-600 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30" /></div>
        </div>
      </div>
      ...
      <div class="p-4 rounded-lg border border-surface-100 dark:border-surface-700 bg-surface-50 dark:bg-surface-900/50 space-y-3">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
          <div><label class="block text-xs font-medium text-surface-500 mb-1">Full Name *</label><input [(ngModel)]="newAgent.fullName" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-700 border border-surface-200 dark:border-surface-600 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30" /></div>
          <div><label class="block text-xs font-medium text-surface-500 mb-1">Email *</label><input type="email" [(ngModel)]="newAgent.email" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-700 border border-surface-200 dark:border-surface-600 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30" /></div>
          <div><label class="block text-xs font-medium text-surface-500 mb-1">Phone *</label><input [(ngModel)]="newAgent.phone" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-700 border border-surface-200 dark:border-surface-600 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30" /></div>
        </div>
      </div>
      ...
      <div class="p-4 rounded-lg border border-surface-100 dark:border-surface-700 bg-surface-50 dark:bg-surface-900/50 space-y-3">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
          <div><label class="block text-xs font-medium text-surface-500 mb-1">Country *</label>
            <select [(ngModel)]="newAgent.country" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-700 border border-surface-200 dark:border-surface-600 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30"><option value="">Select</option><option *ngFor="let c of countries" [value]="c.name">{{ c.name }}</option></select></div>
          <div><label class="block text-xs font-medium text-surface-500 mb-1">City *</label><input [(ngModel)]="newAgent.city" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-700 border border-surface-200 dark:border-surface-600 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30" /></div>
          <div><label class="block text-xs font-medium text-surface-500 mb-1">Currency *</label>
            <select [(ngModel)]="newAgent.currency" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-700 border border-surface-200 dark:border-surface-600 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30"><option *ngFor="let c of currencies" [value]="c">{{ c }}</option></select></div>
          <ng-container *ngIf="newAgent.agentType === 'SendingAgent'">
            <div><label class="block text-xs font-medium text-surface-500 mb-1">Credit Limit *</label><input type="number" [(ngModel)]="newAgent.creditLimit" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-700 border border-surface-200 dark:border-surface-600 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30" /></div>
            <div><label class="block text-xs font-medium text-surface-500 mb-1">Funding Type *</label>
              <select [(ngModel)]="newAgent.fundingType" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-700 border border-surface-200 dark:border-surface-600 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30"><option value="PreFunding">PreFunding</option><option value="PostFunding">PostFunding</option></select></div>
          </ng-container>
        </div>
      </div>

      <!-- API Settings -->
      <div *ngIf="newAgent.agentType === 'PayoutAgent'" class="p-4 rounded-lg border border-surface-100 dark:border-surface-700 bg-surface-50 dark:bg-surface-900/50 space-y-3">
        <h4 class="text-xs font-semibold uppercase tracking-wider text-surface-400">API Settings</h4>
        <label class="flex items-center gap-3 cursor-pointer select-none">
          <div class="relative">
            <input type="checkbox" [(ngModel)]="newAgent.isThirdPartyApi" class="sr-only peer" />
            <div class="w-10 h-6 rounded-full bg-surface-200 dark:bg-surface-600 peer-checked:bg-brand-600 transition-colors"></div>
            <div class="absolute top-1 left-1 w-4 h-4 rounded-full bg-white shadow transition-transform peer-checked:translate-x-4"></div>
          </div>
          <div>
            <span class="text-sm font-medium text-surface-700 dark:text-surface-200">Third Party API Agent</span>
            <p class="text-xs text-surface-400 mt-0.5">Field mappings are configured separately in field mapping management.</p>
          </div>
        </label>
      </div>
    </div>
...
<div *ngIf="showEditPopup" role="dialog" aria-modal="true" class="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
  <div class="bg-white dark:bg-surface-800 rounded-2xl shadow-xl w-full max-w-2xl pointer-events-auto max-h-[90vh] overflow-y-auto">
    <div class="flex items-center justify-between px-6 py-4 border-b border-surface-100 dark:border-surface-700">
    ...
    <div class="p-6 space-y-5">
      ...
      <div class="p-4 rounded-lg border border-surface-100 dark:border-surface-700 bg-surface-50 dark:bg-surface-900/50 space-y-3">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
          ...
          <div><label class="block text-xs font-medium text-surface-500 mb-1">License Number</label><input [(ngModel)]="editAgent.licenseNumber" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-700 border border-surface-200 dark:border-surface-600 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30" /></div>
          <div class="md:col-span-2"><label class="block text-xs font-medium text-surface-500 mb-1">Address</label><input [(ngModel)]="editAgent.address" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-700 border border-surface-200 dark:border-surface-600 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30" /></div>
        </div>
      </div>
      ...
      <div class="p-4 rounded-lg border border-surface-100 dark:border-surface-700 bg-surface-50 dark:bg-surface-900/50 space-y-3">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
          <div><label class="block text-xs font-medium text-surface-500 mb-1">Country *</label>
            <select [(ngModel)]="editAgent.country" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-700 border border-surface-200 dark:border-surface-600 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30"><option *ngFor="let c of countries" [value]="c.name">{{ c.name }}</option></select></div>
          <div><label class="block text-xs font-medium text-surface-500 mb-1">City *</label><input [(ngModel)]="editAgent.city" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-700 border border-surface-200 dark:border-surface-600 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30" /></div>
          <div><label class="block text-xs font-medium text-surface-500 mb-1">Currency *</label>
            <select [(ngModel)]="editAgent.currency" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-700 border border-surface-200 dark:border-surface-600 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30"><option *ngFor="let c of currencies" [value]="c">{{ c }}</option></select></div>
          <ng-container *ngIf="editAgent.agentType === 'SendingAgent'">
            <div><label class="block text-xs font-medium text-surface-500 mb-1">Credit Limit *</label><input type="number" [(ngModel)]="editAgent.creditLimit" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-700 border border-surface-200 dark:border-surface-600 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30" /></div>
            <div><label class="block text-xs font-medium text-surface-500 mb-1">Funding Type *</label>
              <select [(ngModel)]="editAgent.fundingType" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-700 border border-surface-200 dark:border-surface-600 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30"><option value="PreFunding">PreFunding</option><option value="PostFunding">PostFunding</option></select></div>
          </ng-container>
          <div><label class="block text-xs font-medium text-surface-500 mb-1">Agent Type *</label>
            <select [(ngModel)]="editAgent.agentType" (change)="onEditAgentTypeChange()" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-700 border border-surface-200 dark:border-surface-600 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30"><option value="SendingAgent">Sending Agent</option><option value="PayoutAgent">Payout Agent</option></select></div>
        </div>
      </div>

      <!-- API Settings -->
      <div *ngIf="editAgent.agentType === 'PayoutAgent'" class="p-4 rounded-lg border border-surface-100 dark:border-surface-700 bg-surface-50 dark:bg-surface-900/50 space-y-3">
        <h4 class="text-xs font-semibold uppercase tracking-wider text-surface-400">API Settings</h4>
        <label class="flex items-center gap-3 cursor-pointer select-none">
          <div class="relative">
            <input type="checkbox" [(ngModel)]="editAgent.isThirdPartyApi" class="sr-only peer" />
            <div class="w-10 h-6 rounded-full bg-surface-200 dark:bg-surface-600 peer-checked:bg-brand-600 transition-colors"></div>
            <div class="absolute top-1 left-1 w-4 h-4 rounded-full bg-white shadow transition-transform peer-checked:translate-x-4"></div>
          </div>
          <div>
...
<div *ngIf="showLocationPopup" role="dialog" aria-modal="true" class="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
    ...
    <div *ngIf="agentLocations.length" class="overflow-x-auto">
      <table class="w-full text-sm text-left">
        <thead class="text-xs uppercase tracking-wider text-surface-500 bg-surface-50 dark:bg-surface-900/50 border-y border-surface-200 dark:border-surface-700">
          <tr><th scope="col" class="px-4 py-2.5">Location</th><th scope="col" class="px-4 py-2.5">Code</th><th scope="col" class="px-4 py-2.5">Country / City</th><th scope="col" class="px-4 py-2.5">Users</th><th scope="col" class="px-4 py-2.5">Status</th><th scope="col" class="px-4 py-2.5">Actions</th></tr>
        </thead>
        <tbody class="divide-y divide-surface-100 dark:divide-surface-700">
          <tr *ngFor="let loc of agentLocations" class="hover:bg-surface-50 dark:hover:bg-surface-750">
...
<div *ngIf="showLocationForm" role="dialog" aria-modal="true" class="fixed inset-0 z-[60] flex items-center justify-center p-4 pointer-events-none">
  <div class="bg-white dark:bg-surface-800 rounded-2xl shadow-xl w-full max-w-lg pointer-events-auto max-h-[90vh] overflow-y-auto">
    <div class="flex items-center justify-between px-6 py-4 border-b border-surface-100 dark:border-surface-700">
    ...
    <div class="p-6 space-y-3">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
        <div><label class="block text-xs font-medium text-surface-500 mb-1">Location Name *</label><input [(ngModel)]="locName" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-700 border border-surface-200 dark:border-surface-600 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30" /></div>
        <div><label class="block text-xs font-medium text-surface-500 mb-1">Location Code</label><input [(ngModel)]="locCode" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-700 border border-surface-200 dark:border-surface-600 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30" /></div>
        <div><label class="block text-xs font-medium text-surface-500 mb-1">Country</label><input [(ngModel)]="locCountry" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-700 border border-surface-200 dark:border-surface-600 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30" /></div>
        <div><label class="block text-xs font-medium text-surface-500 mb-1">City</label><input [(ngModel)]="locCity" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-700 border border-surface-200 dark:border-surface-600 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30" /></div>
        <div class="md:col-span-2"><label class="block text-xs font-medium text-surface-500 mb-1">Address</label><input [(ngModel)]="locAddress" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-700 border border-surface-200 dark:border-surface-600 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30" /></div>
        <div><label class="block text-xs font-medium text-surface-500 mb-1">Contact Phone</label><input [(ngModel)]="locPhone" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-700 border border-surface-200 dark:border-surface-600 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30" /></div>
        <div><label class="block text-xs font-medium text-surface-500 mb-1">Contact Email</label><input [(ngModel)]="locEmail" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-700 border border-surface-200 dark:border-surface-600 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30" /></div>
        <div class="md:col-span-2"><label class="block text-xs font-medium text-surface-500 mb-1">Operating Hours</label><input placeholder="e.g. Mon-Fri 9AM-5PM" [(ngModel)]="locHours" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-700 border border-surface-200 dark:border-surface-600 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30" /></div>
      </div>
    </div>
    <div class="flex items-center justify-end gap-3 px-6 py-4 border-t border-surface-100 dark:border-surface-700">
...
<div *ngIf="showUserPopup && userLocation" role="dialog" aria-modal="true" class="fixed inset-0 z-[60] flex items-center justify-center p-4 pointer-events-none">
  <div class="bg-white dark:bg-surface-800 rounded-2xl shadow-xl w-full max-w-4xl pointer-events-auto max-h-[90vh] overflow-y-auto">
    <div class="flex items-center justify-between px-6 py-4 border-b border-surface-100 dark:border-surface-700">
    ...
    <div *ngIf="userLocation.users.length" class="overflow-x-auto">
      <table class="w-full text-sm text-left">
        <thead class="text-xs uppercase tracking-wider text-surface-500 bg-surface-50 dark:bg-surface-900/50 border-y border-surface-200 dark:border-surface-700">
          <tr><th scope="col" class="px-4 py-2.5">Full Name</th><th scope="col" class="px-4 py-2.5">Email</th><th scope="col" class="px-4 py-2.5">Username</th><th scope="col" class="px-4 py-2.5">Phone</th><th scope="col" class="px-4 py-2.5">Role</th><th scope="col" class="px-4 py-2.5">Default</th><th scope="col" class="px-4 py-2.5">Actions</th></tr>
        </thead>
        <tbody class="divide-y divide-surface-100 dark:divide-surface-700">
          <tr *ngFor="let u of userLocation.users" class="hover:bg-surface-50 dark:hover:bg-surface-750">
            ...
            <td class="px-4 py-2.5">
              <div class="flex items-center gap-0.5">
                <button aria-label="Edit" (click)="openUserForm(u)" class="p-1.5 rounded text-brand-600 hover:bg-brand-50 dark:hover:bg-brand-900/20"><svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931z"/></svg></button>
                <button aria-label="Delete" (click)="deleteUser(u.id, u.fullName)" class="p-1.5 rounded text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20"><svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="m14.74 9-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 01-2.244 2.077H8.084a2.25 2.25 0 01-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 00-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 013.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 00-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 00-7.5 0"/></svg></button>
              </div>
            </td>
          </tr>
        </tbody>
...
<div *ngIf="showUserForm" role="dialog" aria-modal="true" class="fixed inset-0 z-[70] flex items-center justify-center p-4 pointer-events-none">
  <div class="bg-white dark:bg-surface-800 rounded-2xl shadow-xl w-full max-w-lg pointer-events-auto max-h-[90vh] overflow-y-auto">
    <div class="flex items-center justify-between px-6 py-4 border-b border-surface-100 dark:border-surface-700">
    ...
    <div class="p-6 space-y-3">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
        <div><label class="block text-xs font-medium text-surface-500 mb-1">Full Name *</label><input [(ngModel)]="userFullName" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-700 border border-surface-200 dark:border-surface-600 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30" /></div>
        <div><label class="block text-xs font-medium text-surface-500 mb-1">Email *</label><input [(ngModel)]="userEmail" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-700 border border-surface-200 dark:border-surface-600 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30" /></div>
        <div><label class="block text-xs font-medium text-surface-500 mb-1">Username</label><input [(ngModel)]="userUserName" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-700 border border-surface-200 dark:border-surface-600 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30" /></div>
        ...
        <div><label class="block text-xs font-medium text-surface-500 mb-1">Phone</label><input [(ngModel)]="userPhone" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-700 border border-surface-200 dark:border-surface-600 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30" /></div>
        <div><label class="block text-xs font-medium text-surface-500 mb-1">Role</label>
          <select [(ngModel)]="userRole" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-700 border border-surface-200 dark:border-surface-600 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30"><option value="Operator">Operator</option><option value="Manager">Manager</option><option value="Cashier">Cashier</option></select></div>
      </div>
...
<div *ngIf="showBankPopup" role="dialog" aria-modal="true" class="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
  <div class="bg-white dark:bg-surface-800 rounded-2xl shadow-xl w-full max-w-4xl pointer-events-auto max-h-[90vh] overflow-y-auto">
    <div class="flex items-center justify-between px-6 py-4 border-b border-surface-100 dark:border-surface-700">
    ...
    <div *ngIf="agentBanks.length" class="overflow-x-auto">
      <table class="w-full text-sm text-left">
        <thead class="text-xs uppercase tracking-wider text-surface-500 bg-surface-50 dark:bg-surface-900/50 border-y border-surface-200 dark:border-surface-700">
          <tr><th scope="col" class="px-4 py-2.5">Bank Name</th><th scope="col" class="px-4 py-2.5">Payment Mode</th><th scope="col" class="px-4 py-2.5">Code</th><th scope="col" class="px-4 py-2.5">SWIFT</th><th scope="col" class="px-4 py-2.5">Branches</th><th scope="col" class="px-4 py-2.5">Status</th><th scope="col" class="px-4 py-2.5">Actions</th></tr>
        </thead>
        <tbody class="divide-y divide-surface-100 dark:divide-surface-700">
          <tr *ngFor="let b of agentBanks" class="hover:bg-surface-50 dark:hover:bg-surface-750">
            ...
            <td class="px-4 py-2.5">
              <div class="flex items-center gap-0.5">
                ...
                <button aria-label="Delete" (click)="deleteBank(b.id, b.bankName)" class="p-1.5 rounded text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20"><svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="m14.74 9-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 01-2.244 2.077H8.084a2.25 2.25 0 01-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 00-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 013.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 00-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 00-7.5 0"/></svg></button>
              </div>
            </td>
          </tr>
        </tbody>
...
<div *ngIf="showBankForm" role="dialog" aria-modal="true" class="fixed inset-0 z-[60] flex items-center justify-center p-4 pointer-events-none">
  <div class="bg-white dark:bg-surface-800 rounded-2xl shadow-xl w-full max-w-lg pointer-events-auto max-h-[90vh] overflow-y-auto">
    <div class="flex items-center justify-between px-6 py-4 border-b border-surface-100 dark:border-surface-700">
    ...
    <div class="p-6 space-y-3">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
        <div><label class="block text-xs font-medium text-surface-500 mb-1">Bank Name *</label><input [(ngModel)]="bankName" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-700 border border-surface-200 dark:border-surface-600 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30" /></div>
        <div><label class="block text-xs font-medium text-surface-500 mb-1">Payment Mode *</label>
          <select [(ngModel)]="bankPaymentMethodId" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-700 border border-surface-200 dark:border-surface-600 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30"><option [ngValue]="null">Select</option><option *ngFor="let pm of paymentMethods" [ngValue]="pm.id">{{ pm.name }}</option></select></div>
        <div><label class="block text-xs font-medium text-surface-500 mb-1">Bank Code</label><input [(ngModel)]="bankCode" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-700 border border-surface-200 dark:border-surface-600 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30" /></div>
        ...
        <div><label class="block text-xs font-medium text-surface-500 mb-1">Country</label><input [(ngModel)]="bankCountry" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-700 border border-surface-200 dark:border-surface-600 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30" /></div>
        <div><label class="block text-xs font-medium text-surface-500 mb-1">City</label><input [(ngModel)]="bankCity" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-700 border border-surface-200 dark:border-surface-600 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30" /></div>
        <div class="md:col-span-2"><label class="block text-xs font-medium text-surface-500 mb-1">Address</label><input [(ngModel)]="bankAddress" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-700 border border-surface-200 dark:border-surface-600 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30" /></div>
        <div><label class="block text-xs font-medium text-surface-500 mb-1">Contact Phone</label><input [(ngModel)]="bankPhone" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-700 border border-surface-200 dark:border-surface-600 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30" /></div>
        <div><label class="block text-xs font-medium text-surface-500 mb-1">Contact Email</label><input [(ngModel)]="bankEmail" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-700 border border-surface-200 dark:border-surface-600 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30" /></div>
        <div class="md:col-span-2"><label class="block text-xs font-medium text-surface-500 mb-1">Additional Info</label><textarea rows="2" [(ngModel)]="bankAdditionalInfo" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-700 border border-surface-200 dark:border-surface-600 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30"></textarea></div>
      </div>
    </div>
    <div class="flex items-center justify-end gap-3 px-6 py-4 border-t border-surface-100 dark:border-surface-700">
...
<div *ngIf="showBankBranchPopup && bankBranchBank" role="dialog" aria-modal="true" class="fixed inset-0 z-[60] flex items-center justify-center p-4 pointer-events-none">
  <div class="bg-white dark:bg-surface-800 rounded-2xl shadow-xl w-full max-w-3xl pointer-events-auto max-h-[90vh] overflow-y-auto">
    ...
    <div *ngIf="bankBranchBank.branches.length" class="overflow-x-auto">
      <table class="w-full text-sm text-left">
        <thead class="text-xs uppercase tracking-wider text-surface-500 bg-surface-50 dark:bg-surface-900/50 border-y border-surface-200 dark:border-surface-700">
          <tr><th scope="col" class="px-4 py-2.5">Branch Name</th><th scope="col" class="px-4 py-2.5">Code</th><th scope="col" class="px-4 py-2.5">SWIFT</th><th scope="col" class="px-4 py-2.5">Address</th><th scope="col" class="px-4 py-2.5">Phone</th><th scope="col" class="px-4 py-2.5">Actions</th></tr>
        </thead>
        <tbody class="divide-y divide-surface-100 dark:divide-surface-700">
          <tr *ngFor="let br of bankBranchBank.branches" class="hover:bg-surface-50 dark:hover:bg-surface-750">
            ...
            <td class="px-4 py-2.5">
              <div class="flex items-center gap-0.5">
                <button aria-label="Edit" (click)="openBankBranchForm(br)" class="p-1.5 rounded text-brand-600 hover:bg-brand-50 dark:hover:bg-brand-900/20"><svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931z"/></svg></button>
                <button aria-label="Delete" (click)="deleteBankBranch(br.id, br.branchName)" class="p-1.5 rounded text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20"><svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="m14.74 9-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 01-2.244 2.077H8.084a2.25 2.25 0 01-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 00-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 013.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 00-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 00-7.5 0"/></svg></button>
              </div>
            </td>
          </tr>
        </tbody>
...
<div *ngIf="showBankBranchForm" role="dialog" aria-modal="true" class="fixed inset-0 z-[70] flex items-center justify-center p-4 pointer-events-none">
  <div class="bg-white dark:bg-surface-800 rounded-2xl shadow-xl w-full max-w-lg pointer-events-auto max-h-[90vh] overflow-y-auto">
    <div class="flex items-center justify-between px-6 py-4 border-b border-surface-100 dark:border-surface-700">
    ...
    <div class="p-6 space-y-3">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
        <div><label class="block text-xs font-medium text-surface-500 mb-1">Branch Name *</label><input [(ngModel)]="bbName" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-700 border border-surface-200 dark:border-surface-600 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30" /></div>
        <div><label class="block text-xs font-medium text-surface-500 mb-1">Branch Code</label><input [(ngModel)]="bbCode" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-700 border border-surface-200 dark:border-surface-600 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30" /></div>
        <div><label class="block text-xs font-medium text-surface-500 mb-1">SWIFT Code</label><input [(ngModel)]="bbSwift" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-700 border border-surface-200 dark:border-surface-600 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30" /></div>
        <div><label class="block text-xs font-medium text-surface-500 mb-1">Contact Phone</label><input [(ngModel)]="bbPhone" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-700 border border-surface-200 dark:border-surface-600 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30" /></div>
        <div class="md:col-span-2"><label class="block text-xs font-medium text-surface-500 mb-1">Address</label><input [(ngModel)]="bbAddress" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-700 border border-surface-200 dark:border-surface-600 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30" /></div>
      </div>
    </div>
    <div class="flex items-center justify-end gap-3 px-6 py-4 border-t border-surface-100 dark:border-surface-700">
...
`, styles: ['@charset "UTF-8";\n\n/* src/app/pages/admin/agent-management/agent-management.component.scss */\n/*# sourceMappingURL=agent-management.component.css.map */\n'] }]
  }], () => [{ type: ApiService }, { type: AuthStateService }, { type: NotificationService }, { type: ExportService }, { type: ConfirmDeleteService }, { type: Router }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AgentManagementComponent, { className: "AgentManagementComponent", filePath: "src/app/pages/admin/agent-management/agent-management.component.ts", lineNumber: 76 });
})();
export {
  AgentManagementComponent
};
//# sourceMappingURL=chunk-EPXRFRI5.js.map
