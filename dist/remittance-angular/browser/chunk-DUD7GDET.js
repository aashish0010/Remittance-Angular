...
var AppSettingsService = class _AppSettingsService {
  ...
  get requireRelationship() {
    return this.getBool("transaction.requireRelationship", false);
  }
  ...
  get lockoutDurationMinutes() {
    return this.getNumber("user.lockoutDurationMinutes", 5);
  }
  // System
  get maintenanceMode() {
...
//# sourceMappingURL=chunk-DUD7GDET.js.map
