...
var TransactionDetailComponent = class _TransactionDetailComponent {
  ...
  canApprove() {
    return this.txn?.status === "Pending" || this.txn?.status === "PendingApproval";
  }
  canComplete() {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TransactionDetailComponent, { className: "TransactionDetailComponent", filePath: "src/app/pages/admin/transaction-detail/transaction-detail.component.ts", lineNumber: 21 });
})();
export {
  TransactionDetailComponent
};
//# sourceMappingURL=chunk-G3XZ674D.js.map
