...
function AccountingComponent_div_19_div_11_tr_17_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(11);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "td", 96)(13, "span", 70);
    \u0275\u0275text(14);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(15, "td", 96);
    \u0275\u0275template(16, AccountingComponent_div_19_div_11_tr_17_button_16_Template, 3, 0, "button", 102);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function AccountingComponent_div_21_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(14, "option", 106);
    \u0275\u0275text(15, "Percentage");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "option", 107);
    \u0275\u0275text(17, "Flat");
    \u0275\u0275elementEnd()()();
    ...
    \u0275\u0275template(26, AccountingComponent_div_21__svg_svg_26_Template, 3, 0, "svg", 109);
    \u0275\u0275text(27, " Save ");
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    ...
    <table class="w-full text-sm text-left">
      <thead>
        <tr class="border-b border-surface-200 dark:border-surface-700">
          <th class="px-4 py-3 font-semibold text-surface-600 dark:text-surface-300">Agent</th>
          <th class="px-4 py-3 font-semibold text-surface-600 dark:text-surface-300">Type</th>
          <th class="px-4 py-3 font-semibold text-surface-600 dark:text-surface-300">Service Charge</th>
          <th class="px-4 py-3 font-semibold text-surface-600 dark:text-surface-300 text-right">Effective Limit</th>
          <th class="px-4 py-3 font-semibold text-surface-600 dark:text-surface-300 text-right">Available</th>
...
<div *ngIf="showDetailPopup && detailAgent" class="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
...
<div *ngIf="showAdjustmentForm" class="fixed inset-0 z-[60] flex items-center justify-center p-4 pointer-events-none">
  <div class="bg-white dark:bg-surface-800 rounded-2xl shadow-xl w-full max-w-md pointer-events-auto max-h-[90vh] overflow-y-auto">
    ...
    <div class="p-6 space-y-4">
      ...
      <div><label class="block text-xs font-medium text-surface-500 mb-1">Amount (+ increase / - decrease) *</label><input type="number" [(ngModel)]="adjustmentForm.amount" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-900 border border-surface-200 dark:border-surface-700 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30" /></div>
      <div><label class="block text-xs font-medium text-surface-500 mb-1">Duration</label>
        <select [(ngModel)]="adjustmentForm.durationDays" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-900 border border-surface-200 dark:border-surface-700 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30">
      ...
      <div><label class="block text-xs font-medium text-surface-500 mb-1">Notes (optional)</label><textarea rows="2" [(ngModel)]="adjustmentForm.notes" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-900 border border-surface-200 dark:border-surface-700 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30"></textarea></div>
    </div>
...
<div *ngIf="showAdjustmentPopup" class="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
    ...
    <div *ngIf="adjustments.length" class="overflow-x-auto">
      <table class="w-full text-sm text-left">
        <thead class="text-xs uppercase tracking-wider text-surface-500 bg-surface-50 dark:bg-surface-900/50 border-y border-surface-200 dark:border-surface-700">
          <tr><th class="px-4 py-2.5">Amount</th><th class="px-4 py-2.5">From</th><th class="px-4 py-2.5">To</th><th class="px-4 py-2.5">Notes</th><th class="px-4 py-2.5">Active</th><th class="px-4 py-2.5">Actions</th></tr>
        </thead>
        <tbody class="divide-y divide-surface-100 dark:divide-surface-700">
          <tr *ngFor="let adj of adjustments" class="hover:bg-surface-50 dark:hover:bg-surface-800/50">
...
<div *ngIf="showCommissionPopup" class="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
  <div class="bg-white dark:bg-surface-800 rounded-2xl shadow-xl w-full max-w-md pointer-events-auto max-h-[90vh] overflow-y-auto">
    <div class="flex items-center justify-between px-6 py-4 border-b border-surface-100 dark:border-surface-700">
    ...
    <div class="p-6 space-y-4">
      ...
      <div><label class="block text-xs font-medium text-surface-500 mb-1">Service Charge Type *</label>
        <select [(ngModel)]="commissionForm.commissionType" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-900 border border-surface-200 dark:border-surface-700 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30"><option value="Percentage">Percentage</option><option value="Flat">Flat</option></select>
      </div>
      <div><label class="block text-xs font-medium text-surface-500 mb-1">{{ commissionForm.commissionType === 'Percentage' ? 'Service Charge Percentage (%)' : 'Flat Fee Amount' }}</label><input type="number" [(ngModel)]="commissionForm.commissionValue" class="w-full px-3 py-2 text-sm bg-white dark:bg-surface-900 border border-surface-200 dark:border-surface-700 rounded-lg text-surface-900 dark:text-surface-100 focus:outline-none focus:ring-2 focus:ring-brand-500/30" /></div>
    </div>
    <div class="flex items-center justify-end gap-3 px-6 py-4 border-t border-surface-100 dark:border-surface-700">
...
//# sourceMappingURL=chunk-TL5QYEBI.js.map
