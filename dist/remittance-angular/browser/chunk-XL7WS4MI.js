...
function CommissionsComponent_div_17_tr_29_ng_container_27_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "button", 50);
    \u0275\u0275listener("click", function CommissionsComponent_div_17_tr_29_ng_container_27_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r5);
      const c_r4 = \u0275\u0275nextContext().$implicit;
...
function CommissionsComponent_div_17_tr_29_span_28_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "span", 52)(1, "span", 53);
    \u0275\u0275text(2, "Delete?");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "button", 54);
    \u0275\u0275listener("click", function CommissionsComponent_div_17_tr_29_span_28_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r6);
      const c_r4 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      ctx_r1.deleteCommission(c_r4);
      return \u0275\u0275resetView(ctx_r1.deleteConfirmId = null);
    });
    \u0275\u0275text(4, "Yes");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "button", 55);
    \u0275\u0275listener("click", function CommissionsComponent_div_17_tr_29_span_28_Template_button_click_5_listener() {
      \u0275\u0275restoreView(_r6);
...
function CommissionsComponent_div_17_tr_29_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275template(27, CommissionsComponent_div_17_tr_29_ng_container_27_Template, 4, 0, "ng-container", 43)(28, CommissionsComponent_div_17_tr_29_span_28_Template, 7, 0, "span", 49);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate2("", \u0275\u0275pipeBind2(13, 14, c_r4.minAmount, "1.2-2"), " - ", \u0275\u0275pipeBind2(14, 17, c_r4.maxAmount, "1.2-2"), "");
    \u0275\u0275advance(4);
...
function CommissionsComponent_div_17_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(29, CommissionsComponent_div_17_tr_29_Template, 29, 20, "tr", 26);
    \u0275\u0275elementEnd()()();
...
function CommissionsComponent_div_19_option_21_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngValue", a_r10.id);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(a_r10.businessName);
  }
}
...
function CommissionsComponent_div_19_option_36_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const pm_r13 = ctx.$implicit;
    \u0275\u0275property("ngValue", pm_r13.name);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(pm_r13.name);
  }
}
...
function CommissionsComponent_div_19_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(7, "path", 64);
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(8, CommissionsComponent_div_19_div_8_Template, 2, 1, "div", 65);
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(9, "div", 66)(10, "div")(11, "label", 67);
    ...
    \u0275\u0275template(14, CommissionsComponent_div_19_option_14_Template, 2, 2, "option", 69);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(15, "div")(16, "label", 67);
    \u0275\u0275text(17, "Payout Agent *");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "select", 70);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(21, CommissionsComponent_div_19_option_21_Template, 2, 2, "option", 69);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(22, "div")(23, "label", 67);
    \u0275\u0275text(24, "Source Country");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(25, "select", 68);
    ...
    \u0275\u0275template(26, CommissionsComponent_div_19_option_26_Template, 2, 2, "option", 69);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(27, "div")(28, "label", 67);
    \u0275\u0275text(29, "Destination Country");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(30, "select", 68);
    ...
    \u0275\u0275template(31, CommissionsComponent_div_19_option_31_Template, 2, 2, "option", 69);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(32, "div")(33, "label", 67);
    \u0275\u0275text(34, "Payment Method");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(35, "select", 68);
    ...
    \u0275\u0275template(36, CommissionsComponent_div_19_option_36_Template, 2, 2, "option", 69);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(37, "div")(38, "label", 67);
    \u0275\u0275text(39, "Source Currency");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(40, "select", 68);
    ...
    \u0275\u0275template(41, CommissionsComponent_div_19_option_41_Template, 2, 2, "option", 69);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(42, "div")(43, "label", 67);
    \u0275\u0275text(44, "Destination Currency");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(45, "select", 68);
    ...
    \u0275\u0275template(46, CommissionsComponent_div_19_option_46_Template, 2, 2, "option", 69);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(47, "div")(48, "label", 67);
    \u0275\u0275text(49, "Min Amount");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(50, "input", 72);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(51, "div")(52, "label", 67);
    \u0275\u0275text(53, "Max Amount");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(54, "input", 72);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(55, "div")(56, "label", 67);
    \u0275\u0275text(57, "Service Charge Type *");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(58, "select", 70);
    ...
    \u0275\u0275elementStart(59, "option", 73);
    \u0275\u0275text(60, "Percentage");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(61, "option", 74);
    \u0275\u0275text(62, "Flat Fee");
    \u0275\u0275elementEnd()()();
    ...
    \u0275\u0275elementStart(65, "div", 75)(66, "label", 76)(67, "input", 77);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275element(68, "div", 78);
    \u0275\u0275elementStart(69, "span", 79);
    \u0275\u0275text(70, "Active");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(71, "div", 80)(72, "button", 3);
    ...
    \u0275\u0275template(75, CommissionsComponent_div_19__svg_svg_75_Template, 3, 0, "svg", 82)(76, CommissionsComponent_div_19__svg_svg_76_Template, 2, 0, "svg", 83);
    \u0275\u0275text(77);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    ...
    <table class="w-full text-sm text-left">
      <thead>
        <tr class="border-b border-surface-200 dark:border-surface-700">
          <th scope="col" class="px-3 py-3 font-semibold text-surface-600 dark:text-surface-300 whitespace-nowrap">Sending Agent</th>
          <th scope="col" class="px-3 py-3 font-semibold text-surface-600 dark:text-surface-300 whitespace-nowrap">Payout Agent</th>
          <th scope="col" class="px-3 py-3 font-semibold text-surface-600 dark:text-surface-300 whitespace-nowrap">Source Country</th>
          <th scope="col" class="px-3 py-3 font-semibold text-surface-600 dark:text-surface-300 whitespace-nowrap">Dest Country</th>
          <th scope="col" class="px-3 py-3 font-semibold text-surface-600 dark:text-surface-300 whitespace-nowrap">Currency Pair</th>
          <th scope="col" class="px-3 py-3 font-semibold text-surface-600 dark:text-surface-300 whitespace-nowrap">Amount Range</th>
          <th scope="col" class="px-3 py-3 font-semibold text-surface-600 dark:text-surface-300 whitespace-nowrap">Service Charge</th>
          <th scope="col" class="px-3 py-3 font-semibold text-surface-600 dark:text-surface-300 whitespace-nowrap">Status</th>
          <th scope="col" class="px-3 py-3 font-semibold text-surface-600 dark:text-surface-300 whitespace-nowrap">Actions</th>
        </tr>
      </thead>
      <tbody>
        <tr *ngFor="let c of commissions"
          ...
          <td class="px-3 py-3">
            <div class="flex items-center gap-1">
              <button aria-label="Edit service charge" (click)="openEdit(c)"
              ...
              <ng-container *ngIf="deleteConfirmId !== c.id">
                <button aria-label="Delete service charge" (click)="deleteConfirmId = c.id"
              ...
              <span *ngIf="deleteConfirmId === c.id" class="inline-flex items-center gap-1.5 text-xs">
                ...
                <button (click)="deleteCommission(c); deleteConfirmId = null"
                  class="px-2 py-0.5 bg-danger-600 hover:bg-danger-700 text-white rounded-lg text-xs font-medium transition-colors">Yes</button>
                <button (click)="deleteConfirmId = null"
                  class="px-2 py-0.5 border border-surface-300 dark:border-surface-600 text-surface-600 dark:text-surface-300 rounded-lg text-xs font-medium hover:bg-surface-50 dark:hover:bg-surface-700 transition-colors">No</button>
              </span>
            </div>
          </td>
        </tr>
...
<div *ngIf="showPopup" class="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
  <div
    role="dialog" aria-modal="true" aria-labelledby="commission-form-title"
    ...
    <div class="flex items-center justify-between px-6 py-4 border-b border-surface-200 dark:border-surface-700">
      <h3 id="commission-form-title" class="text-lg font-semibold text-surface-900 dark:text-surface-100">
        {{ isEditing ? 'Edit Service Charge' : 'Create Service Charge' }}
      </h3>
      <button (click)="closePopup()" aria-label="Close dialog"
...
//# sourceMappingURL=chunk-XL7WS4MI.js.map
