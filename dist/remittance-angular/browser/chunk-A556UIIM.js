...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AdminProfileComponent, [{
    type: Component,
    args: [{ selector: "app-admin-profile", standalone: true, imports: [CommonModule, FormsModule], template: `<div class="flex flex-col gap-6 max-w-4xl">
...
//# sourceMappingURL=chunk-A556UIIM.js.map
