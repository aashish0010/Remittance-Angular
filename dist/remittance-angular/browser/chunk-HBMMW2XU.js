    ...
    <div *ngIf="report.monthlyBreakdown.length > 0" class="overflow-x-auto">
      <table class="w-full text-sm text-left">
        <thead class="bg-surface-50 dark:bg-surface-700/50">
          <tr>
            <th scope="col" class="px-4 py-3 font-semibold text-surface-700 dark:text-surface-300 rounded-tl-xl">Month</th>
            <th scope="col" class="px-4 py-3 font-semibold text-surface-700 dark:text-surface-300 text-right">Transactions</th>
            <th scope="col" class="px-4 py-3 font-semibold text-surface-700 dark:text-surface-300 text-right">Volume</th>
            <th scope="col" class="px-4 py-3 font-semibold text-surface-700 dark:text-surface-300 text-right">Total Service Charge</th>
            <th scope="col" class="px-4 py-3 font-semibold text-surface-700 dark:text-surface-300 text-right rounded-tr-xl">Company Service Charge</th>
          </tr>
        </thead>
  ...
  <div class="rounded-2xl border border-surface-200 dark:border-surface-700 bg-white dark:bg-surface-800 p-6 shadow-soft">
    ...
    <div *ngIf="report.corridorBreakdown.length > 0" class="overflow-x-auto">
      <table class="w-full text-sm text-left">
        <thead class="bg-surface-50 dark:bg-surface-700/50">
          <tr>
            <th scope="col" class="px-4 py-3 font-semibold text-surface-700 dark:text-surface-300 rounded-tl-xl">Corridor</th>
            <th scope="col" class="px-4 py-3 font-semibold text-surface-700 dark:text-surface-300 text-right">Transactions</th>
            <th scope="col" class="px-4 py-3 font-semibold text-surface-700 dark:text-surface-300 text-right">Volume</th>
            <th scope="col" class="px-4 py-3 font-semibold text-surface-700 dark:text-surface-300 text-right rounded-tr-xl">Service Charge</th>
          </tr>
        </thead>
        <tbody class="divide-y divide-surface-100 dark:divide-surface-700">
...
//# sourceMappingURL=chunk-HBMMW2XU.js.map
