...
function UsersComponent_div_9_button_29_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, UsersComponent_div_9_button_29__svg_svg_1_Template, 2, 0, "svg", 55);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function UsersComponent_div_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(12, UsersComponent_div_9_p_12_Template, 2, 0, "p", 33);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "div")(14, "label", 13);
    \u0275\u0275text(15, "Phone Number");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "input", 31);
    ...
    \u0275\u0275text(19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "div", 14)(21, "input", 34);
    ...
    \u0275\u0275template(23, UsersComponent_div_9__svg_svg_23_Template, 3, 0, "svg", 36)(24, UsersComponent_div_9__svg_svg_24_Template, 2, 0, "svg", 36);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(25, "div", 37)(26, "label", 38);
    \u0275\u0275text(27, "Roles");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(28, "div", 39);
    \u0275\u0275template(29, UsersComponent_div_9_button_29_Template, 3, 4, "button", 40);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(30, "div", 37)(31, "label", 41)(32, "div", 14)(33, "input", 42);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275element(34, "div", 43)(35, "div", 44);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(36, "span", 45);
    \u0275\u0275text(37, "Active");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(38, "div", 46)(39, "button", 47);
...
function UsersComponent_div_10_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(2, "circle", 63)(3, "path", 64);
    \u0275\u0275elementEnd()();
  }
}
...
function UsersComponent_div_10_div_2_tr_19_ng_container_23_ng_container_10_Template(rf, ctx) {
  if (rf & 1) {
    const _r11 = \u0275\u0275getCurrentView();
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "button", 98);
    \u0275\u0275listener("click", function UsersComponent_div_10_div_2_tr_19_ng_container_23_ng_container_10_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r11);
      const user_r10 = \u0275\u0275nextContext(2).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.deleteConfirmId = user_r10.id);
    });
    \u0275\u0275namespaceSVG();
...
function UsersComponent_div_10_div_2_tr_19_ng_container_23_span_11_Template(rf, ctx) {
  if (rf & 1) {
    const _r12 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "span", 100)(1, "span", 101);
    \u0275\u0275text(2, "Delete?");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "button", 102);
    \u0275\u0275listener("click", function UsersComponent_div_10_div_2_tr_19_ng_container_23_span_11_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r12);
      const user_r10 = \u0275\u0275nextContext(2).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
      ctx_r1.deleteUser(user_r10);
      return \u0275\u0275resetView(ctx_r1.deleteConfirmId = null);
    });
    \u0275\u0275text(4, "Yes");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "button", 103);
    \u0275\u0275listener("click", function UsersComponent_div_10_div_2_tr_19_ng_container_23_span_11_Template_button_click_5_listener() {
      \u0275\u0275restoreView(_r12);
...
function UsersComponent_div_10_div_2_tr_19_ng_container_23_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "div", 89)(2, "button", 90);
    ...
    \u0275\u0275template(7, UsersComponent_div_10_div_2_tr_19_ng_container_23__svg_svg_7_Template, 2, 0, "svg", 94)(8, UsersComponent_div_10_div_2_tr_19_ng_container_23__svg_svg_8_Template, 2, 0, "svg", 94);
    \u0275\u0275text(9);
    \u0275\u0275elementEnd();
    \u0275\u0275template(10, UsersComponent_div_10_div_2_tr_19_ng_container_23_ng_container_10_Template, 5, 0, "ng-container", 86)(11, UsersComponent_div_10_div_2_tr_19_ng_container_23_span_11_Template, 7, 0, "span", 95);
    \u0275\u0275elementEnd();
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.deleteConfirmId !== user_r10.id);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.deleteConfirmId === user_r10.id);
  }
}
...
function UsersComponent_div_10_div_2_tr_19_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr", 73)(1, "td", 74)(2, "div", 75)(3, "div", 76);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "span", 77);
    \u0275\u0275text(6);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(7, "td", 78);
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "td", 79);
    \u0275\u0275text(10);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "td", 74)(12, "div", 80);
    \u0275\u0275template(13, UsersComponent_div_10_div_2_tr_19_span_13_Template, 2, 6, "span", 81);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(14, "td", 74)(15, "div", 25);
    \u0275\u0275element(16, "span", 82);
    \u0275\u0275elementStart(17, "span", 83);
    \u0275\u0275text(18);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(19, "td", 84);
    \u0275\u0275text(20);
    \u0275\u0275pipe(21, "date");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(22, "td", 85);
    \u0275\u0275template(23, UsersComponent_div_10_div_2_tr_19_ng_container_23_Template, 12, 6, "ng-container", 86)(24, UsersComponent_div_10_div_2_tr_19_span_24_Template, 2, 0, "span", 87);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function UsersComponent_div_10_div_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 65)(1, "table", 66)(2, "thead", 67)(3, "tr", 68)(4, "th", 69);
    \u0275\u0275text(5, "User");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "th", 69);
    \u0275\u0275text(7, "Email");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "th", 69);
    \u0275\u0275text(9, "Phone");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "th", 69);
    \u0275\u0275text(11, "Roles");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "th", 69);
    \u0275\u0275text(13, "Status");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275template(19, UsersComponent_div_10_div_2_tr_19_Template, 25, 17, "tr", 71);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(20, UsersComponent_div_10_div_2_div_20_Template, 2, 0, "div", 72);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function UsersComponent_div_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, UsersComponent_div_10_div_1_Template, 4, 0, "div", 59)(2, UsersComponent_div_10_div_2_Template, 21, 2, "div", 60);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
            ...
            <td class="px-4 py-3 text-right">
              <ng-container *ngIf="!isSystemAdmin(user)">
                <div class="flex items-center justify-end gap-1">
                  ...
                  <ng-container *ngIf="deleteConfirmId !== user.id">
                    <button (click)="deleteConfirmId = user.id"
                  ...
                  <span *ngIf="deleteConfirmId === user.id" class="inline-flex items-center gap-1.5 text-xs">
                    <span class="text-danger-700 dark:text-danger-400 font-medium">Delete?</span>
                    <button (click)="deleteUser(user); deleteConfirmId = null"
...
//# sourceMappingURL=chunk-RDMCQKZK.js.map
