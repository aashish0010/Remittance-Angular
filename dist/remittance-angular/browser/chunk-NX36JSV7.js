...
function AdminTransactionsComponent_div_13_tr_53_button_33_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 70);
    \u0275\u0275listener("click", function AdminTransactionsComponent_div_13_tr_53_button_33_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r6);
  ...
  if (rf & 2) {
    const txn_r5 = \u0275\u0275nextContext().$implicit;
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275property("disabled", ctx_r1.actionLoadingId === txn_r5.id);
  }
}
function AdminTransactionsComponent_div_13_tr_53_button_34_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 72);
    \u0275\u0275listener("click", function AdminTransactionsComponent_div_13_tr_53_button_34_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r7);
      const txn_r5 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.confirmPayout(txn_r5));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(1, "svg", 64);
    \u0275\u0275element(2, "path", 73);
...
function AdminTransactionsComponent_div_13_tr_53_button_35_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 74);
    \u0275\u0275listener("click", function AdminTransactionsComponent_div_13_tr_53_button_35_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r8);
      const txn_r5 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
...
function AdminTransactionsComponent_div_13_tr_53_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(19, "number");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "td", 58)(21, "span", 59);
    \u0275\u0275text(22);
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275pipe(25, "date");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(26, "td", 61)(27, "div", 62)(28, "button", 63);
    \u0275\u0275listener("click", function AdminTransactionsComponent_div_13_tr_53_Template_button_click_28_listener() {
      const txn_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.viewDetail(txn_r5));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(29, "svg", 64);
    \u0275\u0275element(30, "path", 65)(31, "path", 66);
    \u0275\u0275elementEnd();
    \u0275\u0275text(32, " View ");
    \u0275\u0275elementEnd();
    \u0275\u0275template(33, AdminTransactionsComponent_div_13_tr_53_button_33_Template, 4, 1, "button", 67)(34, AdminTransactionsComponent_div_13_tr_53_button_34_Template, 4, 1, "button", 68)(35, AdminTransactionsComponent_div_13_tr_53_button_35_Template, 4, 1, "button", 69);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction1(32, _c0, odd_r9));
    \u0275\u0275advance(2);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(34, _c1, txn_r5.id));
    \u0275\u0275advance();
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate2("", \u0275\u0275pipeBind2(10, 17, txn_r5.sendAmount, "1.2-2"), " ", txn_r5.sendCurrency, "");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate2("", \u0275\u0275pipeBind2(13, 20, txn_r5.receiveAmount, "1.2-2"), " ", txn_r5.receiveCurrency, "");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(16, 23, txn_r5.exchangeRateApplied, "1.2-2"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(19, 26, txn_r5.totalCommission, "1.2-2"));
    \u0275\u0275advance(3);
    \u0275\u0275property("ngClass", ctx_r1.getStatusClass(txn_r5.status));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r1.getStatusLabel(txn_r5.status), " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(25, 29, txn_r5.createdAt, "MMM dd, HH:mm"));
    \u0275\u0275advance(9);
    \u0275\u0275property("ngIf", txn_r5.status === "Pending");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.canConfirmPayout(txn_r5.status));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", (txn_r5.status === "Pending" || txn_r5.status === "Completed") && ctx_r1.appSettings.cancellationAllowed);
  }
}
function AdminTransactionsComponent_div_13_tr_54_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminTransactionsComponent_div_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(27, "Cancelled");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(28, "div", 31)(29, "table", 32)(30, "thead")(31, "tr", 33)(32, "th", 34);
    \u0275\u0275text(33, "Reference");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(34, "th", 34);
    \u0275\u0275text(35, "Sender");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(39, "Send Amount");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(40, "th", 34);
    \u0275\u0275text(41, "Receive Amount");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(42, "th", 34);
    \u0275\u0275text(43, "Rate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(44, "th", 34);
    \u0275\u0275text(45, "Service Charge");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(46, "th", 34);
    \u0275\u0275text(47, "Status");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(48, "th", 34);
    \u0275\u0275text(49, "Date");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(50, "th", 35);
    \u0275\u0275text(51, "Actions");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(52, "tbody", 36);
    \u0275\u0275template(53, AdminTransactionsComponent_div_13_tr_53_Template, 36, 36, "tr", 37)(54, AdminTransactionsComponent_div_13_tr_54_Template, 3, 0, "tr", 38);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(55, "div", 39)(56, "div", 40);
    \u0275\u0275text(57);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(58, "div", 2)(59, "select", 41);
    \u0275\u0275listener("ngModelChange", function AdminTransactionsComponent_div_13_Template_select_ngModelChange_59_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onPageChange({ pageIndex: 0, pageSize: $event }));
    });
    \u0275\u0275elementStart(60, "option", 42);
    \u0275\u0275text(61, "10 / page");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function AdminTransactionsComponent_div_13_Template_button_click_66_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onPageChange({ pageIndex: 0, pageSize: ctx_r1.pageSize }));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(67, "svg", 4);
    \u0275\u0275element(68, "path", 44);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    ...
    \u0275\u0275listener("click", function AdminTransactionsComponent_div_13_Template_button_click_75_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onPageChange({ pageIndex: ctx_r1.pageIndex + 1, pageSize: ctx_r1.pageSize }));
    });
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(78, "button", 50);
    \u0275\u0275listener("click", function AdminTransactionsComponent_div_13_Template_button_click_78_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(46);
    \u0275\u0275property("ngForOf", ctx_r1.transactions)("ngForTrackBy", ctx_r1.trackById);
    \u0275\u0275advance();
    ...
    \u0275\u0275property("disabled", ctx_r1.pageIndex === 0);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate2(" Page ", ctx_r1.pageIndex + 1, " of ", ctx_r1.totalCount === 0 ? 1 : \u0275\u0275pipeBind2(74, 19, (ctx_r1.totalCount + ctx_r1.pageSize - 1) / ctx_r1.pageSize, "1.0-0"), " ");
    \u0275\u0275advance(2);
...
function AdminTransactionsComponent_div_14_div_39_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div")(1, "span", 84);
    \u0275\u0275text(2, "Bank");
    \u0275\u0275elementEnd();
...
function AdminTransactionsComponent_div_14_div_96_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div")(1, "span", 84);
    \u0275\u0275text(2, "Partner Reference");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(ctx_r1.selectedTransaction.partnerReferenceId);
  }
}
function AdminTransactionsComponent_div_14_div_97_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(3, "div")(4, "p", 95);
    \u0275\u0275text(5, "Partner Error");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate(ctx_r1.selectedTransaction.lastPartnerError);
  }
}
function AdminTransactionsComponent_div_14_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(2, "div", 79)(3, "h3", 80);
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(8, "div", 83)(9, "div")(10, "span", 84);
    \u0275\u0275text(11, "Reference");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "span", 85);
    \u0275\u0275text(13);
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(27, "span", 87);
    \u0275\u0275text(28);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(29, "div")(30, "span", 84);
    \u0275\u0275text(31, "Receiver");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(32, "span", 87);
    \u0275\u0275text(33);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(34, "div")(35, "span", 84);
    \u0275\u0275text(36, "Receiver Country");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(37, "span", 87);
    \u0275\u0275text(38);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(39, AdminTransactionsComponent_div_14_div_39_Template, 5, 1, "div", 38)(40, AdminTransactionsComponent_div_14_div_40_Template, 5, 1, "div", 38)(41, AdminTransactionsComponent_div_14_div_41_Template, 5, 1, "div", 38);
    \u0275\u0275elementStart(42, "div")(43, "span", 84);
    \u0275\u0275text(44, "Date");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(45, "span", 87);
    \u0275\u0275text(46);
    \u0275\u0275pipe(47, "date");
    \u0275\u0275elementEnd()()();
    \u0275\u0275element(48, "hr", 88);
    \u0275\u0275elementStart(49, "div", 89)(50, "div")(51, "span", 84);
    ...
    \u0275\u0275pipe(55, "number");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(56, "div")(57, "span", 84);
    \u0275\u0275text(58, "Receive Amount");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(59, "span", 90);
    \u0275\u0275text(60);
    \u0275\u0275pipe(61, "number");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(62, "div")(63, "span", 84);
    \u0275\u0275text(64, "Exchange Rate");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(65, "span", 87);
    \u0275\u0275text(66);
    \u0275\u0275pipe(67, "number");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(68, "div")(69, "span", 84);
    \u0275\u0275text(70, "Total Service Charge");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(71, "span", 87);
    \u0275\u0275text(72);
    \u0275\u0275pipe(73, "number");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(74, "div")(75, "span", 84);
    ...
    \u0275\u0275pipe(79, "number");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(80, "div")(81, "span", 84);
    \u0275\u0275text(82, "Payout Agent Service Charge");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(83, "span", 87);
    \u0275\u0275text(84);
    \u0275\u0275pipe(85, "number");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(86, "div")(87, "span", 84);
    \u0275\u0275text(88, "Company Service Charge");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(89, "span", 87);
    \u0275\u0275text(90);
    \u0275\u0275pipe(91, "number");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(92, AdminTransactionsComponent_div_14_div_92_Template, 5, 1, "div", 38)(93, AdminTransactionsComponent_div_14_div_93_Template, 5, 1, "div", 38)(94, AdminTransactionsComponent_div_14_div_94_Template, 5, 1, "div", 38)(95, AdminTransactionsComponent_div_14_div_95_Template, 5, 1, "div", 38)(96, AdminTransactionsComponent_div_14_div_96_Template, 5, 1, "div", 38);
    \u0275\u0275elementEnd();
    \u0275\u0275template(97, AdminTransactionsComponent_div_14_div_97_Template, 8, 1, "div", 91);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(47, 26, ctx_r1.selectedTransaction.createdAt, "dd/MM/yyyy HH:mm"));
    \u0275\u0275advance(8);
    \u0275\u0275textInterpolate2(" ", \u0275\u0275pipeBind2(55, 29, ctx_r1.selectedTransaction.sendAmount, "1.2-2"), " ", ctx_r1.selectedTransaction.sendCurrency, " ");
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate2(" ", \u0275\u0275pipeBind2(61, 32, ctx_r1.selectedTransaction.receiveAmount, "1.2-2"), " ", ctx_r1.selectedTransaction.receiveCurrency, " ");
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(67, 35, ctx_r1.selectedTransaction.exchangeRateApplied, "1.4-4"));
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(73, 38, ctx_r1.selectedTransaction.totalCommission, "1.2-2"));
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(79, 41, ctx_r1.selectedTransaction.agentCommission, "1.2-2"));
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(85, 44, ctx_r1.selectedTransaction.payoutAgentCommission, "1.2-2"));
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(91, 47, ctx_r1.selectedTransaction.companyCommission, "1.2-2"));
    \u0275\u0275advance(2);
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.selectedTransaction.partnerReferenceId);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.selectedTransaction.lastPartnerError);
  }
}
var AdminTransactionsComponent = class _AdminTransactionsComponent {
  constructor(api, exportService, auth, notify, route, signalR, appSettings) {
    this.api = api;
  ...
  ngOnInit() {
    ...
    this.signalR.transactionStatusUpdated$.pipe(takeUntil(this.destroy$)).subscribe((update) => {
      ...
      if (idx !== -1) {
        this.transactions[idx] = __spreadProps(__spreadValues({}, this.transactions[idx]), {
      ...
      if (this.selectedTransaction?.id === update.id) {
        this.selectedTransaction = __spreadProps(__spreadValues({}, this.selectedTransaction), {
          status: update.status,
          partnerReferenceId: update.partnerReferenceId,
          lastPartnerError: update.lastPartnerError
        });
    ...
    this.api.confirmPayout(txn.id).subscribe({
      next: (res) => {
        if (res?.success) {
          ...
          if (idx !== -1) {
            this.transactions[idx] = __spreadProps(__spreadValues({}, this.transactions[idx]), { status: "PendingPayout" });
            this.transactions = [...this.transactions];
          }
        } else {
  ...
  static {
    this.\u0275fac = function AdminTransactionsComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _AdminTransactionsComponent)(\u0275\u0275directiveInject(ApiService), \u0275\u0275directiveInject(ExportService), \u0275\u0275directiveInject(AuthStateService), \u0275\u0275directiveInject(NotificationService), \u0275\u0275directiveInject(ActivatedRoute), \u0275\u0275directiveInject(SignalRService), \u0275\u0275directiveInject(AppSettingsService));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AdminTransactionsComponent, selectors: [["app-admin-transactions"]], decls: 15, vars: 3, consts: [[1, "flex", "flex-col", "sm:flex-row", "sm:items-center", "sm:justify-between", "gap-4", "mb-6"], [1, "text-2xl", "font-bold", "text-surface-900", "dark:text-surface-100"], [1, "flex", "items-center", "gap-2"], [1, "inline-flex", "items-center", "gap-2", "px-4", "py-2", "rounded-lg", "border", "border-surface-300", "dark:border-surface-600", "bg-white", "dark:bg-surface-700", "text-surface-700", "dark:text-surface-200", "hover:bg-surface-50", "dark:hover:bg-surface-600", "transition", "text-sm", "font-medium", 3, "click"], ["xmlns", "http://www.w3.org/2000/svg", "fill", "none", "viewBox", "0 0 24 24", "stroke-width", "1.5", "stroke", "currentColor", 1, "h-4", "w-4"], ["stroke-linecap", "round", "stroke-linejoin", "round", "d", "M3 16.5v2.25A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75V16.5M16.5 12 12 16.5m0 0L7.5 12m4.5 4.5V3"], ["class", "flex items-center justify-center py-24", 4, "ngIf"], ["class", "rounded-2xl border border-surface-200 dark:border-surface-700 bg-white dark:bg-surface-800 shadow-soft", 4, "ngIf"], ["role", "dialog", "aria-modal", "true", "aria-labelledby", "txn-detail-title", "class", "fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm", 3, "click", 4, "ngIf"], [1, "flex", "items-center", "justify-center", "py-24"], ["xmlns", "http://www.w3.org/2000/svg", "fill", "none", "viewBox", "0 0 24 24", 1, "animate-spin", "h-10", "w-10", "text-brand-500"], ["cx", "12", "cy", "12", "r", "10", "stroke", "currentColor", "stroke-width", "4", 1, "opacity-25"], ["fill", "currentColor", "d", "M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z", 1, "opacity-75"], [1, "rounded-2xl", "border", "border-surface-200", "dark:border-surface-700", "bg-white", "dark:bg-surface-800", "shadow-soft"], [1, "flex", "flex-col", "sm:flex-row", "gap-3", "p-4", "border-b", "border-surface-200", "dark:border-surface-700"], [1, "relative", "flex-1"], ["xmlns", "http://www.w3.org/2000/svg", "fill", "none", "viewBox", "0 0 24 24", "stroke-width", "1.5", "stroke", "currentColor", 1, "absolute", "left-3", "top-1/2", "-translate-y-1/2", "h-4", "w-4", "text-surface-400"], ["stroke-linecap", "round", "stroke-linejoin", "round", "d", "m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z"], ["type", "text", "placeholder", "Search by reference, sender, receiver...", 1, "w-full", "pl-10", "pr-9", "py-2", "rounded-lg", "border", "border-surface-300", "dark:border-surface-600", "bg-white", "dark:bg-surface-700", "text-surface-900", "dark:text-surface-100", "placeholder-surface-400", "dark:placeholder-surface-500", "focus:ring-2", "focus:ring-brand-500", "focus:border-brand-500", "outline-none", "transition", "text-sm", 3, "ngModelChange", "ngModel"], ["class", "absolute right-2 top-1/2 -translate-y-1/2 p-0.5 rounded text-surface-400 hover:text-surface-600 dark:hover:text-surface-300 transition", "aria-label", "Clear search", 3, "click", 4, "ngIf"], [1, "w-full", "sm:w-44", "px-3", "py-2", "rounded-lg", "border", "border-surface-300", "dark:border-surface-600", "bg-white", "dark:bg-surface-700", "text-surface-900", "dark:text-surface-100", "focus:ring-2", "focus:ring-brand-500", "focus:border-brand-500", "outline-none", "transition", "text-sm", 3, "ngModelChange", "ngModel"], ["value", "All"], ["value", "OnHold"], ["value", "Compliance"], ["value", "PendingApproval"], ["value", "Pending"], ["value", "PendingPayout"], ["value", "ProcessingAtPartner"], ["value", "Completed"], ["value", "Failed"], ["value", "Cancelled"], [1, "overflow-x-auto"], [1, "w-full", "text-left", "text-sm"], [1, "border-b", "border-surface-200", "dark:border-surface-700", "bg-surface-50", "dark:bg-surface-800/50"], ["scope", "col", 1, "px-4", "py-3", "font-semibold", "text-surface-600", "dark:text-surface-400", "text-xs", "tracking-wide"], ["scope", "col", 1, "px-4", "py-3", "font-semibold", "text-surface-600", "dark:text-surface-400", "text-xs", "tracking-wide", "text-center"], [1, "divide-y", "divide-surface-100", "dark:divide-surface-700"], ["class", "hover:bg-brand-50/40 dark:hover:bg-surface-700/50 transition-colors", 3, "ngClass", 4, "ngFor", "ngForOf", "ngForTrackBy"], [4, "ngIf"], [1, "flex", "flex-col", "sm:flex-row", "items-center", "justify-between", "gap-3", "px-4", "py-3", "border-t", "border-surface-200", "dark:border-surface-700"], [1, "text-sm", "text-surface-500", "dark:text-surface-400"], [1, "px-2", "py-1.5", "rounded-lg", "border", "border-surface-300", "dark:border-surface-600", "bg-white", "dark:bg-surface-700", "text-surface-900", "dark:text-surface-100", "text-sm", "focus:ring-2", "focus:ring-brand-500", "focus:border-brand-500", "outline-none", "transition", 3, "ngModelChange", "ngModel"], [3, "ngValue"], ["aria-label", "First page", 1, "p-1.5", "rounded-lg", "border", "border-surface-300", "dark:border-surface-600", "bg-white", "dark:bg-surface-700", "text-surface-600", "dark:text-surface-300", "hover:bg-surface-50", "dark:hover:bg-surface-600", "disabled:opacity-40", "disabled:cursor-not-allowed", "transition", 3, "click", "disabled"], ["stroke-linecap", "round", "stroke-linejoin", "round", "d", "m18.75 4.5-7.5 7.5 7.5 7.5m-6-15L5.25 12l7.5 7.5"], ["aria-label", "Previous page", 1, "p-1.5", "rounded-lg", "border", "border-surface-300", "dark:border-surface-600", "bg-white", "dark:bg-surface-700", "text-surface-600", "dark:text-surface-300", "hover:bg-surface-50", "dark:hover:bg-surface-600", "disabled:opacity-40", "disabled:cursor-not-allowed", "transition", 3, "click", "disabled"], ["stroke-linecap", "round", "stroke-linejoin", "round", "d", "M15.75 19.5 8.25 12l7.5-7.5"], [1, "text-sm", "text-surface-700", "dark:text-surface-300", "px-2"], ["aria-label", "Next page", 1, "p-1.5", "rounded-lg", "border", "border-surface-300", "dark:border-surface-600", "bg-white", "dark:bg-surface-700", "text-surface-600", "dark:text-surface-300", "hover:bg-surface-50", "dark:hover:bg-surface-600", "disabled:opacity-40", "disabled:cursor-not-allowed", "transition", 3, "click", "disabled"], ["stroke-linecap", "round", "stroke-linejoin", "round", "d", "m8.25 4.5 7.5 7.5-7.5 7.5"], ["aria-label", "Last page", 1, "p-1.5", "rounded-lg", "border", "border-surface-300", "dark:border-surface-600", "bg-white", "dark:bg-surface-700", "text-surface-600", "dark:text-surface-300", "hover:bg-surface-50", "dark:hover:bg-surface-600", "disabled:opacity-40", "disabled:cursor-not-allowed", "transition", 3, "click", "disabled"], ["stroke-linecap", "round", "stroke-linejoin", "round", "d", "m5.25 4.5 7.5 7.5-7.5 7.5m6-15 7.5 7.5-7.5 7.5"], ["aria-label", "Clear search", 1, "absolute", "right-2", "top-1/2", "-translate-y-1/2", "p-0.5", "rounded", "text-surface-400", "hover:text-surface-600", "dark:hover:text-surface-300", "transition", 3, "click"], ["stroke-linecap", "round", "stroke-linejoin", "round", "d", "M6 18 18 6M6 6l12 12"], [1, "hover:bg-brand-50/40", "dark:hover:bg-surface-700/50", "transition-colors", 3, "ngClass"], [1, "px-4", "py-3", "font-mono", "text-xs"], [1, "text-brand-600", "dark:text-brand-400", "hover:underline", 3, "routerLink"], [1, "px-4", "py-3", "text-surface-900", "dark:text-surface-100"], [1, "px-4", "py-3"], [1, "px-2.5", "py-0.5", "rounded-full", "text-xs", "font-medium", "whitespace-nowrap", 3, "ngClass"], [1, "px-4", "py-3", "text-surface-900", "dark:text-surface-100", "whitespace-nowrap"], [1, "px-4", "py-3", "text-center", "whitespace-nowrap"], [1, "inline-flex", "items-center", "gap-1"], [1, "inline-flex", "items-center", "gap-1", "px-2", "py-1", "rounded-md", "text-xs", "font-medium", "text-brand-600", "dark:text-brand-400", "hover:bg-brand-50", "dark:hover:bg-brand-900/20", "transition", 3, "click"], ["fill", "none", "viewBox", "0 0 24 24", "stroke-width", "1.5", "stroke", "currentColor", 1, "h-3.5", "w-3.5"], ["stroke-linecap", "round", "stroke-linejoin", "round", "d", "M2.036 12.322a1.012 1.012 0 0 1 0-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178Z"], ["stroke-linecap", "round", "stroke-linejoin", "round", "d", "M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z"], ["class", "inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-medium text-success-600 dark:text-success-400 hover:bg-success-50 dark:hover:bg-success-900/20 transition disabled:opacity-50 disabled:cursor-not-allowed", 3, "disabled", "click", 4, "ngIf"], ["class", "inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-medium text-indigo-600 dark:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-indigo-900/20 transition disabled:opacity-50 disabled:cursor-not-allowed", 3, "disabled", "click", 4, "ngIf"], ["class", "inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-medium text-danger-600 dark:text-danger-400 hover:bg-danger-50 dark:hover:bg-danger-900/20 transition disabled:opacity-50 disabled:cursor-not-allowed", 3, "disabled", "click", 4, "ngIf"], [1, "inline-flex", "items-center", "gap-1", "px-2", "py-1", "rounded-md", "text-xs", "font-medium", "text-success-600", "dark:text-success-400", "hover:bg-success-50", "dark:hover:bg-success-900/20", "transition", "disabled:opacity-50", "disabled:cursor-not-allowed", 3, "click", "disabled"], ["stroke-linecap", "round", "stroke-linejoin", "round", "d", "M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"], [1, "inline-flex", "items-center", "gap-1", "px-2", "py-1", "rounded-md", "text-xs", "font-medium", "text-indigo-600", "dark:text-indigo-400", "hover:bg-indigo-50", "dark:hover:bg-indigo-900/20", "transition", "disabled:opacity-50", "disabled:cursor-not-allowed", 3, "click", "disabled"], ["stroke-linecap", "round", "stroke-linejoin", "round", "d", "M6 12L3.269 3.126A59.768 59.768 0 0 1 21.485 12 59.77 59.77 0 0 1 3.27 20.876L5.999 12Zm0 0h7.5"], [1, "inline-flex", "items-center", "gap-1", "px-2", "py-1", "rounded-md", "text-xs", "font-medium", "text-danger-600", "dark:text-danger-400", "hover:bg-danger-50", "dark:hover:bg-danger-900/20", "transition", "disabled:opacity-50", "disabled:cursor-not-allowed", 3, "click", "disabled"], ["stroke-linecap", "round", "stroke-linejoin", "round", "d", "m9.75 9.75 4.5 4.5m0-4.5-4.5 4.5M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"], ["colspan", "10", 1, "px-4", "py-12", "text-center", "text-surface-400", "dark:text-surface-500", "italic"], ["role", "dialog", "aria-modal", "true", "aria-labelledby", "txn-detail-title", 1, "fixed", "inset-0", "z-50", "flex", "items-center", "justify-center", "bg-black/50", "backdrop-blur-sm", 3, "click"], [1, "relative", "w-full", "max-w-2xl", "mx-4", "max-h-[90vh]", "overflow-y-auto", "rounded-2xl", "border", "border-surface-200", "dark:border-surface-700", "bg-white", "dark:bg-surface-800", "p-6", "shadow-soft", 3, "click"], [1, "flex", "items-center", "justify-between", "mb-6"], ["id", "txn-detail-title", 1, "text-lg", "font-semibold", "text-surface-900", "dark:text-surface-100"], ["aria-label", "Close dialog", 1, "p-1.5", "rounded-lg", "text-surface-400", "hover:text-surface-600", "dark:hover:text-surface-300", "hover:bg-surface-100", "dark:hover:bg-surface-700", "transition", 3, "click"], ["xmlns", "http://www.w3.org/2000/svg", "fill", "none", "viewBox", "0 0 24 24", "stroke-width", "1.5", "stroke", "currentColor", 1, "h-5", "w-5"], [1, "grid", "grid-cols-1", "sm:grid-cols-2", "gap-4", "mb-6"], [1, "block", "text-xs", "font-medium", "text-surface-500", "dark:text-surface-400", "mb-1"], [1, "text-sm", "font-mono", "text-surface-900", "dark:text-surface-100"], [1, "px-2.5", "py-0.5", "rounded-full", "text-xs", "font-medium", 3, "ngClass"], [1, "text-sm", "text-surface-900", "dark:text-surface-100"], [1, "border-surface-200", "dark:border-surface-700", "mb-6"], [1, "grid", "grid-cols-1", "sm:grid-cols-2", "gap-4"], [1, "text-sm", "font-semibold", "text-surface-900", "dark:text-surface-100"], ["class", "mt-4 rounded-xl border border-danger-200 dark:border-danger-800 bg-danger-50 dark:bg-danger-900/20 p-4 flex items-start gap-3", 4, "ngIf"], [1, "mt-4", "rounded-xl", "border", "border-danger-200", "dark:border-danger-800", "bg-danger-50", "dark:bg-danger-900/20", "p-4", "flex", "items-start", "gap-3"], ["fill", "none", "viewBox", "0 0 24 24", "stroke-width", "1.5", "stroke", "currentColor", 1, "h-5", "w-5", "text-danger-500", "mt-0.5", "shrink-0"], ["stroke-linecap", "round", "stroke-linejoin", "round", "d", "M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126ZM12 15.75h.007v.008H12v-.008Z"], [1, "text-sm", "font-medium", "text-danger-700", "dark:text-danger-300"], [1, "text-xs", "text-danger-600", "dark:text-danger-400", "mt-1"]], template: function AdminTransactionsComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275text(11, " CSV ");
        \u0275\u0275elementEnd()()();
        \u0275\u0275template(12, AdminTransactionsComponent_div_12_Template, 4, 0, "div", 6)(13, AdminTransactionsComponent_div_13_Template, 81, 22, "div", 7)(14, AdminTransactionsComponent_div_14_Template, 98, 50, "div", 8);
      }
      if (rf & 2) {
        \u0275\u0275advance(12);
...
<div *ngIf="!loading" class="rounded-2xl border border-surface-200 dark:border-surface-700 bg-white dark:bg-surface-800 shadow-soft">
  ...
  <div class="flex flex-col sm:flex-row gap-3 p-4 border-b border-surface-200 dark:border-surface-700">
    ...
    >
      ...
      <option value="PendingPayout">Pending Payout</option>
      <option value="ProcessingAtPartner">At Partner</option>
    ...
    <table class="w-full text-left text-sm">
      <thead>
        <tr class="border-b border-surface-200 dark:border-surface-700 bg-surface-50 dark:bg-surface-800/50">
          <th scope="col" class="px-4 py-3 font-semibold text-surface-600 dark:text-surface-400 text-xs tracking-wide">Reference</th>
          <th scope="col" class="px-4 py-3 font-semibold text-surface-600 dark:text-surface-400 text-xs tracking-wide">Sender</th>
          <th scope="col" class="px-4 py-3 font-semibold text-surface-600 dark:text-surface-400 text-xs tracking-wide">Receiver</th>
          <th scope="col" class="px-4 py-3 font-semibold text-surface-600 dark:text-surface-400 text-xs tracking-wide">Send Amount</th>
          <th scope="col" class="px-4 py-3 font-semibold text-surface-600 dark:text-surface-400 text-xs tracking-wide">Receive Amount</th>
          <th scope="col" class="px-4 py-3 font-semibold text-surface-600 dark:text-surface-400 text-xs tracking-wide">Rate</th>
          <th scope="col" class="px-4 py-3 font-semibold text-surface-600 dark:text-surface-400 text-xs tracking-wide">Service Charge</th>
          <th scope="col" class="px-4 py-3 font-semibold text-surface-600 dark:text-surface-400 text-xs tracking-wide">Status</th>
          <th scope="col" class="px-4 py-3 font-semibold text-surface-600 dark:text-surface-400 text-xs tracking-wide">Date</th>
          <th scope="col" class="px-4 py-3 font-semibold text-surface-600 dark:text-surface-400 text-xs tracking-wide text-center">Actions</th>
        </tr>
      </thead>
      <tbody class="divide-y divide-surface-100 dark:divide-surface-700">
        <tr
          *ngFor="let txn of transactions; let odd = odd; trackBy: trackById"
            ...
            <div class="inline-flex items-center gap-1">
              ...
              <button
                *ngIf="txn.status === 'Pending'"
                ...
                class="inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-medium text-success-600 dark:text-success-400 hover:bg-success-50 dark:hover:bg-success-900/20 transition disabled:opacity-50 disabled:cursor-not-allowed">
                <svg class="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
              ...
              <!-- Pending: Confirm Payout -->
              <button
                *ngIf="canConfirmPayout(txn.status)"
                (click)="confirmPayout(txn)"
                [disabled]="actionLoadingId === txn.id"
                class="inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-medium text-indigo-600 dark:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-indigo-900/20 transition disabled:opacity-50 disabled:cursor-not-allowed">
                <svg class="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
              ...
              <button
                *ngIf="(txn.status === 'Pending' || txn.status === 'Completed') && appSettings.cancellationAllowed"
                (click)="cancelTransaction(txn)"
                [disabled]="actionLoadingId === txn.id"
                class="inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-medium text-danger-600 dark:text-danger-400 hover:bg-danger-50 dark:hover:bg-danger-900/20 transition disabled:opacity-50 disabled:cursor-not-allowed">
                <svg class="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
...
>
  ...
  >
    ...
    <div class="flex items-center justify-between mb-6">
      <h3 id="txn-detail-title" class="text-lg font-semibold text-surface-900 dark:text-surface-100">Transaction Details</h3>
      <button
        (click)="closeDetail()"
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
      ...
      <div *ngIf="selectedTransaction.partnerReferenceId">
        <span class="block text-xs font-medium text-surface-500 dark:text-surface-400 mb-1">Partner Reference</span>
        <span class="text-sm font-mono text-surface-900 dark:text-surface-100">{{ selectedTransaction.partnerReferenceId }}</span>
      </div>
    </div>

    <!-- Partner Error Alert -->
    <div
      *ngIf="selectedTransaction.lastPartnerError"
      class="mt-4 rounded-xl border border-danger-200 dark:border-danger-800 bg-danger-50 dark:bg-danger-900/20 p-4 flex items-start gap-3"
    >
      ...
      <div>
        <p class="text-sm font-medium text-danger-700 dark:text-danger-300">Partner Error</p>
        <p class="text-xs text-danger-600 dark:text-danger-400 mt-1">{{ selectedTransaction.lastPartnerError }}</p>
      </div>
    </div>
  </div>
</div>
`, styles: ["/* src/app/pages/admin/transactions/admin-transactions.component.scss */\n:host {\n  display: block;\n}\n/*# sourceMappingURL=admin-transactions.component.css.map */\n"] }]
  }], () => [{ type: ApiService }, { type: ExportService }, { type: AuthStateService }, { type: NotificationService }, { type: ActivatedRoute }, { type: SignalRService }, { type: AppSettingsService }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminTransactionsComponent, { className: "AdminTransactionsComponent", filePath: "src/app/pages/admin/transactions/admin-transactions.component.ts", lineNumber: 28 });
})();
export {
  AdminTransactionsComponent
};
//# sourceMappingURL=chunk-NX36JSV7.js.map
