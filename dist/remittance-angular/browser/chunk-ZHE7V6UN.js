    ...
    <table class="w-full text-sm text-left">
      <thead>
        <tr class="border-b border-surface-200 dark:border-surface-700">
          ...
          <th class="px-4 py-3 font-semibold text-surface-600 dark:text-surface-300">KYC</th>
...
<!-- Detail Popup                                                  -->
<!-- ============================================================ -->
<div *ngIf="showDetail && detailCustomer" class="fixed inset-0 bg-black/50 z-[10000]" (click)="closeDetail()"></div>
<div *ngIf="showDetail && detailCustomer"
     class="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[10001] w-full max-w-2xl max-h-[90vh] overflow-y-auto rounded-2xl bg-white dark:bg-surface-800 shadow-xl p-6">
  <!-- Header -->
...
<!-- ============================================================ -->
<div *ngIf="showDocViewer" class="fixed inset-0 bg-black/50 z-[10000]" (click)="closeDocViewer()"></div>
<div *ngIf="showDocViewer"
     class="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[10001] w-full max-w-3xl max-h-[90vh] overflow-y-auto rounded-2xl bg-white dark:bg-surface-800 shadow-xl p-6">
  <!-- Header -->
  <div class="flex items-center justify-between mb-5">
...
<div *ngIf="showImagePopup" class="fixed inset-0 bg-black/60 z-[10002]" (click)="closeImagePopup()"></div>
<div *ngIf="showImagePopup" class="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[10003] bg-white dark:bg-surface-800 rounded-xl p-3 shadow-2xl max-w-[90vw] max-h-[90vh]">
...
//# sourceMappingURL=chunk-ZHE7V6UN.js.map
