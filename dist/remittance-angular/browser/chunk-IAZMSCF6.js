...
function ReceiversComponent_div_21_tr_37_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(6);
    \u0275\u0275property("title", r_r5.isActive ? "Disable" : "Enable")("ngClass", r_r5.isActive ? "text-warning-600 hover:bg-warning-50 dark:hover:bg-warning-900/20" : "text-success-600 hover:bg-success-50 dark:hover:bg-success-900/20");
    \u0275\u0275advance();
...
function ReceiversComponent_div_25_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(46, "div", 107)(47, "label", 108);
    ...
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(50, "div", 112)(51, "button", 113);
    ...
    \u0275\u0275template(54, ReceiversComponent_div_25__svg_svg_54_Template, 3, 0, "svg", 115)(55, ReceiversComponent_div_25__svg_svg_55_Template, 2, 0, "svg", 61);
    \u0275\u0275text(56);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    ...
    <table class="w-full text-sm text-left">
      <thead>
        <tr class="border-b border-surface-200 dark:border-surface-700 text-surface-600 dark:text-surface-300">
          ...
          <th class="px-4 py-3 font-semibold">Receiver Name</th>
          <th class="px-4 py-3 font-semibold">Phone</th>
          <th class="px-4 py-3 font-semibold">Country</th>
          <th class="px-4 py-3 font-semibold">Bank Name</th>
        ...
        <tr *ngFor="let r of receivers" class="border-b border-surface-100 dark:border-surface-700 hover:bg-surface-50 dark:hover:bg-surface-750 transition-colors">
          ...
          <td class="px-4 py-3">
            <div class="flex items-center gap-1">
              <button title="Edit" (click)="openEditPopup(r)" class="p-1.5 rounded-md text-brand-600 hover:bg-brand-50 dark:hover:bg-brand-900/20 transition"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg></button>
              <button [title]="r.isActive ? 'Disable' : 'Enable'" (click)="toggleReceiverStatus(r)"
              ...
              <button title="Delete" (click)="deleteReceiver(r)" class="p-1.5 rounded-md text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 transition"><svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/></svg></button>
            </div>
          </td>
        </tr>
      </tbody>
...
//# sourceMappingURL=chunk-IAZMSCF6.js.map
