...
function RoutingComponent_div_17_tr_26_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(29, "button", 63);
    \u0275\u0275listener("click", function RoutingComponent_div_17_tr_26_Template_button_click_29_listener() {
      const c_r4 = \u0275\u0275restoreView(_r3).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.deleteCorridor(c_r4));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(30, "svg", 57);
    \u0275\u0275element(31, "path", 64);
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(9);
    \u0275\u0275property("title", c_r4.isActive ? "Deactivate" : "Activate");
    \u0275\u0275advance();
...
function RoutingComponent_div_17_div_28_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "div", 70)(7, "div", 71)(8, "span", 72);
    ...
    \u0275\u0275text(16);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(17, "div", 71)(18, "span", 72);
    \u0275\u0275text(19, "Partners");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "span", 74);
    \u0275\u0275text(21);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(22, "div", 75)(23, "button", 76);
    \u0275\u0275listener("click", function RoutingComponent_div_17_div_28_Template_button_click_23_listener() {
      ...
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.openEditCorridor(c_r6));
    });
    \u0275\u0275namespaceSVG();
    ...
    \u0275\u0275listener("click", function RoutingComponent_div_17_div_28_Template_button_click_26_listener() {
      const c_r6 = \u0275\u0275restoreView(_r5).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.openPartnerManagement(c_r6));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(27, "svg", 77);
    \u0275\u0275element(28, "path", 80);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    ...
    \u0275\u0275listener("click", function RoutingComponent_div_17_div_28_Template_button_click_29_listener() {
      const c_r6 = \u0275\u0275restoreView(_r5).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.toggleCorridor(c_r6));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(30, "svg", 82);
    ...
    \u0275\u0275listener("click", function RoutingComponent_div_17_div_28_Template_button_click_33_listener() {
      const c_r6 = \u0275\u0275restoreView(_r5).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.deleteCorridor(c_r6));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(34, "svg", 77);
    \u0275\u0275element(35, "path", 84);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const c_r6 = ctx.$implicit;
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate2("", c_r6.sourceCountry, " \u2192 ", c_r6.destinationCountry, "");
    \u0275\u0275advance();
    \u0275\u0275property("ngClass", c_r6.isActive ? "bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400" : "bg-surface-100 text-surface-500 dark:bg-surface-700 dark:text-surface-400");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", c_r6.isActive ? "Active" : "Inactive", " ");
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(c_r6.sendingAgentName || "All");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate2("", c_r6.sourceCurrency, " \u2192 ", c_r6.destinationCurrency, "");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate((c_r6.payoutPartners == null ? null : c_r6.payoutPartners.length) || 0);
    \u0275\u0275advance(8);
    \u0275\u0275property("ngClass", c_r6.isActive ? "text-green-600 dark:text-green-400" : "text-surface-400 dark:text-surface-500");
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", c_r6.isActive);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !c_r6.isActive);
  }
}
...
function RoutingComponent_div_17_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(26, RoutingComponent_div_17_tr_26_Template, 32, 12, "tr", 27);
    \u0275\u0275elementEnd()()();
...
function RoutingComponent_div_19_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 87)(1, "div", 88)(2, "div", 89)(3, "h3", 90);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275template(9, RoutingComponent_div_19_div_9_Template, 2, 1, "div", 95);
    \u0275\u0275elementStart(10, "div", 96)(11, "div", 97)(12, "label", 98);
    \u0275\u0275text(13, "Sending Agent (optional)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "select", 99);
    ...
    \u0275\u0275elementStart(15, "option", 100);
    \u0275\u0275text(16, "All (Global)");
    \u0275\u0275elementEnd();
    \u0275\u0275template(17, RoutingComponent_div_19_option_17_Template, 2, 2, "option", 101);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(18, "div")(19, "label", 98);
    \u0275\u0275text(20, "Source Country *");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(21, "select", 102);
    ...
    \u0275\u0275elementStart(22, "option", 103);
    \u0275\u0275text(23, "Select");
    \u0275\u0275elementEnd();
    \u0275\u0275template(24, RoutingComponent_div_19_option_24_Template, 2, 2, "option", 104);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(25, "div")(26, "label", 98);
    \u0275\u0275text(27, "Source Currency *");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(28, "select", 102);
    ...
    \u0275\u0275elementStart(29, "option", 103);
    \u0275\u0275text(30, "Select");
    \u0275\u0275elementEnd();
    \u0275\u0275template(31, RoutingComponent_div_19_option_31_Template, 2, 2, "option", 104);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(32, "div")(33, "label", 98);
    \u0275\u0275text(34, "Destination Country *");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(35, "select", 102);
    ...
    \u0275\u0275elementStart(36, "option", 103);
    \u0275\u0275text(37, "Select");
    \u0275\u0275elementEnd();
    \u0275\u0275template(38, RoutingComponent_div_19_option_38_Template, 2, 2, "option", 104);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(39, "div")(40, "label", 98);
    ...
    \u0275\u0275elementStart(43, "option", 103);
    \u0275\u0275text(44, "Select");
    \u0275\u0275elementEnd();
    \u0275\u0275template(45, RoutingComponent_div_19_option_45_Template, 2, 2, "option", 104);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(46, "div", 105)(47, "button", 106);
    ...
    \u0275\u0275template(50, RoutingComponent_div_19__svg_svg_50_Template, 3, 0, "svg", 108)(51, RoutingComponent_div_19__svg_svg_51_Template, 2, 0, "svg", 109);
    \u0275\u0275text(52);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
...
function RoutingComponent_div_21_div_19_tr_14_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "tr", 134)(1, "td", 47);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "td", 50)(4, "div", 135);
    \u0275\u0275template(5, RoutingComponent_div_21_div_19_tr_14_span_5_Template, 2, 1, "span", 136);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "td", 50)(7, "span", 137);
    \u0275\u0275text(8);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "td", 138)(10, "div", 139)(11, "button", 140);
    \u0275\u0275listener("click", function RoutingComponent_div_21_div_19_tr_14_Template_button_click_11_listener() {
      const p_r19 = \u0275\u0275restoreView(_r17).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.openEditPartner(p_r19));
    });
    \u0275\u0275namespaceSVG();
    ...
    \u0275\u0275listener("click", function RoutingComponent_div_21_div_19_tr_14_Template_button_click_14_listener() {
      const p_r19 = \u0275\u0275restoreView(_r17).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.togglePartner(p_r19));
    });
    \u0275\u0275namespaceSVG();
    ...
    \u0275\u0275listener("click", function RoutingComponent_div_21_div_19_tr_14_Template_button_click_18_listener() {
      const p_r19 = \u0275\u0275restoreView(_r17).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.deletePartner(p_r19));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(19, "svg", 57);
    \u0275\u0275element(20, "path", 64);
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
    const p_r19 = ctx.$implicit;
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(p_r19.payoutAgentName);
    \u0275\u0275advance(3);
    \u0275\u0275property("ngForOf", p_r19.paymentModeNames);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngClass", p_r19.isActive ? "bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400" : "bg-surface-100 text-surface-500 dark:bg-surface-700 dark:text-surface-400");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", p_r19.isActive ? "Active" : "Inactive", " ");
    \u0275\u0275advance(6);
    \u0275\u0275property("title", p_r19.isActive ? "Deactivate" : "Activate");
    \u0275\u0275advance();
    \u0275\u0275property("ngClass", p_r19.isActive ? "text-green-600 dark:text-green-400" : "text-surface-400 dark:text-surface-500");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", p_r19.isActive);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !p_r19.isActive);
  }
}
...
function RoutingComponent_div_21_div_19_div_16_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 67)(1, "div", 144)(2, "span", 69);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275template(10, RoutingComponent_div_21_div_19_div_16_span_10_Template, 2, 1, "span", 136);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(11, "div", 147)(12, "button", 148);
    \u0275\u0275listener("click", function RoutingComponent_div_21_div_19_div_16_Template_button_click_12_listener() {
      const p_r22 = \u0275\u0275restoreView(_r20).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.openEditPartner(p_r22));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(13, "svg", 77);
    \u0275\u0275element(14, "path", 78);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(15, "button", 149);
    \u0275\u0275listener("click", function RoutingComponent_div_21_div_19_div_16_Template_button_click_15_listener() {
      const p_r22 = \u0275\u0275restoreView(_r20).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.togglePartner(p_r22));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(16, "svg", 82);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(19, "button", 150);
    \u0275\u0275listener("click", function RoutingComponent_div_21_div_19_div_16_Template_button_click_19_listener() {
      const p_r22 = \u0275\u0275restoreView(_r20).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.deletePartner(p_r22));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(20, "svg", 77);
    \u0275\u0275element(21, "path", 84);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const p_r22 = ctx.$implicit;
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(p_r22.payoutAgentName);
    \u0275\u0275advance();
    \u0275\u0275property("ngClass", p_r22.isActive ? "bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400" : "bg-surface-100 text-surface-500 dark:bg-surface-700 dark:text-surface-400");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", p_r22.isActive ? "Active" : "Inactive", " ");
    \u0275\u0275advance(5);
    \u0275\u0275property("ngForOf", p_r22.paymentModeNames);
    \u0275\u0275advance(5);
    \u0275\u0275property("ngClass", p_r22.isActive ? "text-green-600 dark:text-green-400" : "text-surface-400 dark:text-surface-500");
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", p_r22.isActive);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !p_r22.isActive);
  }
}
function RoutingComponent_div_21_div_19_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 127)(1, "div", 128)(2, "table", 24)(3, "thead", 129)(4, "tr", 25)(5, "th", 26);
    ...
    \u0275\u0275text(10, "Status");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "th", 131);
    \u0275\u0275text(12, "Actions");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(13, "tbody");
    \u0275\u0275template(14, RoutingComponent_div_21_div_19_tr_14_Template, 21, 8, "tr", 132);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(15, "div", 133);
...
function RoutingComponent_div_21_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 87)(1, "div", 114)(2, "div", 115)(3, "div")(4, "h3", 116);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(5, "svg", 117);
    \u0275\u0275element(6, "path", 58);
    \u0275\u0275elementEnd();
    \u0275\u0275text(7, " Payout Partners ");
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(8, "p", 118);
    \u0275\u0275text(9);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(10, "div", 119)(11, "button", 120);
    ...
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(16, "svg", 92);
    \u0275\u0275element(17, "path", 93);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275template(18, RoutingComponent_div_21_div_18_Template, 6, 2, "div", 122)(19, RoutingComponent_div_21_div_19_Template, 17, 2, "div", 123)(20, RoutingComponent_div_21_div_20_Template, 2, 0, "div", 124);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function RoutingComponent_div_23_option_16_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngValue", a_r25.id);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(a_r25.businessName);
  }
}
function RoutingComponent_div_23_label_21_Template(rf, ctx) {
  if (rf & 1) {
    const _r26 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "label", 163)(1, "input", 164);
    \u0275\u0275listener("change", function RoutingComponent_div_23_label_21_Template_input_change_1_listener() {
      const pm_r27 = \u0275\u0275restoreView(_r26).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.togglePaymentMode(pm_r27.id));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "span", 165);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const pm_r27 = ctx.$implicit;
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275property("checked", ctx_r1.isPaymentModeSelected(pm_r27.id));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(pm_r27.name);
  }
}
function RoutingComponent_div_23_Template(rf, ctx) {
  if (rf & 1) {
    const _r24 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 153)(1, "div", 154)(2, "div", 89)(3, "h3", 155);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "button", 91);
    ...
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(8, "div", 94);
    \u0275\u0275template(9, RoutingComponent_div_23_div_9_Template, 2, 1, "div", 156);
    \u0275\u0275elementStart(10, "div")(11, "label", 98);
    \u0275\u0275text(12, "Payout Agent *");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "select", 102);
    ...
    \u0275\u0275elementStart(14, "option", 157);
    \u0275\u0275text(15, "Select Agent");
    \u0275\u0275elementEnd();
    \u0275\u0275template(16, RoutingComponent_div_23_option_16_Template, 2, 2, "option", 101);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(17, "div")(18, "label", 158);
    \u0275\u0275text(19, "Payment Modes *");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "div", 159);
    \u0275\u0275template(21, RoutingComponent_div_23_label_21_Template, 4, 2, "label", 160);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(22, "div", 105)(23, "button", 106);
    ...
    <table class="w-full text-sm text-left">
      <thead>
        <tr class="border-b border-surface-200 dark:border-surface-700 text-surface-600 dark:text-surface-300">
          <th class="px-4 py-3 font-semibold">Sending Agent</th>
          <th class="px-4 py-3 font-semibold">Source Country</th>
          <th class="px-4 py-3 font-semibold">Source Currency</th>
          <th class="px-4 py-3 font-semibold">Dest Country</th>
          <th class="px-4 py-3 font-semibold">Dest Currency</th>
          <th class="px-4 py-3 font-semibold">Partners</th>
        ...
        <tr *ngFor="let c of corridors" class="border-b border-surface-100 dark:border-surface-700 hover:bg-surface-50 dark:hover:bg-surface-750 transition-colors">
          ...
          <td class="px-4 py-3">
            <div class="flex items-center gap-1">
              <button title="Edit" (click)="openEditCorridor(c)" class="p-1.5 rounded-md text-brand-600 hover:bg-brand-50 dark:hover:bg-brand-900/20 transition"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg></button>
              <button title="Manage Partners" (click)="openPartnerManagement(c)" class="p-1.5 rounded-md text-purple-600 hover:bg-purple-50 dark:hover:bg-purple-900/20 transition"><svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"/></svg></button>
              <button [title]="c.isActive ? 'Deactivate' : 'Activate'" (click)="toggleCorridor(c)" class="p-1.5 rounded-md hover:bg-surface-100 dark:hover:bg-surface-700 transition"><svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" [ngClass]="c.isActive ? 'text-green-600 dark:text-green-400' : 'text-surface-400 dark:text-surface-500'"><path *ngIf="c.isActive" d="M17 7H7a5 5 0 000 10h10a5 5 0 000-10zm0 8a3 3 0 110-6 3 3 0 010 6z"/><path *ngIf="!c.isActive" d="M17 7H7a5 5 0 000 10h10a5 5 0 000-10zM7 15a3 3 0 110-6 3 3 0 010 6z"/></svg></button>
              <button title="Delete" (click)="deleteCorridor(c)" class="p-1.5 rounded-md text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 transition"><svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/></svg></button>
            </div>
          </td>
        </tr>
      </tbody>
...
//# sourceMappingURL=chunk-GVLXHUCL.js.map
