...
var AgentManagementComponent = class _AgentManagementComponent {
  constructor(api, auth, notify, exportService, confirmDelete) {
    this.api = api;
    this.auth = auth;
    this.notify = notify;
  ...
  static {
    this.\u0275fac = function AgentManagementComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _AgentManagementComponent)(\u0275\u0275directiveInject(ApiService), \u0275\u0275directiveInject(AuthStateService), \u0275\u0275directiveInject(NotificationService), \u0275\u0275directiveInject(ExportService), \u0275\u0275directiveInject(ConfirmDeleteService));
    };
  }
  static {
...
`, styles: ['@charset "UTF-8";\n\n/* src/app/pages/admin/agent-management/agent-management.component.scss */\n/*# sourceMappingURL=agent-management.component.css.map */\n'] }]
  }], () => [{ type: ApiService }, { type: AuthStateService }, { type: NotificationService }, { type: ExportService }, { type: ConfirmDeleteService }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AgentManagementComponent, { className: "AgentManagementComponent", filePath: "src/app/pages/admin/agent-management/agent-management.component.ts", lineNumber: 75 });
})();
export {
  AgentManagementComponent
};
//# sourceMappingURL=chunk-GEJ2TEPF.js.map
