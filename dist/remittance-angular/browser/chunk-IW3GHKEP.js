...
function ExchangeRatesComponent_div_21_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 74)(1, "div", 62)(2, "h3", 75);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "button", 64);
    ...
    \u0275\u0275element(6, "path", 66);
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(7, ExchangeRatesComponent_div_21_div_7_Template, 2, 1, "div", 76);
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(8, "div", 77)(9, "div", 78)(10, "label", 79);
    \u0275\u0275text(11, "Payout Agent *");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(15, ExchangeRatesComponent_div_21_option_15_Template, 2, 2, "option", 82);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(16, "div", 78)(17, "label", 79);
    \u0275\u0275text(18, "Payout Country");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "select", 80);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(22, ExchangeRatesComponent_div_21_option_22_Template, 2, 2, "option", 84);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(23, "div")(24, "label", 79);
    \u0275\u0275text(25, "Source Currency *");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(26, "select", 80);
    ...
    \u0275\u0275elementStart(27, "option", 85);
    \u0275\u0275text(28, "Select");
    \u0275\u0275elementEnd();
    \u0275\u0275template(29, ExchangeRatesComponent_div_21_option_29_Template, 2, 2, "option", 84);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(30, "div")(31, "label", 79);
    \u0275\u0275text(32, "Destination Currency *");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(33, "select", 80);
    ...
    \u0275\u0275elementStart(34, "option", 85);
    \u0275\u0275text(35, "Select");
    \u0275\u0275elementEnd();
    \u0275\u0275template(36, ExchangeRatesComponent_div_21_option_36_Template, 2, 2, "option", 84);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(37, "div")(38, "label", 79);
    \u0275\u0275text(39, "Rate *");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(40, "input", 86);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(41, "div")(42, "label", 79);
    \u0275\u0275text(43, "Margin");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(45, "div", 87)(46, "button", 3);
    ...
    \u0275\u0275template(49, ExchangeRatesComponent_div_21__svg_svg_49_Template, 3, 0, "svg", 89)(50, ExchangeRatesComponent_div_21__svg_svg_50_Template, 2, 0, "svg", 90);
    \u0275\u0275text(51);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
...
var ExchangeRatesComponent = class _ExchangeRatesComponent {
  ...
  constructor(api, exportService, auth, notify, confirmDelete) {
    this.api = api;
...
<div *ngIf="showFormPopup"
  ...
  }], () => [{ type: ApiService }, { type: ExportService }, { type: AuthStateService }, { type: NotificationService }, { type: ConfirmDeleteService }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ExchangeRatesComponent, { className: "ExchangeRatesComponent", filePath: "src/app/pages/admin/exchange-rates/exchange-rates.component.ts", lineNumber: 40 });
})();
export {
  ExchangeRatesComponent
};
//# sourceMappingURL=chunk-IW3GHKEP.js.map
