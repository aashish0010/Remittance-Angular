...
var IdleTimeoutService = class _IdleTimeoutService {
  ...
  start() {
    ...
    this._warningAtMs = Math.max(this._idleTimeoutMs - warningLeadMs, 60 * 1e3);
...
function AdminLayoutComponent_div_37_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(11, "svg", 65);
    \u0275\u0275element(12, "path", 66);
    \u0275\u0275elementEnd();
    \u0275\u0275text(13, " My Profile ");
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275element(14, "div", 63);
    \u0275\u0275elementStart(15, "a", 67);
    ...
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(16, "svg", 68);
    \u0275\u0275element(17, "path", 47);
    \u0275\u0275elementEnd();
    \u0275\u0275text(18, " Sign Out ");
    \u0275\u0275elementEnd()();
  }
...
function AdminLayoutComponent_div_40_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(5, AdminLayoutComponent_div_40_button_5_Template, 3, 0, "button", 74);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
function AdminLayoutComponent_div_41_a_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, AdminLayoutComponent_div_41_a_1_span_4_Template, 2, 1, "span", 83);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function AdminLayoutComponent_div_41_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, AdminLayoutComponent_div_41_a_1_Template, 5, 4, "a", 79);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
function AdminLayoutComponent_ng_container_47_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function AdminLayoutComponent_ng_container_47_ng_container_1_Template_button_click_1_listener() {
      ...
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.toggleSection(section_r9));
    });
    \u0275\u0275elementStart(2, "span", 88);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(4, "svg", 89);
    \u0275\u0275element(5, "path", 31);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    ...
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", section_r9, " ");
    \u0275\u0275advance();
    \u0275\u0275classProp("rotate-180", !ctx_r0.isSectionExpanded(section_r9));
  }
}
...
function AdminLayoutComponent_ng_container_47_ng_container_4_a_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(1, "svg", 40);
    \u0275\u0275template(2, AdminLayoutComponent_ng_container_47_ng_container_4_a_1_span_2_Template, 2, 1, "span", 41);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const item_r10 = ctx.$implicit;
    const ctx_r0 = \u0275\u0275nextContext(3);
    \u0275\u0275property("routerLink", item_r10.route)("title", !ctx_r0.sidenavOpened ? item_r10.label : "");
    \u0275\u0275advance();
    \u0275\u0275property("innerHTML", ctx_r0.getIconSvg(item_r10.icon), \u0275\u0275sanitizeHtml);
    \u0275\u0275advance();
...
function AdminLayoutComponent_ng_container_47_ng_container_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, AdminLayoutComponent_ng_container_47_ng_container_4_a_1_Template, 3, 4, "a", 91);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const section_r9 = \u0275\u0275nextContext().$implicit;
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", ctx_r0.getItemsForSection(section_r9));
  }
}
function AdminLayoutComponent_ng_container_47_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, AdminLayoutComponent_ng_container_47_ng_container_1_Template, 6, 3, "ng-container", 86)(2, AdminLayoutComponent_ng_container_47_ng_template_2_Template, 1, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(4, AdminLayoutComponent_ng_container_47_ng_container_4_Template, 2, 1, "ng-container", 48);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const section_r9 = ctx.$implicit;
    const collapsedDivider_r11 = \u0275\u0275reference(3);
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r0.sidenavOpened)("ngIfElse", collapsedDivider_r11);
    \u0275\u0275advance(3);
    \u0275\u0275property("ngIf", ctx_r0.isSectionExpanded(section_r9) || !ctx_r0.sidenavOpened);
  }
}
...
function AdminLayoutComponent_div_57_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(3, "svg", 96);
    \u0275\u0275element(4, "path", 97);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(5, "h3", 98);
    \u0275\u0275text(6, "Session Timeout Warning");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "p", 99);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "div", 101)(13, "button", 102);
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AdminLayoutComponent, selectors: [["app-admin-layout"]], hostBindings: function AdminLayoutComponent_HostBindings(rf, ctx) {
      ...
      if (rf & 1) {
        ...
        \u0275\u0275template(18, AdminLayoutComponent__svg_svg_18_Template, 2, 0, "svg", 17)(19, AdminLayoutComponent__svg_svg_19_Template, 2, 0, "svg", 17);
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275elementEnd()();
        \u0275\u0275namespaceSVG();
        \u0275\u0275elementStart(35, "svg", 30);
        \u0275\u0275element(36, "path", 31);
        \u0275\u0275elementEnd()();
        \u0275\u0275template(37, AdminLayoutComponent_div_37_Template, 19, 4, "div", 32);
        \u0275\u0275elementEnd()()();
        \u0275\u0275template(38, AdminLayoutComponent_div_38_Template, 1, 0, "div", 33);
        \u0275\u0275namespaceHTML();
        \u0275\u0275elementStart(39, "aside", 34);
        \u0275\u0275template(40, AdminLayoutComponent_div_40_Template, 6, 2, "div", 35)(41, AdminLayoutComponent_div_41_Template, 2, 1, "div", 36)(42, AdminLayoutComponent_div_42_Template, 4, 0, "div", 37);
        \u0275\u0275elementStart(43, "nav", 38)(44, "a", 39);
        \u0275\u0275namespaceSVG();
        \u0275\u0275element(45, "svg", 40);
        \u0275\u0275template(46, AdminLayoutComponent_span_46_Template, 2, 0, "span", 41);
        \u0275\u0275elementEnd();
        \u0275\u0275template(47, AdminLayoutComponent_ng_container_47_Template, 5, 3, "ng-container", 42);
        \u0275\u0275namespaceHTML();
        \u0275\u0275element(48, "div", 43);
        \u0275\u0275elementStart(49, "div", 44)(50, "a", 45);
        \u0275\u0275listener("click", function AdminLayoutComponent_Template_a_click_50_listener() {
          return ctx.logout();
        });
        \u0275\u0275namespaceSVG();
        \u0275\u0275elementStart(51, "svg", 46);
        \u0275\u0275element(52, "path", 47);
        \u0275\u0275elementEnd();
        \u0275\u0275template(53, AdminLayoutComponent_span_53_Template, 2, 0, "span", 48);
        \u0275\u0275elementEnd()()()();
        \u0275\u0275namespaceHTML();
        \u0275\u0275elementStart(54, "main", 49)(55, "div", 50);
        \u0275\u0275element(56, "router-outlet");
        \u0275\u0275elementEnd()();
        \u0275\u0275template(57, AdminLayoutComponent_div_57_Template, 17, 1, "div", 51);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
...
//# sourceMappingURL=chunk-R6BLUAIG.js.map
