...
function RoutingComponent_div_21_div_19_tr_14_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "tr", 135)(1, "td", 47);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "td", 50)(4, "div", 136);
    \u0275\u0275template(5, RoutingComponent_div_21_div_19_tr_14_span_5_Template, 2, 1, "span", 137);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "td", 50)(7, "span", 138);
    \u0275\u0275text(8);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "td", 139)(10, "div", 140)(11, "button", 141);
...
function RoutingComponent_div_21_div_19_div_16_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 67)(1, "div", 145)(2, "span", 69);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "span", 138);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "div", 146)(7, "span", 147);
    \u0275\u0275text(8, "Payment Modes");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "div", 136);
    \u0275\u0275template(10, RoutingComponent_div_21_div_19_div_16_span_10_Template, 2, 1, "span", 137);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(11, "div", 148)(12, "button", 149);
...
function RoutingComponent_div_21_div_19_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 127)(1, "div", 128)(2, "table", 24)(3, "thead", 129)(4, "tr", 25)(5, "th", 130);
    \u0275\u0275text(6, "Payout Agent");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "th", 130);
    \u0275\u0275text(8, "Payment Modes");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "th", 131);
    \u0275\u0275text(10, "Status");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "th", 132);
    \u0275\u0275text(12, "Actions");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(13, "tbody");
    \u0275\u0275template(14, RoutingComponent_div_21_div_19_tr_14_Template, 21, 8, "tr", 133);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(15, "div", 134);
...
function RoutingComponent_div_23_label_21_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "label", 164)(1, "input", 165);
...
function RoutingComponent_div_23_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 154)(1, "div", 155)(2, "div", 89)(3, "h3", 156);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "button", 91);
    ...
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(8, "div", 94);
    \u0275\u0275template(9, RoutingComponent_div_23_div_9_Template, 2, 1, "div", 157);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(17, "div")(18, "label", 159);
    \u0275\u0275text(19, "Payment Modes *");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "div", 160);
    \u0275\u0275template(21, RoutingComponent_div_23_label_21_Template, 4, 2, "label", 161);
    \u0275\u0275elementEnd()()();
        ...
        <tr *ngFor="let c of corridors" class="border-b border-surface-100 dark:border-surface-700 hover:bg-surface-50 dark:hover:bg-surface-750 transition-colors">
          ...
          <td class="px-4 py-3">
            <div class="flex items-center gap-1">
              ...
              <button aria-label="Delete corridor" (click)="deleteCorridor(c)" class="p-1.5 rounded-md text-danger-500 hover:bg-danger-50 dark:hover:bg-danger-900/20 transition"><svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/></svg></button>
            </div>
          </td>
        </tr>
      </tbody>
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RoutingComponent, { className: "RoutingComponent", filePath: "src/app/pages/admin/routing/routing.component.ts", lineNumber: 46 });
})();
export {
  RoutingComponent
};
//# sourceMappingURL=chunk-SYKPHF2Q.js.map
