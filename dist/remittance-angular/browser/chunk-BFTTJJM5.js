        ...
        <tr *ngFor="let c of commissions"
          ...
          <td class="px-3 py-3">
            <div class="flex items-center gap-1">
              ...
              <button aria-label="Delete service charge" (click)="deleteCommission(c)"
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CommissionsComponent, { className: "CommissionsComponent", filePath: "src/app/pages/admin/commissions/commissions.component.ts", lineNumber: 62 });
})();
export {
  CommissionsComponent
};
//# sourceMappingURL=chunk-BFTTJJM5.js.map
