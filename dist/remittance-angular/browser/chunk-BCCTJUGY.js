...
function ComplianceSetupComponent_div_8_tr_24_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ComplianceSetupComponent_div_8_tr_24_Template_button_click_25_listener() {
      const r_r4 = \u0275\u0275restoreView(_r3).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.deleteRule(r_r4));
    });
    \u0275\u0275namespaceSVG();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction3(12, _c0, r_r4.action === "Block", r_r4.action === "Review", r_r4.action !== "Block" && r_r4.action !== "Review"));
    \u0275\u0275advance();
    ...
    \u0275\u0275advance(6);
    \u0275\u0275property("title", r_r4.isActive ? "Deactivate" : "Activate");
    \u0275\u0275advance();
...
function ComplianceSetupComponent_div_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(24, ComplianceSetupComponent_div_8_tr_24_Template, 28, 16, "tr", 22);
    \u0275\u0275elementEnd()()();
...
function ComplianceSetupComponent_div_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 44)(1, "div", 45)(2, "div", 46)(3, "h3", 47);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275template(9, ComplianceSetupComponent_div_10_div_9_Template, 2, 1, "div", 52);
    \u0275\u0275elementStart(10, "div", 53)(11, "div", 54)(12, "label", 55);
    \u0275\u0275text(13, "Rule Name *");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(15, "div")(16, "label", 55);
    \u0275\u0275text(17, "Rule Type");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "select", 57);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(25, "option", 61);
    \u0275\u0275text(26, "Name Screening");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(27, "div")(28, "label", 55);
    \u0275\u0275text(29, "Action");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(30, "select", 57);
    ...
    \u0275\u0275text(34, "Block");
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(35, ComplianceSetupComponent_div_10_div_35_Template, 4, 1, "div", 64)(36, ComplianceSetupComponent_div_10_div_36_Template, 4, 1, "div", 64)(37, ComplianceSetupComponent_div_10_div_37_Template, 4, 1, "div", 64);
    \u0275\u0275elementStart(38, "div")(39, "label", 55);
    \u0275\u0275text(40, "Source Country");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(41, "select", 57);
    ...
    \u0275\u0275elementStart(42, "option", 65);
    \u0275\u0275text(43, "-- Any --");
    \u0275\u0275elementEnd();
    \u0275\u0275template(44, ComplianceSetupComponent_div_10_option_44_Template, 2, 2, "option", 66);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(45, "div")(46, "label", 55);
    \u0275\u0275text(47, "Destination Country");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(48, "select", 57);
    ...
    \u0275\u0275text(50, "-- Any --");
    \u0275\u0275elementEnd();
    \u0275\u0275template(51, ComplianceSetupComponent_div_10_option_51_Template, 2, 2, "option", 66);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(52, "div", 67)(53, "label", 68)(54, "div", 69)(55, "input", 70);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275element(56, "span", 71)(57, "span", 72);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(58, "span", 73);
    \u0275\u0275text(59, "Active");
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275elementStart(60, "div", 74)(61, "button", 75);
    ...
    \u0275\u0275template(64, ComplianceSetupComponent_div_10__svg_svg_64_Template, 3, 0, "svg", 77)(65, ComplianceSetupComponent_div_10__svg_svg_65_Template, 2, 0, "svg", 78);
    \u0275\u0275text(66);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    ...
    <table class="w-full text-sm text-left">
      <thead>
        <tr class="border-b border-surface-200 dark:border-surface-700 text-surface-600 dark:text-surface-300">
          ...
          <th class="px-4 py-3 font-semibold">Threshold / Params</th>
          <th class="px-4 py-3 font-semibold">Countries</th>
        ...
        <tr *ngFor="let r of filteredRules" class="border-b border-surface-100 dark:border-surface-700 hover:bg-surface-50 dark:hover:bg-surface-750 transition-colors">
          ...
          <td class="px-4 py-3">
            <div class="flex items-center gap-1">
              <button title="Edit" (click)="openEdit(r)" class="p-1.5 rounded-md text-brand-600 hover:bg-brand-50 dark:hover:bg-brand-900/20 transition"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg></button>
              <button [title]="r.isActive ? 'Deactivate' : 'Activate'" (click)="toggleRule(r)" class="p-1.5 rounded-md hover:bg-surface-100 dark:hover:bg-surface-700 transition"><svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" [ngClass]="r.isActive ? 'text-green-600 dark:text-green-400' : 'text-surface-400 dark:text-surface-500'"><path *ngIf="r.isActive" d="M17 7H7a5 5 0 000 10h10a5 5 0 000-10zm0 8a3 3 0 110-6 3 3 0 010 6z"/><path *ngIf="!r.isActive" d="M17 7H7a5 5 0 000 10h10a5 5 0 000-10zM7 15a3 3 0 110-6 3 3 0 010 6z"/></svg></button>
              <button title="Delete" (click)="deleteRule(r)" class="p-1.5 rounded-md text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 transition"><svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/></svg></button>
            </div>
          </td>
        </tr>
      </tbody>
...
<div *ngIf="showPopup" class="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
  <div class="bg-white dark:bg-surface-800 rounded-2xl shadow-xl w-full max-w-2xl pointer-events-auto max-h-[90vh] overflow-y-auto">
    <div class="flex items-center justify-between px-6 py-4 border-b border-surface-100 dark:border-surface-700">
      <h3 class="text-lg font-semibold text-surface-900 dark:text-surface-100">{{ isEditing ? 'Edit Rule' : 'Create Rule' }}</h3>
...
//# sourceMappingURL=chunk-BCCTJUGY.js.map
