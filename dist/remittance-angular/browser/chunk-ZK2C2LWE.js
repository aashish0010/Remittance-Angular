...
function LoginComponent_ng_container_10_ng_container_25_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r0.isLockedOut ? "Account Locked" : "Sign In");
  }
}
...
function LoginComponent_ng_container_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(25, LoginComponent_ng_container_10_ng_container_25_Template, 2, 1, "ng-container", 28)(26, LoginComponent_ng_container_10_ng_template_26_Template, 3, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    ...
    <ng-container *ngIf="!showPortalSelection">
      ...
      <form [formGroup]="loginForm" (ngSubmit)="login()" class="flex flex-col gap-4 text-left">
        ...
        <button
          ...
          <ng-container *ngIf="!loading; else loader">{{ isLockedOut ? 'Account Locked' : 'Sign In' }}</ng-container>
          <ng-template #loader>
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LoginComponent, { className: "LoginComponent", filePath: "src/app/pages/auth/login/login.component.ts", lineNumber: 65 });
})();
export {
  LoginComponent
};
//# sourceMappingURL=chunk-ZK2C2LWE.js.map
