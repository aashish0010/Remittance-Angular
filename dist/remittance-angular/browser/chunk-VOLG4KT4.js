...
var AdminTransactionsComponent = class _AdminTransactionsComponent {
  constructor(api, exportService, auth, notify, route, appSettings) {
    this.api = api;
        ...
        >
          ...
          <td class="px-4 py-3 text-center whitespace-nowrap">
            <div class="inline-flex items-center gap-1">
              ...
              <!-- Pending/Completed: Cancel (hidden when transaction.cancellationAllowed = false) -->
              <button
...
`, styles: ["/* src/app/pages/admin/transactions/admin-transactions.component.scss */\n:host {\n  display: block;\n}\n/*# sourceMappingURL=admin-transactions.component.css.map */\n"] }]
  }], () => [{ type: ApiService }, { type: ExportService }, { type: AuthStateService }, { type: NotificationService }, { type: ActivatedRoute }, { type: AppSettingsService }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminTransactionsComponent, { className: "AdminTransactionsComponent", filePath: "src/app/pages/admin/transactions/admin-transactions.component.ts", lineNumber: 27 });
})();
export {
  AdminTransactionsComponent
};
//# sourceMappingURL=chunk-VOLG4KT4.js.map
