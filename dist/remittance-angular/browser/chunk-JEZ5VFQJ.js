...
var AccountingComponent = class _AccountingComponent {
  ...
  static {
    this.\u0275fac = function AccountingComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _AccountingComponent)(\u0275\u0275directiveInject(ApiService), \u0275\u0275directiveInject(AuthStateService), \u0275\u0275directiveInject(NotificationService), \u0275\u0275directiveInject(ExportService), \u0275\u0275directiveInject(ConfirmDeleteService));
    };
  }
  static {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AccountingComponent, { className: "AccountingComponent", filePath: "src/app/pages/admin/accounting/accounting.component.ts", lineNumber: 45 });
})();
export {
  AccountingComponent
};
//# sourceMappingURL=chunk-JEZ5VFQJ.js.map
